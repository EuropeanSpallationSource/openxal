...
public class ChannelSnapshot {
    ...
    /**
     * minimum value of a double supported by Oracle where we assume it can at
     * least handle a small float
     */
     ...
     * @param timestamp The timestamp of the snapshot identifying when the data
     * was acquired.
     */
    ...
    /**
     * Process the value array to make it compatible with Oracle's limited
     * support of doubles. Modify the array inline to avoid an underflow.
     *
    ...
    /**
     * get the scalar value which corresponds to the first element of the value
     * array if it exists or NaN otherwise
     */
    ...
    /**
     * Get the timestamp of the PV's data identifying the time the data was
     * acquired.
     *
