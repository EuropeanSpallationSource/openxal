...
public class ChannelWrapper {
    ...
    /**
     * Dispose of the channel resources: Shutdown the monitor if a monitor is
     * active. Remove the connection handler as a connection listener of the
     * channel.
     */
    public void dispose() {
    ...
    /**
     * Add the specified object as a listener of channel connection events of
     * the channel that is wrapped.
     *
    ...
    /**
     * Remove the specified object from being a listener of channel connection
     * events of the channel that is wrapped.
     *
     ...
     * occurs, create a monitor. If a channel is dropped then clear the record.
     */
     ...
     * internal anonymous class is the listener of the monitor events and caches
     * the latest channel record.
     */
    ...
    protected class ConnectionHandler implements ConnectionListener {
         ...
         * established. If the monitor is null make a new monitor.
         *
        ...
        /**
         * Indicates that a connection to the specified channel has been
         * dropped. If the connection is dropped, clear the latest record.
         *
