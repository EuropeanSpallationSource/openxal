...
public class MachineSnapshot {
     ...
     * Primary constructor.
     *
     * @param id The unique identifier of this instance in the persistent
     * storage.
     ...
     * @param channelSnapshots The channel snapshots associated with this
     * machine snapshot.
     */
    ...
    /**
     * Constructor of a MachineSnapshot with no data. Placeholders for channel
     ...
     * @param channelSnapshot The channel snapshot to associate with this
     * machine snapshot.
     */
     ...
     *
     * @param channelSnapshots The array of channel snapshots to associate with
