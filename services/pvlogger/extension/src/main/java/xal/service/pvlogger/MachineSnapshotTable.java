...
class MachineSnapshotTable {
    ...
    /**
     * Fetch the machine snapshots within the specified time range. The machine
     * snapshots do not include the channel snapshots. A complete snapshot can
     * be obtained using the fetchMachineSnapshot(id) method.
     *
     * @param connection database connection
     * @param startTime The start time of the time range
     * @param endTime The end time of the time range
     ...
     *
     * @return the prepared statement for making a new machine snapshot primary
     * key and fetching it
     ...
     * Create the prepared statement if it does not already exist.
     *
     * @return the prepared statement to query for machine snapshots by primary
     * key
     * @throws java.sql.SQLException if an exception occurs during a SQL
     * evaluation
     */
     ...
     * Create the prepared statement if it does not already exist.
     *
     * @return the prepared statement to query for machine snapshots by type and
     * time range
     * @throws java.sql.SQLException if an exception occurs during a SQL
     * evaluation
     */
     ...
     * Create the prepared statement if it does not already exist.
     *
     * @return the prepared statement to query for machine snapshots by time
     * range
     * @throws java.sql.SQLException if an exception occurs during a SQL
     * evaluation
     */
