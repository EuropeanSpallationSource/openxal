...
public class ChannelGroup {
    ...
    /**
     * retention time in days (or zero for permanent retention) for snapshots
     ...
     * @param retention the rentention time in days (or zero for permanent
     * retention) for snapshots associated with this group
     */
    ...
    /**
     * get the retention in days (or 0 for permanent) of the snapshots
     * associated with this group
     */
