...
class TripFilterFactory {
    ...
    public static TripFilter getTripCounterFilter() {
        return new TripFilter() {
            /**
             * a new trip is indicated by the new value being greater than the
             * old value and also greater than zero
             */
    ...
    /**
     * get a trip filter which filters based on a particular value indicating
     * okay
     */
