 ...
 * channel and registering it with the correlator.
 *
 * @author tap
 */
public class ChannelWrapper {
    ...
    /**
     * Add the specified listener as a listener of connection events for the
     * wrapped channel
     *
    ...
    /**
     * Remove the specified listener from receiving connection events from the
     * wrapped channel
     *
    ...
    /**
     * Request that the wrapped channel be connected. Connections are made in
     * the background so this method returns immediately upon making the
     * request. The connection will be made in the future as soon as possible. A
