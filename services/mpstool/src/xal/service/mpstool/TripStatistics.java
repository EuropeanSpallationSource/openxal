...
public class TripStatistics {
    ...
    /**
     * the number of times the MPS signal has been the first to trip among a
     * correlated set
     */
    ...
    /**
     * Get the number of times the MPS signal was the first to trip among a
     * correlate set of MPS trips.
     *
    ...
    /**
     * Generate an MPS trip comparator that compares trip statistics records
     * based on the number of MPS trips.
     *
    ...
    /**
     * Generate an MPS first hit comparator that compares trip statistics
     * records based on the number of times an MPS signal was the first to trip
     * among a correlated group of trips.
     *
    ...
    /**
     * Generate an input trip comparator that compares trip statistics records
     * based on the number of input trips.
     *
