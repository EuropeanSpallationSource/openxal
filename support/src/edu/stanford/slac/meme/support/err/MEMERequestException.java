...
/**
 * MEMERPCRequestException can be used to implement the MEME error handling and
 * logging standard rules. Specifically AidaRPCRequestException offers constructors
 * that put together the message text given, plus the message text of a given "cause"
 * Throwable also given, inroder to construct a single message that says the first
 * was caused by the second. This "chained excpetion" text is a required feature of
 * MEME services.
 *
