...
public class GenericVector extends BaseVector<GenericVector> {
	 ...
	 */
	public GenericVector(double[] arrVals) throws ArrayIndexOutOfBoundsException {
		super(arrVals);
	}
	...
	@Override
	protected GenericVector newInstance(double[] arrVecInt) {
		return new GenericVector(arrVecInt);
	}
