 ...
 * <code>newSourceAgent()</code> to generate a ChannelAgent as a source agent.
...
public class ChannelCorrelator extends Correlator<Channel, ChannelTimeRecord, ChannelAgent> {
     ...
     * Creates new ChannelCorrelator.
     *
     * @param aBinTimespan The time resolution for accepting two events as
     * correlated.
    ...
    /**
     * Add a channel to monitor. If we already monitor a channel, do nothing.
     * This method allows channels to be specified with an alternate id than the
     * default one.
     *
     * @param channel The channel to monitor for correlations.
     ...
     * Add a channel to monitor. If we already monitor a channel, do nothing.
     * The record filter is used to determine whether or not to accept the
     * reading of the specified channel when the event is handled. This method
     * allows channels to be specified with an alternate id than the default
     * one.
     *
     * @param channel The channel to monitor for correlations.
     ...
     *
     * @param channel The channel we are requesting to stop monitoring and
     * correlating.
     */
     ...
     * Stop managing the specified channel
     *
     * @param channelId The id of the channel we are requesting to stop
