...
public class Timestamp implements Comparable<Timestamp> {
    ...
    /**
     * Get the times tamp as a Java Date. Some precision is lost since the Date
    ...
    /**
     * Override the hashcode as required when overriding equals. Equality
     * implies equality of the underlying timestamp instance variables.
     */
    @Override
    public int hashCode() {
