...
public class XalException extends java.lang.Exception {
    ...
    /**
     * Constructs an <code>XalException</code> with the specified detail
     * message.
     *
    ...
    /**
     * Create a new <code>XalException</code> object which is spawned (in
     * principle) by the given exception object and has the given explanation
     * message.
     *
