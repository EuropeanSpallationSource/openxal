 ...
 * <p>
 * A zero value for focal length indicates zero focusing strength, or infinite
 * focal length. Positive focal lengths imply focusing while negative values
 * imply defocusing.
 *
...
public class ThinLens extends ThinElement {
     ...
     */
    /**
     * Creates a new instance of ThinLens A zero value for focal length
     * indicates zero focusing strength, or infinite focal length. Positive
     ...
     */
    /**
     * Return the focal length of thin lens in the x phase plane. Negative
    ...
    /**
     * Return the focal length of thin lens in the y phase plane. Negative
     * values indicate focusing effect Positive values indicate defocusing
     * effect
     *
     * @return lens focal length (in <strong>meters</strong>)
    ...
    /**
     * Return the focal length of thin lens in the z phase plane. Negative
     * values indicate focusing effect Positive values indicate defocusing
     * effect
     *
     * @return lens focal length (in <strong>meters</strong>)
    ...
    /**
     * Compute and return the block-diagonal transfer matrix representing a thin
     * lens in each phase plane.
     *
