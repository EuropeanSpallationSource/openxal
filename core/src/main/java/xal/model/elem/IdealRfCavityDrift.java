 ...
 * <code>IdealDrift</code> class to include a frequency parameter
 * <i>f</i> which is necessary in computing probe phase advance through the
 * drift.
 * </p>
 * I think we are going to include the structure mode number <i>q</i> in here as
...
public class IdealRfCavityDrift extends IdealDrift {
     ...
     * Constructor initializes all defining parameters of this RF cavity drift
     * space.
     *
...
//        super(strId, dblLen);
     ...
     *
     * @return the fundamental mode frequency <i>f</i><sub>0</sub> of the
     * enclosing RF cavity
     */
     ...
     */
    /**
     * Computes and returns the phase advance of the probe while drifting
     * through the given segment of this drift.
     *
