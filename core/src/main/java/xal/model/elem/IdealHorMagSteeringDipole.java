 ...
 * <code>{@link IdealMagSteeringDipole}</code>. This purpose of this class is to
 * avoid the use of the enumeration constants in
 * <code>{@link IElectromagnet}</code> which define the orientation. They are
 * brittle being of the legacy construction (with <code>int</code> values) and
 * the mechanism is problematic when generating a model from the SMF
 * <code>{@link Accelerator}</code> tree.
 *
 *
 * @author Christopher K. Allen
 * @since May 13, 2011
...
public class IdealHorMagSteeringDipole extends IdealMagSteeringDipole {
     ...
     * <code>IdealHorMagSteeringDipole</code>. Typically used by automatic
     * lattice generation.
     *
     * @author Christopher K. Allen
     * @since May 13, 2011
    ...
    /**
     * Create a new instance of <code>IdealHorMagSteeringDipole</code> and
     * specify its instance identifier.
     *
    ...
    /**
     * Creates a new instance of <code>IdealHorMagSteeringDipole</code>. The
