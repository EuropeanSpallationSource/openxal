 ...
 * <code>IdealFringeQuadFace</code> elements that provides fringe field based
 * on; H. Matsuda and H. Wollnik, NIM 103 (1972) 117 Structure is simular to
 * that of IdealMagWedgeDipole2
 *
...
public class IdealMagFringeQuad extends ElectromagnetSeq {
     ...
     * NOTE:
     * <p>
     * We have a bit of a logitics problem here because this is a composite
     * element. So when setting the position of this element we want to set the
     * positions of all the internal elements, in particlar, the pole faces.
