...
public class IdealEDipole extends ThickElectrostatic {
     ...
     * = 1/6 for linear drop off, =~0.4 for clamped Rogowski coil, = 0.7 for an
     * unclamped Rogowski coil, or = 0.45 for square edge - non saturating
     * magnet.
     *
     */
    ...
    /**
     *
     * Orientation of dipole (for now hardwired to horizontal). This interface
     * needs a general angle.
     *
     */
    ...
    /**
     * dipole indicator, 0 = first half of a split dipole, 1 = means second half
     * of a split dipole, 2 = others
     */
     ...
     * focusing (dimensionless). Should be: = 1/6 for linear drop off, =~0.4 for
     * clamped Rogowski coil, = 0.7 for an unclamped Rogowski coil, or = 0.45
     * for square edge - non saturating magnet.
     *
     */
    ...
    /**
     * Set dipole indicator so the transfer map can handle edge effect
     * correctly.
     *
    ...
    /**
     *
     * Returns the energy gain imparted to a particular probe. For an ideal
     * dipole magnet this value is always zero.
     *
    ...
    /**
     *
     * Computes the partial transfer map of an ideal dipole for the particular
     * probe. Computes transfer map for a section. of dipole <code>dblLen</code>
     * meters in length.
     *
