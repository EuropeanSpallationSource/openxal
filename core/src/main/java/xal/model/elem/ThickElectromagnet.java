...
public abstract class ThickElectromagnet extends ThickElement implements IElectromagnet {
    ...
    *  IElectromagnet Interface
     */
    /**
     * Return the orientation enumeration code. Return the orientation
     * enumeration code for the bending plane of the associated dipole magnet /
     * focusing plane of quadrupole.
     *
     * @return ORIENT_HOR - quadrupole focuses in x (horizontal) plane dipole
     * has steering action in x (horizontal) plane ORIENT_VER - quadrupole
     * focuses in y ( vertical ) plane dipole has steering action in y
     * (vertical) plane ORIENT_NONE - error
     */
    @Override
     ...
     *
     * @return magnetic field (in <b>Tesla/meter</b> for quads, <b>Tesla</b> for
     * dipoles).
     */
    @Override
     ...
     *
     * @param dblField magnetic field (in <b>Tesla/meter</b> for quads,
     * <b>Tesla</b> for dipoles).
     */
    @Override
