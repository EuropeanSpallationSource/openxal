 ...
 * <code>IdealMagSectorDipole2</code>
 */
@Deprecated
...
//	}
    ...
    /**
     * A version from ThickDipole. The results is very similar as
     * this.transferMap Compute the partial transfer map of an ideal quadrupole
     * for the particular probe. Computes transfer map for a section of
     * quadrupole <code>dblLen</code> meters in length.
     *
     * @param dL compute transfer matrix for section of this path length
     * @param probe uses the rest and kinetic energy parameters from the probe
     *
