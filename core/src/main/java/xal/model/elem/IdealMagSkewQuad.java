...
public class IdealMagSkewQuad extends IdealMagQuad {
     ...
     *
     * @return 13 - quadrupole focuses in first and third quadrants 24 -
     * quadrupole focuses in second and fourth quadrants ORIENT_NONE - error
     */
    /**
     ...
     */
    /**
     * Compute the partial transfer map of an ideal skew quadrupole for the
     * particular probe. Computes transfer map for a section of skew quadrupole
