 ...
 * </p>
 * <p>
 * Currently is it intended to be used in tandem with the <code>IRfGap</code>
 * interface to get a complete description. It might be more natural to inherit
 * from the <code>IRfGap</code> interface since most cavity cells are used for
 ...
 * object (e.g., IdealRfGap). This isn't exactly sound practice since the gap is
 * not a cell, however, it's a quick, klugy way into the current architecture.
 * </p>
 * <p>
...
public interface IRfCavityCell {
    ...
    /**
     * Returns whether or not the cell is the first or last in a string of cells
     * within an RF cavity. This is particularly important in structures
     * operating outside 0 mode where the cell phasing may change.
     *
     * @return  <code>true</code> if this cell is at either end in a bank of
     * cells, <code>false</code> otherwise
     *
