 ...
 * magnet which is rolled about the beam axis by 45&deg;. It is a corrective
 * device which is meant to be driven with a bipolar supply. Thus, the sign of
 * the magnetic field parameter (see
 * {@link IdealMagSkewQuad3#setMagField(double)}) can be either positive or
 * negative
 * </p>
 * <p>
 * Looking down the beam axis toward a "skew quadrupole", a positive "skew"
 * angle means the element is rotated <em>clockwise</em> by 45&deg;. (This
 * convention is consistent with the Tait-Bryan angles of aerospace
 * engineering.)
 * </p>
 * <p>
 ...
 * parameter, the <code>setOrientation()</code> parameter. This condition
 ...
 * angle for any <code>IdealMagSkewQuad3</code> object is always the same.
 * Driving the device with a negative supply (see
 * {@link IdealMagSkewQuad3#setMagField(double)}) in effect changes its
 * "orientation."
 * </p>
 *
 ...
 * Specifically,
 * <br>
 * <br>- A (+45&deg;) skew quadrupole driven with a positive field focuses in
 * the 2<sup>nd</sup> and 4<sup>th</sup> quadrants.
 * </td>
 * </tr>
 * <tr>
 * <td>
 * - A (+45&deg;) skew quadrupole driven with a negative field focuses in the
 * 1<sup>st</sup> and 3<sup>rd</sup> quadrants.
 * </td>
 * </tr>
 * </table>
 *
...
public class IdealMagSkewQuad3 extends ThickElectromagnet {
     ...
     */
    /**
     * Phase coordinate rotation in SO(6) taking beam coordinates to natural
     * quadrupole coordinates
     */
    private static final PhaseMatrix MAT_SO6_TOQUAD_COORDS;

    /**
     * Phase coordinate rotation in SO(6) natural quadrupole coordinates to beam
     * coordinates
     */
     ...
     * </p>
     * <p>
     * Converts a linear transform (represented as a <code>PhaseMatrix</code>
     * object) from its representation in the magnet coordinates to its
     * representation in the beam frame phase coordinates.
     * </p>
     *
     * @param matQuad linear transform in natural quadrupole magnet
     * representation
     *
    ...
    /**
     * Create new, uninitialized <code>IdealMagSkewQuad3</code> object. Use this
     * constructor with caution as the length of the magnet is uninitialized.
     *
     * @author Christopher K. Allen
     * @since Mar 14, 2008
     */
    ...
    /**
     * <p>
     * Get the skew angle of the quadrupole magnet. For a description of this
     * parameter see {@link IdealMagSkewQuad3}.
     * </p>
     * <p>
     ...
     * <p>
     * NOTE:
     * <br>The magnet orientation property has no effect upon the operation of
     * the modeling element. This method is needed to satisfy the
     * <code>IElectromagnet</code> interface, which should be re-designed
