 ...
 * others). According to the Element-Algorithm-Probe analysis pattern, the Probe
 * objects interact with accelerator structures, Element's. These interactions
 * are implemented as the separate classes (Tracker, Mapper, etc.) that support
 * the Algorithm interface.
 *
 * @author Nikolay Malitsky, Christopher K. Allen
 * @version $Id: IProbe.java 2 2006-08-17 12:20:30 +0000 (Thursday, 17 8 2006)
 * t6p $
 */
public interface IProbe {
     ...
     */
    /**
     * Returns the state history of the probe. The returned object is
     * essentially the simulation results for the online model. The
     * <code>Trajectory</code> object contains a complete collection of all the
     * probe state object generated during the simulation.
     *
    ...
    /**
     * Get the type identifier string of the modeling element where this probe
     * currently exists. Note that all modeling elements have a static string
    ...
    /**
     * Returns the identifier of the hardware being modeling by the current
     * element.
     *
...
//    public double   getCoupledCavityPhase();
     ...
     * object is searched for the last state with the modeling type ID equal to
     * the given value.
     *
    ...
    /**
     * Sets the type identifier string of the modeling element where this probe
     * currently exists. Note that all modeling elements have a static string
     * identifier defined in their class definition.
     *
     * @param strTypeId static identifier string of the modeling element class
    ...
    /**
     * Sets the string identifier of the hardware node modeled by the current
     * element.
     *
...
//    
     ...
     *
     * @exception ModelException an error occurred while trying to initialize
     * the probe
     */
    public void initialize() throws ModelException;

    /**
     * Update all data and connections. Recompute any parameters consistent with
     * new probe state Optionally store probe state to save trajectory history
     * Resynchronize probe with data sources if they exist
     *
     * @exception ModelException an error occurred while trying to update the
     * probe
     */
    public void update() throws ModelException;

    /**
     * Perform any required post processing upon completion of algorithm
     * processing.
     *
     * @deprecated This has a zero implementation in <code>Probe</code> but
     * never does anything.
     */
    @Deprecated
    ...
    /**
     * Return the <code>IArchive</code> interface for archiving this algorithm
     * object.
     *
