 ...
 * propagating probe objects, represented by the <code>IProbe</code> interface,
 * through element objects, represented by the <code>IElement</code> interface.
 * <p>
 *
...
public interface IAlgorithm extends java.rmi.Remote, IContextAware, IArchive {
     ...
     *
     * @return  <b>true</b> if algorithm can propagation probe, <b>false</b>
     * otherwise
     *
     */
    ...
    /**
     * Initialize the algorithm for propagation. Reset any necessary state
     * variables
     *
