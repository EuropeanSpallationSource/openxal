...
/**
 * Parses the description of a <code>Probe</code> from an XML file. Returns an
 * instance of the appropriate <code>Probe</code> species. This class simply
...
public class ProbeXmlParser {
    ...
    /**
     * Parse the given data source and build a probe object according to that
     * described. Convenience method calling
    ...
    /**
     * Parse the given data source and build a probe object according to that
     * described. Calls method <code>{@link Probe#readFrom(DataAdaptor)}</code>
