 ...
 * XML file and creating the corresponding <code>DataAdaptor</code>. The task of
 * reading the DataAdaptor contents is delegated to the Trajectory class itself,
 * since it is responsible for writing the XML file.
 *
 * @author Craig McChesney
 * @version $id:
 *
 * @deprecated This functionality is now contained in the
 * <code>Trajectory</code> class itself
 *
 */
@Deprecated
