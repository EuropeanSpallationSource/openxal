 ...
 * words, and accelerator <em>line</em>.
 *
...
public class LineModel extends ElementSeq {
     ...
     */
    /**
     * I believe Sako-san wrote this to check for "valid" elements by looking at
     * their string identifiers (see
     * <code>{@link #VALID_ELEMENT_PATTERN}</code>). I'm not sure what valid is,
     * however.
     *
    ...
    /**
     * Create a new <code>LineModel</code> object with the given string type
     * identifier. The type refers to the type of accelerating structure this
     * models.
     *
    ...
    /**
     * Create a new <code>LineModel</code> object with the given type and given
     * string identifier.
     *
    ...
    /**
     * Create a new <code>LineModel</code> object with the given type, given
     * string identifier, and while reserving the given number of positions for
     * internal modeling elements. Note that if the number of child elements
     * grows large than the reservation number, extra space is automatically
     * allocated. It's just faster to use this feature if you do know the size
     * of the child set.
     *
     * @param strType the type class of the accelerating structure
     * @param strId the identifier of this particular structure
    ...
    /**
     * <h2>Override of
     * {@link xal.model.elem.ElementSeq#propagate(xal.model.IProbe)}</h2>
     *
     * @author Christopher K. Allen
     * @since Feb 27, 2009
     *
...
//            System.out.println("found valid elem0 = "+elem0);
    ...
    /**
     * <h2>Override of
     * {@link xal.model.elem.ElementSeq#backPropagate(xal.model.IProbe)}</h2>
     *
     * @author Christopher K. Allen
     * @since Feb 27, 2009
     *
    ...
    /**
     * Just added comment - obvious this is part of the back propagation
     * mechanism.
     *
     * @param probe beam representation
     * @param elem0 modeling element identifier
