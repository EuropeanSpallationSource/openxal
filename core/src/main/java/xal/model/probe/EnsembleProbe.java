...
/**
 * Represents an ensemble of particles. This <code>IProbe</code> type maintains
 * an <code>Ensemble</code> object which is a collection of
 * <code>Particle</code>s. Thus, this probe designed for multi-particle
 * simulation.
 *
...
public class EnsembleProbe extends BunchProbe<EnsembleProbeState> {
     ...
     *
     * @return a <code>EnsembleProbeState</code> encapsulating the probe's
     * current state
     */
    @Override
