...
public class EnsembleProbeState extends BunchProbeState<EnsembleProbeState> {
     ...
     */
    /**
     * Default constructor. Create a new, empty <code>EnsembleProbeState</code>
     * object.
     */
     ...
     * <code>EnsembleProbeState</code> objects with the state attributes of the
     * given <code>EnsembleProbeState</code>.
     *
    ...
    /**
     * Initializing Constructor. Create a new <code>EnsembleProbeState</code>
     * object and initialize it to the state of the probe argument.
     *
     * @param probe     <code>EnsembleProbe</code> containing initializing state
     * information
     */
    ...
    /**
     * Save the state values particular to <code>EnsembleProbeState</code>
    ...
    /**
     * Recover the state values particular to <code>EnsembleProbeState</code>
