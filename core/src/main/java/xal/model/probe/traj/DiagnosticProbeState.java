...
public class DiagnosticProbeState extends ProbeState<DiagnosticProbeState> {
     ...
     */
    /**
     * The accumulator for counting the model elements traversed by the probe at
     * this state
     */
     ...
     * <code>DisagnosticProbeState</code> objects with the state attributes of
     * the given <code>DiagnosticProbeState</code>.
     *
    ...
    /**
     * Creates a new <code>DiagnosticProbeState</code> with the state
     * initialized from the given <code>DiagnosticProbe</code>.
     *
     * @author Christopher K. Allen
     * @since Apr 19, 2011
     */
     ...
     *
     * @see
     * xal.model.probe.traj.ProbeState#addPropertiesTo(xal.tools.data.DataAdaptor)
     *
     * @author Christopher K. Allen
     * @since Jun 27, 2014
     */
     ...
     *
     * @see
     * xal.model.probe.traj.ProbeState#readPropertiesFrom(xal.tools.data.DataAdaptor)
     *
     * @author Christopher K. Allen
     * @since Jun 27, 2014
     */
