...
public class ParticleProbeState extends ProbeState<ParticleProbeState> /*implements ICoordinateState */ {
     ...
     */
    /**
     * Default constructor. Creates a new, empty <code>ParticleProbeState</code>
     * object.
     */
     ...
     * <code>ParticleProbeState</code> objects with the state attributes of the
     * given <code>ParticleProbeState</code>.
     *
    ...
    /**
     * Initializing constructor. Creates a new <code>ParticleProbeState</code>
     * object which contains a deep copy of the state of the given probe object.
     *
     * @param probe     <code>ParticleProbe</code> containing cloned initial state
     * data
     */
     ...
     *
     * @deprecated This is a duplicate of {@link #getPhaseCoordinates()} but
     * with a misleading name. I plan to get rid of it.
     */
    @Deprecated
     ...
     */
    /**
     * Copies and returns a new, identical instance of <strong>this</strong>
     * <code>ParticleProbeState</code>.
     *
     * @return a copy of <strong>this</strong> <code>ParticleProbeState</code>
     */
    @Override
