 ...
 * <code>@link ICoordinateState#getPhaseCoordinates()}</code> etc. Interface
 * <code>ICoordinateState</code> extends <code>IProbeState</code>. Well,
 * <code>TransferMapState</code> inherits from <code>ProbeState</code> which
 * implements <code>IProbeState</code>. It's getting dicey.
 * <br>
...
//    private PhaseVector[] _phaseCoordinates;
     ...
     */
    /**
     * Constructor, create new <code>TransferMapState</code> and initialize to
     * zero state values.
     */
...
//        this.setPhaseCoordinates( PhaseVector.newZero() );
     ...
     * <code>TransferMapState</code> objects with the state attributes of the
     * given <code>TransferMapState</code>.
     *
...
//    	this._phaseCoordinates	= transferMapState._phaseCoordinates.clone();
    ...
    /**
     * Initializing constructor - create a new <code>TransferMapState</code>
...
//        this.setPhaseCoordinates( probe.getPhaseCoordinates().clone() );
    ...
    /**
     * Sets the current partial transfer map, or "through map". This map
     * transfers particle phase coordinates through a distance occupied by this
     * state.
     *
     ...
     * <strong>&phi;</strong> maps the phase coordinates of particles at the
     * beginning of the <code>TransferMapTrajectory</code> parent (i.e., at the
     * first state of the trajectory object) to this state.
     *
    ...
    /**
     * <p>
     * Returns the partial transfer map that transports particle phase
     * coordinates through the space occupied by this state.
     * </p>
     * <p>
     ...
     * partial transfer maps from the first state to this state would yield the
     * returned value of <code>{@link #getTransferMap()}</code>.
     * </p>
     *
...
//
     ...
     * @see
     * xal.model.probe.traj.ProbeState#addPropertiesTo(gov.DataAdaptor.tools.data.IDataAdaptor)
     */
    @Override
     ...
     * @see
     * xal.model.probe.traj.ProbeState#readPropertiesFrom(gov.DataAdaptor.tools.data.IDataAdaptor)
     */
    @Override
