...
public interface IProbeState extends IArchive {
    ...
    /**
     * Sets the type identifier string of the modeling element where this state
     * was created. Note that all modeling elements have a static string
    ...
    /**
     * Gets the type identifier string of the modeling element where this state
     * was created. Note that all modeling elements have a static string
     * identifier defined in their class definition.
     *
