...
public class ParticleProbe extends Probe<ParticleProbeState> {
     ...
     */
    /**
     * Default constructor for ParticleProbe. Creates a new (empty) instance of
     * ParticleProbe.
     */
    ...
    /**
     * Copy constructor for ParticleProbe. Performs deep copy of target particle
     * probe.
     *
     ...
     * This method is essentially a proxy to the constructor
     * {@link #ParticleProbe(ParticleProbe)}.
     *
     ...
     * object.
     *
     * @return new <code>ParticleProbeState</code> object initialized to current
     * state
     *
     * @author Christopher K. Allen
     * @since Aug 13, 2002
