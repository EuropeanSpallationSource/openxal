 ...
 *
 * @deprecated functionality pushed down into child class class
 * <code>{@link EnvTrackerAdapt}</code>
 */
@Deprecated
public abstract class TrackerAdaptive extends Tracker {
    ...
    /**
     * Determine whether this algorithm supports the optional accuracy odrer and
     * maximum iteration methods.
     *
    ...
    /**
     * Sets the integration step size to be used at the beginning of the
     * algorithm or after <code>{@link #initialize()}</code> is called.
     *
