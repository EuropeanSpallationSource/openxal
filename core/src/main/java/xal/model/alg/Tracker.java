 ...
 *
 * <p>
 * Provides boiler plate functionality for probe tracking algorithms from which
 * more sophisticated algorithms may inherit.
 * </p>
 * <p>
 ...
 * <code>retractProbe</code> for forward-propagating and back-propagating the
 ...
 * the abstract method <code>doPropagation</code>.
 * </p>
 * <p>
 * <strong>NOTES:</strong> &nbsp; CKA
 * <br>
 * &middot; We might get a significant performance upgrade by eliminating the
 * calls to <code>validElement(IElement)</code> and
 * <code>validProbe(IProbe)</code> within the method
 * <code>propagate(IProbe, IElement)</code>.
 * <br>
 * &middot; Derived classes should call <code>registerProbeType(Class)</code> in
 * order that the the <code>validProbe()</code> method function properly, that
 * is, identify all probes that this class recognizes.
 * <br>
 * &middot; Perhaps it's better to eliminate <code>validProbe</code> as a safety
...
public abstract class Tracker implements IAlgorithm, IArchive {
    ...
    /**
     * <p>
     * The implementation must propagate the probe through the element according
     * to the dynamics of the specific algorithm. Derived classes must implement
     * this method but the <code>Tracker</code> base provided convenient methods
     * for this implementation.
     * </p>
     * <p>
     * NOTE:
     * <br>The protected method
     * <code>advanceProbe(IProbe, IElement, double)</code> is available for
     * derived classes. It is a convenience method for performing many of the
     * common tasks in the forward propagation of any probe. Thus, its use is
     * not required.
     * </p>
     *
    ...
    /**
     * flag to update the beam phase in RF gaps ( a la parmila) rather than use
     * default values
     */
     ...
     */
    /**
     * Read the contents of the supplied <code>DataAdaptor</code> and return a
     * new instance of the appropriate <code>IAlgorithm</code> object
     ...
     * @since &gt; Oct 17, 2012
     *
     * @deprecated I want to discourage use of this method since it return the
     * same "default" algorithm regardless the type of probe being used. Please
     * refer to <code>{@link AlgorithmFactory}</code>.
     */
    @Deprecated
     ...
     *
     * <p>
     * The record used to initialize the data is that with the primary key have
     * the given value of the argument <code>strLocationId</code>.
     * </p>
     *
     * <h3>NOTE</h3>
     * <p>
     ...
     * @param sequence The sequence for which to get the adaptive tracker
     * parameters.
     *
     * @return new IAlgorithm object initialized to the given table data
     *
    ...
    /**
     * Flag indicating that propagation should stop at the entrance of the stop
     * element.
     */
    ...
    /**
     * <p>
     * Creates a new, empty, instance of Tracker.</p>
     *
     * <p>
     * Note that if the child algorithm may handle more than one probe type the
     * additional types should be registered using the method
     * registerProbeType() in the constructor.
     * </p>
     *
    ...
    /**
     * Returns the flag that indicates whether or not the stop element is
     * propagated through.
     *
     * @return  <code>true</code> indicates propagation stops after the stop
     * element, <code>false</code> indicates propagation stops before the stop
     * element (entrance)
     *
     * @author Christopher K. Allen
     * @since Oct 20, 2014
     ...
     *
     * @return <code>true</code> if phase calculations are made,
     * <code>false</code> otherwise
     */
    @Override
    public boolean getRfGapPhaseCalculation() {
        return bolCalcRfGapPhase;
    }
    ...
    public void setRfGapPhaseCalculation(boolean tf) {
        bolCalcRfGapPhase = tf;
    }

    /**
     * Sets the element from which to start propagation.
     *
     * @param id <code>String</code> id of the element from which to start
     * propagation
     */
    @Override
     ...
     *
     * @param id <code>String</code> id of the element at which to stop
     * propagation
     */
    @Override
    ...
    /**
     * Sets the flag that determines whether or not the propagation stops at the
     * entrance of the stop element (if set), or at the exit of the stop node.
     * The later case is the default.
     *
     * @param bolInclStopElem propagation stops after stop element if
     * <code>true</code>, before the stop element if <code>false</code>
     *
     * @author Christopher K. Allen
     * @since Oct 20, 2014
     */
     ...
     * <br>
     * &middot; We might get a significant performance upgrade by eliminating
     * the internal call to <code>{@link #validProbe(IProbe)}</code>.
     * <br>
     * &middot; The method <code>validElement(IElement)}</code> needs to be
     * called here in the current implementation. It is called for every element
     ...
     */
    /**
     * Load the state and settings of this algorithm from a data source exposing
     * the <code>DataAdaptor</code> interface. Subclasses should override this
     * method to recover the data particular to there own operation.
     *
    ...
    /**
     * <p>
     * Convenience method for common propagation dynamics for all probes. This
     * method performs propagation tasks that are common to all probes.
     * </p>
     * <p>
    ...
    /**
     * <p>
     * Override of xal.model.alg.Tracker#advanceProbe(xal.model.IProbe,
     ...
     * of kinetic energy, the <em>decrement</em> of lattice position, etc.
     * </p>
     * <p>
     * NOTES: CKA
     * <br>
     * &middot; In order to use this method the derived class must override the
     * <code>propagate</code> method, since it default implementation forward
     * propagates the probe.
     * </p>
     *
     ...
     *
     * @throws ModelException error occured while trying to update the probe
     * values (unlikely)
     *
     * @author Christopher K. Allen
     * @since Feb 3, 2009
    ...
    /**
     * <p>
     * Check if the specified element is requires probe propagating. That is, is
     * the element within the specified start and stop boundaries defined with
     * this algorithm object.
     * </p>
     * <p>
     * NOTE: CKA
     * <br>
     * &middot; Maybe there is a better way of using start and stop elements.
     * </p>
     *
     ...
     */
    /**
     * Register the class of a probe recognized by this algorithm. This method
     * should be called in the constructor of all derived classes for each
     * additional probe that the algorithm may propagate.
     *
     * @param clsProbeType class object of probe which this algorithm can
     * propagate
     */
