 ...
 *
 * <p>
 * This tracker object is based The <code>EnvelopeProbe</code>'s state, which is
 * a <code>CovarianceMatrix</code> object, is advanced using the linear dynamics
 * portion of any beamline element (<code>IElement</code> exposing object)
...
public class EnvelopeBacktracker extends EnvelopeTrackerBase {
    ...
    /**
     * <p>
     * Create a new, uninitialized <code>EnvelopeBacktracker()</code> algorithm
     * object. This is the default constructor to be used when creating objects
     * of this type.
     * </p>
     */
    ...
    /**
     * <p>
     * This method is a protected constructor meant only for building child
     * classes.
     * </p>
     *
    ...
    /**
     * <h2>Implementation of Abstract Tracker#doPropagation(IProbe,
     * IElement)</h2>
     *
     * <p>
     ...
     * @since Feb 9, 2009
     *
     * @see xal.model.alg.Tracker#propagate(xal.model.IProbe,
     * xal.model.IElement)
...
//        dblStep = propLen / cntSteps;
     ...
     * back-propagated. The method utilizes all the space charge mechanisms of
     * the base class <code>EnvelopeTracker</code>.
     * </p>
     *
     ...
     * @since Feb 9, 2009
     *
     * @see xal.model.alg.EnvelopeTracker#advanceState(xal.model.IProbe,
     * xal.model.IElement, double)
     *
     */
...
//        probe.setBetatronPhase(vecPhs1);
     ...
     * distance <code>dblLen</code> for the beamline modeling element
     * <code>ifcElem</code>, and for the given <code>probe</code>. We include
     * space charge and emittance growth effects if specified.
     * </p>
     *
     * <p>
     * <strong>NOTE</strong>: (CKA)
     * <br>
     * &middot; If space charge is included, the space charge matrix is computed
     * for length <code>dblLen</code>, but at a half-step location behind the
     * current probe position. This method is the same technique used by
     * Trace3D. The space charge matrix is then pre- and post- multiplied by the
     * element transfer matrix for a half-step before and after the mid-step
     * position, respectively.
     * <br>
     * &middot; I do not know if this (leap-frog) technique buys us much more
     * accuracy then full stepping.
     * </p>
     *
     ...
     * @see EnvelopeTracker#transferEmitGrowth(EnvelopeProbe, IElement,
     * PhaseMatrix)
     ...
     * of <b>&sigma;</b>, this method reduces them by the same amount.
     * Specifically, let <i>x</i> be either transverse phase space variable. The
     * emittance growth effect is achieved by first multiplying the element
     * &lt;x'|x&gt; of the RF gap transfer matrix <b>&Phi;</b> by the factor
     ...
     * covariance matrix <b>&tau;</b> is back-propagated by the modified
     * transfer matrix <b>&Phi;</b>, the moment &lt;<i>x'</i><sup>2</sup>&gt; is
     ...
     * &Delta;&lt;<i>x'<sub>f</sub></i><sup>2</sup>&gt; rather than increased by
     * it.
     * </p>
     * <p>
     ...
     * @see EnvelopeTracker#addEmittanceGrowth(EnvelopeProbe, IElement,
     * PhaseMatrix)
     *
...
//}
     ...
     * represent an H<sup>+</sup> beam, the electrons are added and the beam
     * becomes H<sup>-</sup>.
     * </p>
     * <p>
     * The opposite of
