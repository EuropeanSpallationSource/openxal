 ...
 * conjugation, however, the matrix is computation using the values of the
 * probe's correlation matrix. The result is a nonlinear effect. The space
 * charge forces are computed using a linear fit to the fields generated by an
 * ellipsoidal charge distribution with the same statistics described in the
 * probe's correlation matrix. The linear fit is weighted by the beam
 * distribution itself, so it is more accurate in regions of higher charged
 * density. For a complete description see the reference below.
 * </p>
 * <p>
 ...
 * <h3>NOTES:</h3>
 * <p>
 * &middot; Completed: Replace <code>EllipsoidalCharge</code> with
 * <code>BeamEllipsoid</code>.
 * <br>
...
public class Trace3dTracker extends Tracker {
     ...
     * <h3>NOTE:</h3>
     * <p>
     * <em>&middot; This currently works only for upright beam ellipses in
     * configuration space!</em>
     * <br>
     * &middot; This method was converted from the use of
     * <code>EllipsoidalCharge</code> to class <code>BeamEllipsoid</code> to
