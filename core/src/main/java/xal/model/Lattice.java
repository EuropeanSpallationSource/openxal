...
public class Lattice extends ElementSeq {
    ...
    /**
     * Creates a new instance of Lattice and reserves space for a szReserve
     * length lattice.
     *
     * @param strId identifier of the lattice
    ...
    /**
     * Return a list of the <code>RingModel</code> objects contained in this
     * model.
     *
    ...
    /**
     * Return a list of the <code>LineModel</code> objects contained in this
     * model.
     *
     ...
     * method of the probe then updated by calling the <code>update()</code>
     * method in order to save the initial state of the probe into its
     * trajectory.
     * </p>
     * <p>
     ...
     *
     * @throws IOException I guess this is thrown when
     * <code>LatticeXmlWriter</code> is unable to parse this lattice
     */
