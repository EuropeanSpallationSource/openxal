...
public abstract class ArrayValue extends Number {
    ...
    /**
     * Factory method to instantiate a new ArrayValue store for the byte array
     * type
     */
    ...
    /**
     * Factory method to instantiate a new ArrayValue store for the byte scalar
     * type
     */
    ...
    /**
     * Factory method to instantiate a new ArrayValue store for the short array
     * type
     */
    ...
    /**
     * Factory method to instantiate a new ArrayValue store for the short scalar
     * type
     */
    ...
    /**
     * Factory method to instantiate a new ArrayValue store for the int array
     * type
     */
    ...
    /**
     * Factory method to instantiate a new ArrayValue store for the int scalar
     * type
     */
    ...
    /**
     * Factory method to instantiate a new ArrayValue store for the long array
     * type
     */
    ...
    /**
     * Factory method to instantiate a new ArrayValue store for the long scalar
     * type
     */
    ...
    /**
     * Factory method to instantiate a new ArrayValue store for the float array
     * type
     */
    ...
    /**
     * Factory method to instantiate a new ArrayValue store for the float scalar
     * type
     */
    ...
    /**
     * Factory method to instantiate a new ArrayValue store for the double array
     * type
     */
    ...
    /**
     * Factory method to instantiate a new ArrayValue store for the double
     * scalar type
     */
    ...
    /**
     * Factory method to instantiate a new ArrayValue store for the String array
     * type
     */
    ...
    /**
     * Factory method to instantiate a new ArrayValue store for the String
     * scalar type
     */
    ...
    /**
     * Create a new ArrayValue from an Object array. Inspect the array type to
     * create the proper kind of storage.
     */
...
/**
 * Storage for a numeric array type. There will be a concrete subclass of
 * NumericStore for each numeric type.
 */
...
final class ByteStore extends NumericStore {
    ...
    /**
     * Override numeric store by directly returning the byte array for best
     * performance
     */
    @Override
    public byte[] byteArray() {
...
final class ShortStore extends NumericStore {
    ...
    /**
     * Override numeric store by directly returning the short array for best
     * performance
     */
    @Override
    public short[] shortArray() {
...
final class IntStore extends NumericStore {
    ...
    /**
     * Override numeric store by directly returning the int array for best
     * performance
     */
    @Override
    public int[] intArray() {
...
final class LongStore extends NumericStore {
    ...
    /**
     * Override numeric store by directly returning the long array for best
     * performance
     */
    @Override
    public long[] longArray() {
...
final class FloatStore extends NumericStore {
    ...
    /**
     * Override numeric store by directly returning the float array for best
     * performance
     */
    @Override
    public float[] floatArray() {
...
final class DoubleStore extends NumericStore {
    ...
    /**
     * Override numeric store by directly returning the double array for best
     * performance
     */
    @Override
    public double[] doubleArray() {
