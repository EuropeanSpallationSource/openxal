...
public abstract class SquareMatrix<M extends SquareMatrix<M>> extends BaseMatrix<M> {
     ...
     */
    /**
     * Returns the size of this square matrix, that is, the equal number of rows
     * and columns.
     *
    ...
    /**
     * <p>
     * Solves the linear matrix-vector system without destroying the given data
     * vector. Say the linear system can be represented algebraically as
     * <br>
     * <br>
     * &nbsp; &nbsp; <b>Ax</b> = <b>y</b> ,
     * <br>
     ...
     * determined, and <b>y</b> is the data vector provided as the argument. The
     ...
     * </p>
     * <p>
     * Note that the inverse matrix <b>A</b><sup>-1</sup> is never computed. If
     * this system is to be solved repeated for the same matrix
     * <b>A</b> it may be preferable to invert this matrix and solve the
     * multiple system with matrix multiplication.
     * </p>
     *
     * @param vecObs the data vector
     *
     * @return vector which, when multiplied by this matrix, will equal the data
     * vector
     */
    ...
    /**
     * <p>
     * Solves the linear matrix-vector system and returns the solution in the
     * given data vector. Say the linear system can be represented algebraically
     * as
     * <br>
     * <br>
     * &nbsp; &nbsp; <b>Ax</b> = <b>y</b> ,
     ...
     * </p>
     * <p>
     * The value of <b>x</b> is returned within the argument vector. Thus, the
     ...
     * </p>
     * <p>
     * Denote by <b>&sigma;</b><sub>0</sub> this matrix object, and denote the
     * argument matrix as <b>&Phi;</b>. Then the returned matrix,
     * <b>&sigma;</b><sub>1</sub> is given by
     * <br>
     * <br>
     * &nbsp; &nbsp; <b>&sigma;</b><sub>1</sub> =
     * <b>&Phi;</b><b>&sigma;</b><sub>0</sub><b>&Phi;</b><sup><i>T</i></sup>
     * <br>
     * <br>
     * </p>
     *
     * @param matPhi conjugating matrix <b>&Phi;</b> (typically a transfer
     * matrix)
     *
     ...
     * <br>
     * &nbsp; &nbsp; <b>&sigma;</b><sub>1</sub> =
     * <b>&Phi;</b><b>&sigma;</b><sub>0</sub><b>&Phi;</b><sup><i>-1</i></sup>
     * <br>
     * <br>
     * </p>
     *
     ...
     */
    /**
     * Constructor for SquareMatrix. Creates a new, uninitialized instance of a
     * square matrix with the given matrix dimensions. The matrix contains all
     * zeros.
     *
    ...
    /**
     * Copy constructor for <code>SquareMatrix</code>. Creates a deep copy of
     * the given object. The dimensions are set and the internal array is
     * cloned.
     *
    ...
    /**
     * <p>
     * Initializing constructor for bases class <code>SquareMatrix</code>. Sets
     * the entire matrix to the values given in the Java primitive type double
     * array. Warning! The argument becomes the internal matrix representation
     * and, thus, is not immutable.
     * </p>
     * <p>
     * The dimensions of the given Java double array must be consistent with the
     * size of the matrix. Thus, if the arguments are inconsistent, an exception
     * is thrown.
     * </p>
     *
     ...
     * @exception IllegalArgumentException the argument is degenerate, not fully
     * allocated
     *
     * @author Christopher K. Allen
     * @since Oct 4, 2013
