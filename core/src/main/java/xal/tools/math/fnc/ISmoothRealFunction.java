...
public interface ISmoothRealFunction extends IRealFunction {
    ...
    /**
     * <p>
     * Return the first-order derivative (<i>n</i> = 1) of the function. Thus,
     ...
     * derivative
     * <i>f</i>'(<i>x</i>) should always exist for any class implementing this
     * interface.
     * </p>
     *
    ...
    /**
     * <p>
     * Compute and return the <i>n<sup>th</sup></i> derivative at the given
     * location <i>x</i>
     ...
     * <i>n</i> greater than a certain value. Consider a polynomial for example,
     * when <i>n</i> is greater than the degree of that polynomial.
     * </p>
     *
     * @param nOrder the order <i>n</i> of the derivative
     * @param dblLoc the location <i>x</i> at which to evaluate the derivative
     *
     * @return the derivative <i>f</i><sup>(<i>n</i>)</sup>(<i>x</i>) of the
     * function
     *
