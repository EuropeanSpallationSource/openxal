 ...
 * <p>
 * <h4>NOTES: CKA</h4>
 * This class is copied from the original
 * <code>xal.tools.LinearInterpolator</code> implemented by Thomas Pelaia.
 * Although it would be more attractive to simply move the original class to the
 * current package, it is difficult to make dramatic changes in the core once
 * established. The class has been modified slightly to support the
 * <code>IRealFunction</code> interface.
 * </p>
 *
 * @author tap
