 ...
 * the <code>{@link #getDomain()}</code> method the default implementation
...
public interface IRealFunction {
     ...
     * return the entire real line &reals;. That is, the function is assumed to
     * be defined on the whole real line.
     *
     ...
     *
     * @throws IllegalArgumentException may be thrown if location is outside
     * function domain
     *
     * @since Sep 24, 2015 by Christopher K. Allen
     */
