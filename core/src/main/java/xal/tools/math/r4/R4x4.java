 ...
 * operations and linear transforms on <b>R</b><sup>4</sup> that are represented
 * by these matrices.
 * </p>
 *
 * @author Christopher K. Allen
...
public class R4x4 extends SquareMatrix<R4x4> {
     ...
     * </p>
     *
     * @param matSO2 a rotation matrix in two dimensions, i.e., a member of
     * <i>SO</i>(2) &sub; <b>R</b><sup>2&times;2</sup> &cong;
     * <i>S</i><sup>1</sup>
     *
     * @return rotation matrix in <i>S0</i>(4) which is direct product of
     * rotations in <i>S0</i>(2)
     */
