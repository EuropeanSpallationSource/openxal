...
public class R4 extends BaseVector<R4> {
     ...
     */
    /**
     * Class <code>R4x4.IND</code> is an enumeration of the matrix indices for
     * the <code>R4x4</code> class.
     *
     * @author Christopher K. Allen
     * @since Oct 4, 2013
     */
    ...
    /**
     * <p>
     * Initializing constructor for bases class <code>Vector</code>. Sets the
     * entire matrix to the values given in the Java primitive type double
    ...
    /**
     * Copy constructor for <code>R4</code>. Creates a cloned copy of the given
     * parent object.
     *
