...
/**
 * Real matrix with arbitrary row and column dimensions. This class supports the
 * usual matrix operations for non-square matrices but does not optimize for
 * square matrices. Because general matrix dimensions must be considered there
 * is more overhead when using this class over the specialized matrix classes.
 *
 *
 * @author Christopher K. Allen
 * @since Jul 21, 2015
...
public class Rmxn extends BaseMatrix<Rmxn> {
     ...
     */
    /**
     * Creates and returns a new instance of the identity matrix with the given
     * dimensions.
     *
     * @param cntSize the size of the identity matrix (i.e., row and column
     * count)
     * @return
     *
     ...
     */
    /**
     * Zero-matrix constructor for class <code>Rmxn</code>. A matrix of the
     * given dimension is created, all the elements are zero.
     *
    ...
    /**
     * <p>
     * Initializing constructor for class <code>Rmxn</code>. Initializes the
     * matrix to the values given in the Java primitive type double array by
     * setting the internal matrix representation to the given Java array. The
     * matrix is shaped according to the (row-packed) argument.
     * </p>
     * <p>
     ...
     * </p>
     * <p>
     * The returned vector must be created using Java reflection, so this
     * operation is somewhat more risky and expensive than and in place
     * multiplication.
     * </p>
     *
     ...
     *
     * @throws IllegalArgumentException the argument vector must have compatible
     * dimensions
     *
     * @author Christopher K. Allen
     * @since Oct 11, 2013
     ...
     * same dimensions as this object. That is, the returned object is in the
     * same equivalence class of matrices as this one.
     *
     ...
     */
    /**
     * Checks that the given matrix's dimensions are equal to the dimensions of
     * this matrix.
     *
     * @param matTest matrix under test
     *
     * @throws IllegalArgumentException the given matrix's dimensions are not
     * equal
     *
     * @since Jul 22, 2015 by Christopher K. Allen
     */
