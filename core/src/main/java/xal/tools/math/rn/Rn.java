...
public class Rn extends BaseVector<Rn> {
     ...
     */
    /**
     * Zero matrix constructor for <code>Rn</code>. A new vector is created with
     * the given dimension and all zero elements.
     *
    ...
    /**
     * Initializing constructor for <code>Rn</code>. The element values are
     * loaded from the given data source.
     *
    ...
    /**
     * <p>
     * Initializing constructor for bases class <code>Rn</code>. Sets the entire
     * vector to the values given in the Java primitive type double array. The
     ...
     * same size as this object. That is, the returned object is in the same
     * equivalence class of vectors as this one.
     *
