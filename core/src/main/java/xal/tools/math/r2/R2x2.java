...
/**
 * <p>
 * Represents an element of R2x2, the set of real 3x3 matrices. The class a set
 * of the usual matrix operations and linear transforms on R3 represented by the
 * matrix.
 * </p>
 *
...
public class R2x2 extends SquareMatrix<R2x2> implements Serializable {
    ...
    /**
     * Create and return the generator element of SO(2) which is a
    ...
    /**
     * Create a deep copy of the given <code>R2x2</code> matrix object. The
     * returned object shares no references with the argument.
     *
    ...
    /**
     * Create a R2x2 instance and initialize it according to a token string of
     * element values.
     *
    ...
    /**
     * Parsing Constructor - create a R2x2 instance and initialize it according
