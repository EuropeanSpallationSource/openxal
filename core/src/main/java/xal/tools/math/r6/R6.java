...
public class R6 extends BaseVector<R6> {
    ...
    /**
     * <p>
     * Initializing constructor for bases class <code>R6</code>. Sets the entire
     * matrix to the values given in the Java primitive type double array. The
    ...
    /**
     * Copy constructor for <code>R6</code>. Creates a cloned copy of the given
     * parent object.
     *
