...
public class R3x3 extends SquareMatrix<R3x3> implements Serializable {
    ...
    /**
     * Enumeration for the element positions of an <code>R3x3</code> matrix
     * element. Also provides some convenience functions for accessing these
     * <code>R3x3</code> elements.
     *
     * @author Christopher K. Allen
     */
    public enum POS {
    ...
    /**
     * Create and return the generator element of SO(3) which is a
    ...
    /**
     * Create a deep copy of the given <code>R3x3</code> matrix object. The
     * returned object is completely decoupled from the original.
     *
    ...
    /**
     * Create a R3x3 instance and initialize it according to a token string of
     * element values.
     *
     ...
     * itself is unchanged). The dimensions of the argument must be 3&times;3.
     *
     * @param arrValues initial values for the new matrix object
     *
     * @exception ArrayIndexOutOfBoundsException the argument must have the
     * dimensions 3&times;3
     *
     * @author Christopher K. Allen
     * @since Oct 4, 2013
     */
    ...
    /**
     * Parsing Constructor - create a R3x3 instance and initialize it according
     * to a token string of element values.
     *
     * The token string argument is assumed to be one-dimensional and packed by
     * column (ala FORTRAN).
     *
    ...
    /**
     * Set the element specified by the position in the argument to the new
