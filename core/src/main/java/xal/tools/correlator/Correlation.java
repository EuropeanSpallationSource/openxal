...
public class Correlation<T> {
     ...
     * @return true if the sourceName identifies a record in this correlation
     * and false otherwise.
     */
    ...
    /**
     * Get the record identified by the source name (same one registered with
     * the correlator). In general this record can be any class that the
     * specific implementation chooses to make. The record holds the value and
     * time stamp of the specific measurement (e.g. PV timestamp and value). For
     * a ChannelCorrelator, this method returns a ChannelTimeRecord.
     *
    ...
    /**
     * Check whether this correlation contains all of the records of a specified
     * correlation.
     *
     * @param correlation The correlation to test for being contained within
     * <code>this</code>
    ...
    /**
     * Average time of the time stamps from the records in seconds since the
     * Java epoch
     *
    ...
    /**
     * Convenience method to get a Java date for a given time stamp by averaging
