...
public class PatientBroadcaster<RecordType> extends AbstractBroadcaster<RecordType> {
    ...
    /**
     * Handle the BinListener event and determine if we should cache it or post
     * it.
     *
    ...
    /**
     * Determine whether the correlation time intersects with the last time
     * within the bin time span.
     *
     * @param correlationTime The time of the correlation with which to test
     * against the last time.
     * @return true if the correlation correlates with the last correlation and
     * false otherwise.
     */
