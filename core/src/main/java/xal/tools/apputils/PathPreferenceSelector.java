...
/**
 * Dialog box for selecting a file path and saving it as the default URL spec in
 * a preference. The dialog box presents the user with a field for entering the
 * path or the option of browsing to the path. A button allows the user to make
 * the path the default path. The default path is stored as a URL spec via a
 * Preferences instance provided in the constructor.
 *
 * @author tap
 */
public class PathPreferenceSelector extends JDialog implements ScrollPaneConstants {
     ...
     * Constructor
     *
     * @param defaults The Preferences instance that stores the default URL spec
     * of the path.
     * @param urlKey The preference key used for associating the URL spec to
     * store.
    ...
    /**
     * Handle the text changed event by updating the view to reflect the present
     * state.
     *
...
class CustomChooser extends JFileChooser {
     ...
     * Constructor
     *
     * @param defaults The preference that stores the default location of the
     * path.
     ...
     * @throws java.net.MalformedURLException if the default URL spec is not a
     * valid URL
     */
     ...
     * @throws java.net.MalformedURLException if the file path cannot form a
     * valid URL
     */
     ...
     * @throws java.net.MalformedURLException if the file cannot form a valid
     * URL
     */
     ...
     *
     * @return true if the file chooser was approved and false if it wasn't
     * approved.
     */
     ...
     *
     * @return true if the file chooser was canceled and false if it wasn't
     * canceled.
     */
