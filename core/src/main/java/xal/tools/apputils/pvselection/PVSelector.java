 ...
 * selected PV in a text box. Note this is for single selection only.
 *
...
public class PVSelector extends JPanel {
    ...
    /**
     * name for this PV selector - use it to differentiate PV sources in the
     * case you use more than one PV selector
     */
