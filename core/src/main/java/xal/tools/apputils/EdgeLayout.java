...
public class EdgeLayout implements LayoutManager {
    ...
    /**
     * Add the component to the layout at the specified coordinates with the
     * specified struts and strut and growth behaviors.
     */
    ...
    /**
     * Add the component to the layout at the specified coordinates with the
     * specified struts and strut and no growth.
     */
    ...
    /**
     * Add the component to the layout at the specified coordinates with the
     * specified strut and growth behaviors. The struts are calculated based on
     * the component's preferred size and the specified container size.
     */
    ...
    /**
     * Add the component to the parent at the specified coordinates with the
     * specified strut and growth behaviors. The struts are calculated based on
     * the component's preferred size and the parent's bounds at the time this
     * method is invoked.
     */
    ...
    /**
     * Add the component to the parent at the specified coordinates with the
     * specified strut behavior. The growth behavior is set to NO_GROWTH.
     */
