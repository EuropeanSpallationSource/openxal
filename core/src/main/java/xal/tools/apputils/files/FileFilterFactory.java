...
public class FileFilterFactory {
    ...
    /**
     * Applies the file filters to the file chooser and returns this file
     * chooser. Existing file filters are removed from the file chooser and then
     * new file filters are added to the file chooser consistent with the
     * specified file types and descriptions.
     *
     ...
     * @return The file chooser that accepts the specified file types (same file
     * chooser as the argument)
     */
    ...
    /**
     * Create a file filter that accepts files of the specified type. This is a
     * supporting method for creating file choosers. A type is identified by its
     * filename suffix.
     *
    ...
    /**
     * Create a file filter that accepts files of the specified types. This is a
     * supporting method for creating file choosers. A type is identified by its
     * filename suffix.
     *
    ...
    /**
     * Determine whether the extension matches the file type. If the file type
     * is the wildcard extension, then accept all extensions as matching.
     *
     * @param extension the file extension to test for matching to the file
     * type.
     * @param fileType the file type against which to test for matching the file
     * extension.
