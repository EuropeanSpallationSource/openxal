...
public class DoubleToString {
    ...
    /**
     * I'm not sure how this works or what it does since Craig originally build
     * this class. There's not much documentation.
     *
     * @param s
     * @param d
    ...
    /**
     * I think this is one of the two main methods in this class. It appends a
     * double number to a <code>StringBuffer</code> object using optimized
     * float-to-character representation algorithms.
     *
     * @param s string buffer
     * @param d a double-valued number being appended to the string
     *
     * @author Christopher K. Allen
     * @since Apr 19, 2011
     */
    ...
    /**
     * I think this is one of the two main methods in this class. It appends an
     * integer number to a <code>StringBuffer</code> object using optimized
     * float-to-character representation algorithms.
     *
     * @param s string buffer
     * @param i a double-valued number being appended to the string
     *
     * @author Christopher K. Allen
     * @since Apr 19, 2011
     */
