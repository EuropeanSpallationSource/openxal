 ...
 * implementation is "hideously under-optimized".  This implementation is
...
1e305D, 1e306D, 1e307D, 1e308D
   ...
   * build this class.  There's not much documentation.
   *
   * @param s
   * @param d
   ...
   * class.  It appends a double number to a <code>StringBuffer</code>
  ...
  /**
   * I think this is one of the two main methods in this
   * class.  It appends an integer number to a <code>StringBuffer</code>
   * object using optimized float-to-character representation
   * algorithms.
   *
   * @param s   string buffer
