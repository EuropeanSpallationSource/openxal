...
public class ScientificNumberFormat extends NumberFormat {
    ...
    /**
     * format the number padding with spaces to the left (right justification)
     * as needed to fill out the field width
     */
     ...
     * @param fixedLength specified whether to pad the formatted output to the
     * left (right justification) as needed to fill out the field width
     */
    ...
    /**
     * Convenience constructor. By default, formats a value with padding to the
     * field width (set fixedLength to change mode).
     *
     * @param significantDigits total number of significant digits to display
     * @param fieldWidth field width of right justified text to display
     */
    ...
    /**
     * Convenience constructor. The width is significant digits + 1 space + 1
     * sign + 1 decimal point + 5 for exponent field. By default, formats a
     * value without padding to the field width (set fixedLength to change
     * mode).
     *
     * @param significantDigits total number of significant digits to display
     */
    ...
    /**
     * Empty convenience constructor defaulting to four significant digits. By
     * default, formats a value without padding to the field width (set
     * fixedLength to change mode).
     */
    ...
    /**
     * Determine whether the formatted output is padded with spaces to the left
     * (right justification) as needed to fill out the fixed width.
     *
    ...
    /**
     * Get the field width for displaying the right justified output when used
     * with fixed length mode.
     *
    ...
    /**
     * Set the field width (used with fixed length mode to format output with
     * fixed width padding with spaces as needed)
     *
     * @param fieldWidth field width of right justified text to display
     */
    ...
    /**
     * Implement the abstract format method by delegating to an internal number
     * format
     */
    @Override
    ...
    /**
     * Implement the abstract parse method by delegating to an internal number
     * format
     */
    @Override
    ...
    /**
     * Append the formatted values to the output throwing any internal
     * IOException from the output. Use this method when you want to handle IO
     * Exceptions
     *
     * @param output the output to which to append the formatted values
     * @param separator the characters to insert between each formatted value
     * (e.g. this could be a comma)
    ...
    /**
     * Convenience method to append the formatted values to the output
     * suppressing IOException and instead dumping the stack trace upon
     * exception. This is useful when calling with outputs that don't through
     * IOException (e.g. StringBuffer and StringBuilder)
     *
     * @param output the output to which to append the formatted values
     * @param separator the characters to insert between each formatted value
     * (e.g. this could be a comma)
     ...
     * @param separator the characters to insert between each formatted value
     * (e.g. this could be a comma)
     * @param terminator the characters to append to the end of the line of
     * formatted values (e.g. this could be "\n")
     * @param values the values to format and output
     */
    ...
    /**
     * Convenience method to print the formatted values with the system's
