...
public abstract class DatabaseAdaptor {
    ...
    /**
     * Get a new database adaptor using the default database adaptor. Site
     * specific code should provide an implementation of this method using the
     * site specific database drivers.
     *
     * @return return a new instance of the default database adaptor
    ...
    /**
     * Fetch the list of nontrivial schema. By default, fetch all schema. Driver
     * specific subclasses should provide a more accurate implementation.
     *
