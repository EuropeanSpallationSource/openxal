...
public class ConnectionDictionary extends Properties {
    ...
    /**
     * Get the connection dictionary from the file specified in the user's
     * preferences.
     *
    ...
    /**
     * Get the connection dictionary from the URL specified in the user's
     * preferences.
     *
     * @return the user's default connection dictionary
     */
    ...
    /**
     * Get the connection dictionary from the URL specified in the user's
     * preferences and for the specified account.
     *
     ...
     *
     * @param accountNames ordered (most preferred is first) accounts to search
     * among
     */
    ...
    /**
     * Get the connection dictionary from the URL specified in the user's
     * preferences and for the specified account and server.
     *
     * @param accountName name of the account for which to initialize the
     * connection dictionary (or null to use the default account if any)
    ...
    /**
     * Determine if the dictionary is sufficiently complete regardless whether
     * the data is right or wrong.
     *
     * @return true if the dictionary contains the user name, password and
     * database URL (database adaptor is optional)
     */
