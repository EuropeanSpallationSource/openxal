...
public class ConcreteBlob implements Blob {
    ...
    /**
     * Get the position of the first occurrence of pattern in this BLOB starting
    ...
    /**
     * Determine if the pattern matches the specified range of bytes in this
     * BLOB.
     *
     * @param pattern the pattern of bytes to match against data bytes
     * @param offset the index of the byte in pattern against which to match the
     * corresponding byte in data
     * @param start the index in of the byte in data against which to match the
     * corresponding byte in pattern
     */
    ...
    /**
     * Get an output stream for writing to this BLOB. This implementation simply
