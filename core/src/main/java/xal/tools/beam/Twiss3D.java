 ...
 * is basically a container allowing type safe passing of Twiss parameters
 * rather passing an array which allows for runtime errors.
 *
 * @author Christopher K. Allen
 * @since Dec, 2006
 * @version Nov 5, 2013
...
public class Twiss3D implements IArchive {
    ...
    /**
     * Initializing Constructor: Create a new <code>Twiss3D</code> object and
     * initialize to the given argument values.
     *
    ...
    /**
     * Initializing Constructor: Create a new <code>Twiss3D</code> object and
     * initialize it with data from the data source behind the
    ...
    /**
     * Returns the array of Twiss parameters for this distribution for all three
     * planes.
     *
    ...
    /**
     * Recover the state values particular to <code>BunchDistribution</code>
     ...
     *
     * CKA Notes: - I don't like this method since it can break the
     * self-consistency of the class. But it's here for backward convenience
     * within the class and I added the check for 3D and the subsequent runtime
     * error.
     *
