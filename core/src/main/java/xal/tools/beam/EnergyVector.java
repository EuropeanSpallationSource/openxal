 ...
 * </p>
 * <p>
 * The position &phi; of the synchronous particle is the origin of the local
 ...
 * particle, are are usually described using a <code>PhaseVector</code> object.
 * </p>
 * <p>
 * The synchronous phase coordinates are represented in homogeneous coordinates
 * so that they may be acted on by class <code>SyncMatrix</code> objects. In
 ...
 * </p>
 * <p>
 * Currently this class has minimal functionality. Additional capabilities
...
public class EnergyVector extends BaseVector<EnergyVector> {
    ...
    /**
     * Initializing constructor for <code>EnergyVector</code>. The initial
     * values for the vector are contained in the given string. The string
     * should contain comma-separated values with enclosing parenthesis,
     * brackets, or curly braces. For more information see
    ...
    /**
     * Initializing constructor for class <code>EnergyVector</code>. The initial
    ...
    /**
     * Initializing constructor for class <code>EnergyVector</code>. Initial
     * values are taken from the given data source with <code>DataAdaptor</code>
     * interface.
     *
