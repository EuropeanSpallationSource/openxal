 ...
 * <b>r</b> &equiv; (<i>x y z</i>) is the position vector in R3, and the prime
 * indicates transposition.
 * </p>
 * <p>
 * The matrix <b>&sigma;</b> is taken from the 7&times;7 covariance matrix
 * <b>&tau;</b>
 * in homogeneous coordinates; it is the matrix formed from the six,
 * second-order spatial moments &lt;<i>xx</i>&gt;, &lt;<i>xy</i>&gt;,
 * &lt;<i>xz</i>&gt;, &lt;<i>yy</i>&gt;, &lt;<i>yz</i>&gt;, &lt;<i>zz</i>&gt;
 * and is arranged as follows:
 * <br>
 * <br>
 * <table>
 * <tr>
 * <td>&nbsp;</td> <td>&nbsp;</td> <td>| &lt;<i>xx</i>&gt; &lt;<i>xy</i>&gt;
 * &lt;<i>xz</i>&gt; |</td>
 * </tr>
 * <tr>
 * <td><b>&sigma;</b></td> <td> = </td> <td>| &lt;<i>xy</i>&gt;
 * &lt;<i>yy</i>&gt; &lt;<i>yz</i>&gt; |</td>
 * </tr>
 * <tr>
 * <td>&nbsp;</td> <td>&nbsp;</td> <td>| &lt;<i>xz</i>&gt; &lt;<i>yz</i>&gt;
 * &lt;<i>zz</i>&gt; |</td>
 * </tr>
 * </table>
 * <br>
 * <br>
 * Note that <b>&sigma;</b> must be symmetric and positive definite. Thus, it is
 * diagonalizable with the decomposition
 * <br>
 * <br>
 * &nbsp; &nbsp; <b>&sigma;</b> = <b>R&Lambda;R</b>'
 * <br>
 * <br>
 * where the prime indicates transposition, <b>R</b> &isin; <i>SO</i>(3) is the
 * orthogonal rotation matrix and <b>&Lambda;</b> is the diagonal matrix of real
 * eigenvalues. Note from the above that these eigenvalues are the squares of
...
public class BeamEllipsoid {
     ...
     * <br>
     * <br>
     * &nbsp; &nbsp;  <i>k</i><sup>2</sup> = <i>k<sub>n</sub></i><sup>2</sup><i>K
     * ds</i>
     * <br>
     * <br>
     * where <i>k</i><sup>2</sup> is the true defocusing constant,
     * <i>k<sub>n</sub></i><sup>2</sup>
     * is the normalized defocusing constant(returned by this method), <i>K</i>
     * is the generalized beam perveance, and <i>ds</i> is the incremental path
     * length over which the kick is being applied.
     * </p>
     * <p>
     * The defocusing constants
     * (<i>k<sub>nx</sub>,k<sub>ny</sub>,k<sub>nz</sub></i>) are given for the
     * Cartesian coordinate system (<i>x,y,z</i>) which is aligned to the
     ...
     * constants
     * <i>k<sub>n</sub></i> are related to the space charge defocusing lengths
     * <i>f</i> by the formula
     * <br>
     * <br>
     ...
     * <i>v</i><sup>2</sup>/<i>c</i><sup>2</sup>)<sup>1/2</sup>
     * for ellipsoid
     * @param arrMoments three-array (&lt;<i>x</i><sup>2</sup>&gt;,
     * &lt;<i>y</i><sup>2</sup>&gt; &lt;<i>z</i><sup>2</sup>&gt;) of ellipsoid
     * spatial second moments
     *
     * @return three-array (<i>k<sub>nx</sub></i><sup>2</sup>,
     * <i>k<sub>ny</sub></i><sup>2</sup>,
     * <i>k<sub>nz</sub></i><sup>2</sup>) of defocusing constants
     *
     * @see
...
//        double  gamma   = this.getGamma();
     ...
     * </tr>
     * <tr>
     * <td><b>&sigma;</b></td> <td>&equiv;</td> <td>| &lt;y*x&gt; &lt;y*y&gt;
     * &lt;y*z&gt; |</td> <td>-</td>  <td>| &lt;y&gt;*&lt;x&gt;
     * &lt;y&gt;*&lt;y&gt; &lt;y&gt;*&lt;z&gt; |</td>
     * </tr>
     * <tr>
     ...
     * moments &lt;<i>x</i><sup>2</sup>&gt; - &lt;<i>x</i>&gt;<sup>2</sup>,
     * &lt;<i>y</i><sup>2</sup>&gt; - &lt;<i>y</i>&gt;<sup>2</sup>,
     * &lt;<i>z</i><sup>2</sup>&gt; - &lt;<i>z</i>&gt;<sup>2</sup>, taken from
     * the central (spatial) covariance matrix
     * <br>
     * <br>
     * <table>
     * <tr>
     ...
     * moments
     * @param vec2ndMmts vector (&lt;<i>x</i><sup>2</sup>&gt; -
     * &lt;<i>x</i>&gt;<sup>2</sup>, &lt;<i>y</i><sup>2</sup>&gt; -
     * &lt;<i>y</i>&gt;<sup>2</sup>, &lt;<i>z</i><sup>2</sup>&gt; -
     * &lt;<i>z</i>&gt;<sup>2</sup>) of second spatial moments
     *
     * @author Christopher K. Allen
     * @since Aug 25, 2011
     */
...
//        this.arrMoments   = (vec2ndMmts.minus( vec1stMmts.square() )).toArray();
    ...
    /**
     * <p>
     * Get orthogonal rotation matrix <b>R</b> in <i>SO</i>(7) that rotates the
     * ellipsoid spatial semi-axes onto the spatial coordinate axes.
     * </p>
     * <p>
     * The rotation <b>R</b> is actually the Cartesian product of a single
     * rotation
     * <b>r</b> from <i>SO</i>(3) that rotates the ellipsoid's spatial
     * coordinates onto the coordinate axes. That is,
     * <br>
     * <br>
     * <b>R</b> = <b>r</b> &times; <b>r</b> contained in SO(7) contained in
     * <b>R</b><sup>7&times;7</sup>
     * <br>
     * <br>
     ...
     * <br>
     * <br>
     * where <b>L<sub>0</sub></b> is the Lorentz transform into the beam frame,
     * <b>T<sub>0</sub></b> is the Galilean transform to the ellipsoid centroid
     * coordinates, and <b>R<sub>0</sub></b>
     ...
     * <br/>
     * <br/>
     * where <b>T<sub>0</sub></b> is the Galilean transform to the ellipsoid
     * centroid coordinates, and <b>R<sub>0</sub></b>
     ...
     * </p>
     * <p>
     * Denoting the returned generator matrix as <b>G</b> then the actual
     * transfer matrix <b>M</b>(s) for the space charge effect is given as
     * <br>
     * <br>
     ...
     * <b>G</b><sub>0</sub> in the ellipsoid coordinate (which has a very simple
     * form), and a series of matrix transforms. We have
     * <br>
     * <br>
     * &nbsp; &nbsp;  <b>G</b> =
     * (<b>R</b><sub>0</sub><b>T</b><sub>0</sub><b>L</b><sub>0</sub>)<sup>-1</sup>
     * <b>G</b><sub>0</sub>
     * (<b>R</b><sub>0</sub><b>T</b><sub>0</sub><b>L</b><sub>0</sub>)
     * <br>
     * <br>
     * where <b>L</b><sub>0</sub> is the Lorentz transform into the beam frame,
     * <b>T0</b> is the Galilean transform to the ellipsoid centroid
     * coordinates, and <b>R</b><sub>0</sub>
     * is the rotation that aligns the ellipsoid semi-axes to the coorinates
     * axes putting it into standard position.
     * </p>
     * <h3>NOTES:</h3>
     ...
     * perveance. This value <i>K</i> is defined as
     * <br>
     * <br>
     ...
     * <br>
     * <br>
     * where <i>Q</i> is the total beam charge, <i>&epsilon;</i><sub>0</sub> is
     * the permittivity of free space, <i>&gamma;</i> is the relativistic
     * factor, <i>&beta;</i> is the normalized velocity (to the speed of light),
     * <i>q</i> is the unit charge,
     * <i>m</i> is the beam particle mass, and <i>c</i> is the speed of light.
     * </p>
     *
     * @param dblPerveance    <i>K</i>, the generalized three-dimensional beam
     * perveance
     *
     * @return                  <b>G</b>, the transfer matrix generator representing linear space
     * charge effects
     *
     * @author Christopher K. Allen
     *
     ...
     * <br>
     * <br>
     * where <i>s</i> is the incremental path length for the dynamics, and
     * <b>G</b>
     ...
     * compute the transfer matrix <b>M</b> simply by exponentiating the
     * returned value. However, because the generator matrix in the ellipsoid
     * coordinates, <b>G<sub>0</sub></b>, is idempotent (i.e.,
     * <b>G<sub>0</sub>G<sub>0</sub></b> = 0) it is computationally faster to
     * assemble the transfer matrix as the product
     * <br>
     * <br>
     * &nbsp; &nbsp; <b>M</b>(<i>s</i>) = <i>e</i><sup><i>s</i><b>G</b></sup>
     ...
     * </p>
     *
     * @param dblLen          <i>ds</i>, the incremental path length for the space charge
     * effects
     * @param dblPerveance    <i>K</i> the generalized three-dimensional beam
     * perveance
     *
     ...
     *         | 0  0 0  0 0  0 0 |
     * </pre> where <i>K<sub>x</sub></i>, <i>K<sub>y<sub></i>,
     * <i>K<sub>z<sub></i>
     * are the defocusing constants. These constants have the value (for
     * example, in the <i>x</i> direction)
     * <br>
     * <br>
     * &nbsp; &nbsp;  <i>K<sub>x</sub></i> = <i>ds K
     * k<sub>nx<sub></i><sup>2</sup>
     * <br>
     * <br>
     * where <i>ds</i> is the incremental path length, <i>K</i> is the beam
     * perveance, and <i>k<sub>nx</sub></i><sup>2</sup> is the normalized
     * defocusing constant.
     *
     * The argument of this method is the magnitude of the space charge effect,
     * which is simply the product of <i>ds</i> and <i>K</i>.
     *
