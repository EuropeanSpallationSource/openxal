...
public class PhaseVector extends BaseVector<PhaseVector> implements Serializable, IArchive {
     ...
     * objects. This set include the phase space coordinates and the homogeneous
     * coordinate.
     *
     * @author Christopher K. Allen
     * @since Oct 8, 2013
    ...
    /**
     * Creates a deep copy of the given <code>PhaseVector</code> object. Thus,
     * the argument is unmodified and unreferenced.
     *
    ...
    /**
     * Create a new instance of PhaseVector with initial value determined by the
    ...
    /**
     * Create a new instance of <code>PhaseVector</code> with specified initial
     * value.
     *
...
//      this.setVector(arrVals);
    ...
    /**
     * Create a new instance of PhaseVector with specified initial value
     * specified by the formatted string argument. The input string may or may
     * not contain the final coordinate which always has value 1.
     *
    ...
    /**
     * Vector outer product operation. Returns the tensor outer product as a
     * <code>PhaseMatrix</code> object
     *
    ...
    /**
     * We need to redefine this method in order to set the homogeneous
     * coordinate back to unity.
     *
