...
public class Twiss implements Serializable {
    ...
    public enum PROP {
        ...
        /**
         * Returns the label of the property in the data structure which
         * corresponds to this enumeration constant.
         *
         ...
         *
         * @param data      <code>Twiss</code> data structure having field
         ...
         * @param strFldGtr the name of the getter method for the field
     ...
     *
     * @return Courant-Snyder parameters corresponding to the given covariance
     * matrix
     *
     * @author Christopher K. Allen
     * @since Aug 29, 2012
    ...
    /**
     * <p>
     * Creates a new <code>Twiss</code> object given the parameters of the
     * equivalent uniform beam. This is the uniform beam that has the same
     * second-moments as the beam under study. Because of the uniform charge
     * distribution it can be modeled as a KV (Kapchinsky-Vladimirsky) beam
     * having a distinct envelope size (radius) and a distinct envelope slope
     * (this value is related to the divergence angle).
     * </p>
     * <h3>NOTE</h3>
     * <p>
     * &middot; <em>We do not scale the emittance!</em> It is common practice to
     * multiply the RMS emittance by 4 for 2D beams and other values for 3D
     * beams with various distributions. We assume the same second moments which
     * yield the same RMS emittance. Specially, the emittance of the returned
    ...
    /**
     * Creates a new instance of Twiss initialized to the given Twiss
     * parameters.
     *
    ...
    /**
     * Set the values of the Twiss parameters from the corresponding phase space
     * envelope values.
     *
