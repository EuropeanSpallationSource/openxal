 ...
 * in three spatial dimensions. Thus, each <code>PhaseMatrix</code> is an
...
public class PhaseMatrix extends SquareMatrix<PhaseMatrix> implements java.io.Serializable {
    ...
    public enum IND implements IIndex {
         ...
         * coordinates only. The homogeneous coordinate index is not included
         * (i.e., the <code>IND.HOM</code> constant).
         *
         * @return the set of phase indices <code>IND</code> less the
         * <code>HOM</code> constant
         *
...
//        matIden.setElem(IND.HOM, IND.HOM, 1.0);
    ...
    /**
     * <p>
     * Create a phase matrix representing a linear translation operator on
     ...
     * <br>
     * <br>
     * &nbsp; &nbsp;  <strong>&Delta;</strong> = (<em>&Delta;x, &Delta;x',
     * &Delta;dy, &Delta;dy', &Delta;dz, &Delta;dz'</em>,
     * 1)<sup><em>T</em></sup>
     * <br>
     * <br>
     * then the returned matrix <strong>T</strong>(<strong>&Delta;</strong>) has
     * the form
     * <pre>
     *
     ...
     *          |<em>z'</em>|
     *          |1 |
     * </pre> Then operation on <strong>v</strong> by
     * <strong>T</strong>(<strong>&Delta;</strong>) has the result
     * <pre>
     *           |<em>x + &Delta;x</em> |
     *           |<em>x'+ &Delta;x'</em>|
     ...
     *           |<em>z'+ &Delta;z'</em>|
     *           |  1    |
     * </pre> which we see is equivalent to the simple vector addition
     * <strong>v</strong>
     * + <strong>&Delta;</strong>.
     *
     * @param vecTrans translation vector <strong>&Delta;</strong>
     *
     * @return translation operator <strong>T</strong>(<strong>&Delta;</strong>)
     * as a phase matrix
     */
     ...
     * into phase space. Specifically, if the argument <strong>&Delta;</strong>
     * has coordinates
     * <br>
     * <br>
     ...
     * <br>
     * <br>
     * then the returned matrix <strong>T</strong>(<strong>dv</strong>) has the
     * form
     * <pre>
     *
     *          |1 0 0 0 0 0 <em>&Delta;x</em>|
    ...
    public static PhaseMatrix rotationProduct(R3x3 matSO3) {
        ...
        for (POS pos : POS.values()) {
            ...
            // configuration space
            matSO7.setElem(m, n, val);
            // momentum space
            matSO7.setElem(m + 1, n + 1, val);
        }
        return matSO7;
    }

    /**
     * Create a PhaseMatrix instance and initialize it according to a token
     ...
     *
     * @return phase matrix with elements initialized by the given numeric
     * tokens
     *
    ...
    /**
     * Copy Constructor - create a <strong>deep copy</strong> of the target
     * phase matrix.
     *
    ...
    /**
     * Initializing constructor for class <code>PhaseMatrix</code>. The values
     * of the new matrix object are set to the given Java primitive type array
     * (the array is not modified).
     *
     * @param arrValues initial values for the new matrix
     *
     * @throws ArrayIndexOutOfBoundsException the argument must have dimensions
     * 7&times;7
     *
     * @author Christopher K. Allen
     * @since Oct 7, 2013
     ...
     * which does not translate vectors. The condition is that the last row and
     * last column consist of all zeros, except for the diagonal element, which
     * is 1.
     *
     * @author Christopher K. Allen
     * @since Oct 10, 2013
    ...
    /**
     * <p>
     * Projects the <code>PhaseMatrix</code> onto the space of 6&times;6
     * matrices. The projective dimension of this phase matrix is lost in the
     * projection, that is, the homogeneous coordinate and all the actions
     * associated with it (primarily translations).
     * </p>
     * <p>
     * This method is useful when the phase matrix represents the statistics of
     * a centered beam, or when it represents a transfer map without any
     * translation.
     * </p>
     *
    ...
    /**
     * <p>
     * Projects the <code>PhaseMatrix</code> onto the space of 4&times;4
     * matrices. The projective dimension of this phase matrix is lost in the
     * projection, as is the longitudinal components of the matrix. that is, the
     * last three columns and the last three rows are truncated.
     * </p>
     * <p>
     * This method is useful when the phase matrix represents the transverse
     * properties of a beam, or when it represents a transverse action on a
     * beam.
     * </p>
     *
     * @return the top 6&times;6 diagonal block of this matrix
    ...
    /**
     * Projects the <em>i<sup>th</sup></em> row onto
     * <strong>R</strong><sup>6</sup>. Specifically, the projective element (the
     * 7<em><sup>th</sup></em> element in this case) is dropped and that part of
     * the <em>i<sup>th</sup></em> row in the 6 dimensional phase space is
     * returned.
     *
     * @param i index of the matrix row to be returned, <em>i</em> &in;
     * {0,...,5}
     *
    ...
    /**
     * Projects the <em>j<sup>th</sup></em> column onto
     * <strong>R</strong><sup>6</sup>. Specifically, the projective element (the
     * 7<em><sup>th</sup></em> element in this case) is dropped and that part of
     * the <em>j<sup>th</sup></em>
    ...
    /**
     * <p>
     * Non-destructive matrix addition. The homogeneous pivot element on the
     * diagonal is unchanged at value 1.
     * </p>
     * <h3>NOTE:</h3>
     * <p>
     * BE VERY CAREFUL when using this function. The homogeneous coordinates are
     * not meant for addition operations.
     * </p>
     *
    ...
    /**
     * <p>
     * In-place matrix addition. The homogeneous pivot element on the diagonal
     * is unchanged at value 1.
     * </p>
     * <h3>NOTE:</h3>
     * <p>
     * BE VERY CAREFUL when using this function. The homogeneous coordinates are
    ...
    /**
     * <p>
     * Non-destructive matrix subtraction. The homogeneous pivot element on the
     * diagonal is unchanged at value 1.
     * </p>
     * <h3>NOTE:</h3>
     * <p>
     * BE VERY CAREFUL when using this function. The homogeneous coordinates are
     * not meant for subtraction operations.
     * </p>
     *
    ...
    /**
     * <p>
     * In-place matrix subtraction. The homogeneous pivot element on the
     * diagonal is unchanged at value 1.
     * </p>
     * <h3>NOTE:</h3>
     * <p>
     ...
     * </p>
     *
     * @param matSub matrix to be subtracted from this matrix (result replaces
     * this)
     */
    @Override
     ...
     */
    /**
     * We must redefine the norm of any matrix on projective space to eliminate
     * the homogeneous coordinate. See the base class
     * <code>{@link xal.tools.math.BaseMatrix}</code> for information on the
     * specific norm.
     *
