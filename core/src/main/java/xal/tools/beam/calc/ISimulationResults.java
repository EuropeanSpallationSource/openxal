 ...
 * must be taken in the context of the data upon which they calculate.  <b>See
 * the associated Javadoc.</b>
 * </p>
 *
 * @author Christopher K. Allen
 * @since Nov 15, 2013
...
public interface ISimulationResults {
    ...
    public interface ISimLocResults<S> extends ISimulationResults {
         ...
         * </p>
         * <p>
         * In general the idea is that the returned coordinate <b>z</b> in phase
         * space <b>P</b><sup>6</sup> &cong;
         * <b>R</b><sup>6</sup> &times; {1} is invariant under some map
         * <b>&phi;</b> : <b>P</b><sup>6</sup> &rarr; <b>P</b><sup>6</sup>
         ...
         * @param state simulation state where parameters are computed
         *
         * @return the reference orbit vector (<i>x,x',y,y',z,z'</i>,1) (see
         * comments)
         */
         ...
         * energy spread. The returned value <b>&Delta;</b> is the vector
         * <br>
         * <br>
         * &nbsp; &nbsp; <b>&Delta;</b> &equiv; (&Delta;<i>x</i>,
         * &Delta;<i>x'</i>, &Delta;<i>y</i>, &Delta;<i>y'</i>, 0, 0, 1)
         * <br>
         * <br>
         * where, when multiplied by momentum spread &delta; &equiv;
         * &Delta;<i>p</i>/<i>p</i> yields the change in fixed orbit position.
         * That is <b>z</b> = <b>z</b><sub>0</sub> + &delta;<b>&Delta;</b>.
         *
         * @param state simulation state where parameters are computed
         *
    ...
    public interface ISimEnvResults<S> extends ISimulationResults {
         ...
         * @param state simulation state where parameters are computed
         *
         * @return vector (&psi;<sub><i>x</i></sub>, &psi;<sub><i>y</i></sub>,
         * &psi;<sub><i>x</i></sub>) of phases in radians
         */
         ...
         * at the given state <i>S<sub>n</sub></i> location <i>s<sub>n</sub></i>
         * in the presence of dispersion.
         * </p>
         * <p>
         * Let the full-turn map a the state location be denoted
         * <b>&Phi;</b><sub><i>n</i></sub> (or the transfer matrix from entrance
         * to location <i>s<sub>n</sub></i> for a linac). The transverse plane
         * dispersion vector <b>&Delta;</b> is defined
         * <br>
         * <br>
         ...
         * 6<sup><i>th</i></sup>
         * column in the transfer matrix <b>&Phi;</b></b><sub><i>n</i></sub>.
         ...
         * longitudinal divergence angle <i>z'</i> used by XAL to momentum
         * &delta;<i>p</i> &equiv; &Delta;<i>p</i>/<i>p</i> used in the
         ...
         * <b>&Phi;</b></b><sub><i>n</i></sub>, which we denote take
         * <b>T</b></b><sub><i>n</i></sub>. That is,
         * <b>T</b></b><sub><i>n</i></sub> = &pi; &sdot;
         * <b>&Phi;</b></b><sub><i>n</i></sub>
         ...
         * <i>y'<sub>t</sub></i>) in transvse phase space that is invariant
         * under the action of the ring for a given momentum spread
         * &delta;<i>p</i>. That is, the particle ends up in the same location
         * each revolution. With a finite momentum spread of &delta;<i>p</i>
         * &gt; 0 we require this require that
         * <br>
         * <br>
         * &nbsp; &nbsp; <b>T</b><sub><i>n</i><b></sub>z</b><sub><i>t</i></sub>
         ...
         * <br>
         * &nbsp; <b>z</b><sub><i>t</i></sub> =
         * &delta;<i>p</i>(<b>T</b></b><sub><i>n</i></sub> -
         ...
         * <b>z</b><sub><i>t</i></sub>/&delta;<i>p</i> =
         * (<b>T</b></b><sub><i>n</i></sub> -
         * <b>I</b>)<sup>-1</sup><b>&Delta;</b><sub><i>t</i></sub> ,
         * <br>
         * <br>
