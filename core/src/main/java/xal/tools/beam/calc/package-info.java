 ...
 * <p>
 * <h3>Introduction</h3>
 * This package contains classes that perform common processing tasks for
 * simulation data produced by the online model. Such data is contained in a
 * <code>{@link xal.model.probe.traj.Trajectory}</code> object where the
 ...
 * <code>{@link CalculationsOnParticles}</code>, has no methods for such a
 * calculation.
 * </p>
 * <p>
 ...
 * <p>
 * <h3>Interfaces</h3>
 * There are two interfaces exposed by the processing classes in this package,
 * both of them contained in the parent interface
 * <code>{@link ISimulationResults}</code>. The first is
 * <code>{@link ISimLocResults<>}</code> which exposes methods involved in the
 * computation of points or locations in phase space. The second is
 * <code>{@link ISimEnvResults<>}</code> which exposes methods that are
 ...
 * There are 4 classes that produce finished information from simulation data.
 * There is an additional base class, <code>{@link CalculationEngine}</code>,
 ...
 * <br>
 * <br>
 * <strong><code>CalculationsOnParticles</code></strong>: Provides processing
 ...
 * <br>
 * <br>
 * <strong><code>CalculationsOnMachines</code></strong>: This class is concerned
 * with the calculation of machine properties without regard to any beam
 * propagation. The simulation data is of type
 * <code>Trajectory&lt;TransferMapState&gt;</code>.
 * <br>
 * <br>
 * <strong><code>CalculationsOnRings</code></strong>: Computes ring properties
 ...
 * <code>Trajectory&lt;TransferMapState&gt;</code>. However, it is necessary
 * that the simulation data be produced by a machine with the topology of a ring
 * for the calculations to have context.
 * <br>
 * <br>
 * <strong><code>CalculationsOnBeams</code></strong>: Computes parameters for a
 ...
 * <code>SimResultsAdaptor</code> and <code>SimpleSimResultsAdaptor</code>. The
 * function of <code>SimResultsAdaptor</code> is to expose both the above
 ...
 * priori</em>. The <code>CalculationsOnRings</code> class is used for
 * simulation data of type <code>Trajectory&lt;TransferMapState&gt;</code>,
 * <code>CalculationsOnParticles</code> is used for type
 * <code>Trajectory&lt;ParticleProbeState&gt</code>, and
 * <code>CalculationsOnBeams</code> is used for type
 * <code>Trajectory&lt;EnvelopeProbeState&gt;</code>.
 * </p>
 *
 * @author Christopher K. Allen
 * @since Sep 25, 2014
