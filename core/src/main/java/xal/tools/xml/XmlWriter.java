...
public class XmlWriter {
    ...
    private abstract class NodeWriter {
        ...
        protected void writeOpenTag() throws IOException {
            ...
            if (name == null || !(rootNode instanceof Element)) {
                return;
            }
        ...
        /**
         * Escape special characters as necessary to form valid XML. In
         * particular we escape the ampersand and less than characters.
         *
         * @param value The value whose special characters are escaped as
         * necessary.
