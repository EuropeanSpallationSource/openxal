 ...
 * (from/to) XML. While the DataAdaptor provides methods for getting and setting
 * properties of nodes and getting and setting nodes in a tree of data,
 * XmlDataAdaptor uses an XML backing store for the data. In particular, you can
 * use the methods of DataAdaptor for all data manipulation. You need to
 ...
 * </p>
 * <p>
 * There are several more methods available for DataAdaptor and XmlDataAdaptor,
 * but the examples listed above should provide an overview and foundation.
 * </p>
 *
 * @author tap
 */
public class XmlDataAdaptor implements FileDataAdaptor {
    ...
    /**
     * Get the string value associated with the specified attribute allowing DOM
     * to recover escaped characters as necessary.
     *
     * @param attribute The node attribute.
     * @return the raw string value associated with the attribute or null if the
    ...
    /**
     * Set the string value to associate with the attribute and allow DOM to
    ...
    /**
     * Set the string value to be associated with the attribute and replace
     * illegal XML attribute characters (less than and ampersand) with their
     * legal XML attribute substitutions.
     *
     * @param attribute The node attribute.
     * @param value The string value to associate with the attribute.
     */
    ...
    /**
     * Create a list of child adaptors (one adaptor for each non-null child
     * node).
     *
    ...
    /**
     * Generate an XmlDataAdaptor from a urlPath, given dtd validating option,
     * and given schemaUrl
     */
    ...
    /**
     * Generate an XmlDataAdaptor from an XML string and given dtd validating
     * option
     */
