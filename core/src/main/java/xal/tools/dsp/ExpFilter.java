 ...
 * </p>
 * <p>
 * When the filters are described as "perfect", we are implying that they do not
 * roll off with frequency (thus, they are of infinite order). The transfer
 * function of the filter has values of either unity or zero. This may or may
 * not correspond to a linear phase filter.
 * </p>
 *
 * @author Christopher K. Allen
 *
...
public class ExpFilter {
     ...
     */
    /**
     * Perfect low-pass filter. Any frequency components
     * <strong>greater</strong>
     * than the given (discrete) cut off frequency are complete removed. The
     * filtered function is returned.
     *
     ...
     *
     * @throws IndexOutOfBoundsException cut off frequency either negative or
     * greater than max frequency
     * @throws IllegalArgumentException discrete function size is not equal to
     * filter dimensions
     */
...
//        this.linearPhase(vecTrans);
    ...
    /**
     * Perfect high-pass filter. Any frequency components <strong>less</strong>
     * than the given (discrete) cut off frequency are complete removed. The
     * filtered function is returned.
     *
     * @param intFreq discrete cut off frequency
    ...
    /**
     * Perfect band-pass filter. Any frequency components
     * <strong>outside</strong>
     * the the given (discrete) cut off frequencies (exclusive) are complete
     * removed. That is, only discrete frequency components inside the interval
    ...
    /**
     * Perfect notch filter. Any frequency components <strong>inside</strong>
     * the the given (discrete) cut off frequencies (inclusive) are complete
     * removed. That is, only discrete frequency components outside the interval
     * [<var>intFreqLow</var>,<var>intFreqHigh</var>] are contained in the
     * returned function.
     *
     * @param intFreqLow discrete low-band cut off frequency
    ...
    /**
     * Perfect notch filter. Removes a single (discrete) frequency component
     ...
     */
    /**
     * Parabolic low-pass filter. Any frequency components
     * <strong>greater</strong>
     * than the given (discrete) cut off frequency are complete removed.
     * Frequencies in the pass-band are attenuated by a transfer function with
     * unit high and parabolic shape with value zero at the cut off frequency.
     *
     * @param intFreq discrete cut off frequency
     * @param arrFunc discrete function to be filtered
     *
     ...
     *
     * @throws IndexOutOfBoundsException frequency lies outside acceptable
     * interval
     */
