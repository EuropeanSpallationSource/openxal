...
public class MessageCenter implements Serializable {
    ...
    /**
     * forward fresh events (drop old unprocessed pending events) on a common
     * thread per protocol
     */
    ...
    /**
     * Static initializer Create a default message center.
     */
    static {
    ...
    /**
     * set the thread pool size for concurrent messaging to reduce bottlenecks.
    ...
    // target registration --------------------------------------------------------------
    /**
     * register target for messages from the source and for the specified
     * interface
     *
    ...
    /**
     * Remove the target from every source that broadcasts the specified
     * protocol
     *
     * @param target The target receiving messages
     * @param protocol The protocol identifying the message type being received
    ...
    /**
     * Unregister the target from listening to the specified protocol from the
     * specified collection of sources.
     *
     * @param target The target receiving messages
    ...
    /**
     * Removes the target from listening for the specified protocol. It only
     * removes the target from listening to the protocol from anonymous sources.
     * For example, it unregisters a call of registerTarget(target, protocol).
     * This method does NOT remove the target from listening to directly
     * registered sources.
     *
     * @param target The target receiving messages
     * @param protocol The protocol identifying the message type being received
    ...
    // registering sources --------------------------------------------------------------------
    /**
     * register the specified source to be associated with the specified event
     * protocol defaults to synchronous messaging
     *
     * @param source The source of the message
     * @param protocol The type and interface of the messages the source will
     * send
    ...
    /**
     * Register the specified source to be associated with the specified event
     * protocol and using synchronous (true) or asynchronous messaging (false)
     *
     * @param source The source of the message
     * @param protocol The type and interface of the messages the source will
     * send
     * @param isSynchronous true to enable synchronous messaging and false for
     * asynchronous messaging
     * @return The proxy (implementing protocol) to call to broadcast messages
     * @deprecated Use the version of this method that takes the synchronous
     * type instead
     */
    @Deprecated
    ...
    /**
     * Register the specified source to be associated with the specified event
     * protocol and processed as the synchronous type
     *
     * @param source The source of the message
     * @param protocol The type and interface of the messages the source will
     * send
     * @param synchronousType one of SYNCHRONOUS, ASYNCHRONOUS or FRESH to
    ...
    /**
     * Remove source registration which means the proxy for the source/protocol
     * pair is no longer able to broadcast messages. The handler for this
     * source/protocol pair will be removed.
     *
     ...
     * @return The proxy (implementing protocol) to call on behalf of the source
    ...
    /**
     * Override toString() to return a description of the message center. At
     * this point it simply returns the name of the message center.
     *
