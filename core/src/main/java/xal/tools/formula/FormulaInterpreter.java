...
public final class FormulaInterpreter {
    ...
    /**
     * Set the named variable to the specified value. Overrides the previous
    ...
    /**
     * Determine if a variable of the specified name exists and has been
     * assigned a value.
     *
     ...
     *
     * @return The result of evaluating the formula with the present variable
     * values.
     */
