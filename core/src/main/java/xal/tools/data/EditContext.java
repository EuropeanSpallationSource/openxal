...
public class EditContext {
     ...
     *
     * @param listener the listener to receive edit context events from this
     * context
     */
     ...
     *
     * @param listener the listener to remove from receving edit context events
     * from this context
     */
    ...
    /**
     * Perform a deep copy of the specified table group from the specified edit
     * context
     */
    ...
    /**
     * Import the tables from the data adaptor and assign them to the specified
     * group in this edit context.
     */
    ...
    /**
     * Write all tables associated with the specified group to the specified
     * data adaptor.
     */
    ...
    /**
     * Return the tables associated with the specified group and make a set if
    ...
    /**
     * Get the records from the table where the value for the specified key
     * matches.
     */
