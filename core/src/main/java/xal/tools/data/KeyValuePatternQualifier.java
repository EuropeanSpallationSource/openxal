...
public class KeyValuePatternQualifier implements Qualifier {
    ...
    /**
     * Determine if the specified record's value associated with this
     * qualifier's key is a match to this qualifier's pattern. The value
     * corresponding to this qualifier's key must be a
     * <code>java.lang.CharSequence</code>.
     *
     * @param object The object to test for matching. The object must be a keyed
     * record.
