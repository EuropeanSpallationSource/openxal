...
public class KeyValueSorting {
    ...
    /**
     * Generate a comparator that compares records according to the method
     * obtained by a key value adaptor generated internally. The keyed values
     * being compared are assumed to be comparable.
     *
    ...
    /**
     * Generate a comparator that compares records according to the method
     * obtained by the key value adaptor The keyed values being compared are
     * assumed to be comparable.
     *
     * @param adaptor key value adaptor used for getting the method associated
     * with the key
     * @param keyPath indicates the method used for comparison
     * @param order either ASCENDING or DESCENDING
     * @return a comparator which compares objects according to the keyed
    ...
    /**
     * Coalesce the specified comparators to generate a compound comparator
     * whose sub comparators are evaluated in the specified order.
     *
     * @param comparators array of parameters to coalesce taken in order (sort
