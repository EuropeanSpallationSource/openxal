...
public class NotQualifier implements Qualifier {
    ...
    /**
     * Determine if the specified object is not a match to the enclosed
     * qualifier.
     *
     * @param object the object to test for matching
     * @return true if the object does not match the enclosed qualifier's
     * criteria and false if it does match.
     */
    @Override
