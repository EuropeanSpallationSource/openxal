...
public class ArrayMath {
    ...
    /**
     * Transform an array by multiplying by a scale and adding an offset v(i) =
     * scale * array(i) + offset
     */
    ...
    /**
     * Return the square root of each element: s(i1,i2,...) = v1(i1,i2,...) -
     * v2(i1,i2,...)
     */
    public static Object subtract(Object vec1, Object vec2, int[] dimensions) {
        ...
        while (true) {
            ...
            if (!ArrayTool.increment(indices, dimensions)) {
                break;
            }
        }
    ...
    /**
     * Return the square root of each element: m(i1,i2,...) = v(i1,i2,...) *
     * scalar
     */
    ...
    /**
     * Multiply a vector by a matrix defined by: v(i) = Sum<sub>j</sub>(
     * mat(i,j) * vec(j) )
     */
    ...
    /**
     * Multiply a column vector by a row vector where the product is a matrix
     * defined by: M(i,j) = columnVector(i) * rowVector(j) Note: This is not a
     * scalar product, nor a vector product, but rather it is a product of a
     * column vector with a row vector which results in a matrix.
     */
    ...
    /**
     * Return the square root of each element: m(i1,i2,...) = v1(i1,i2,...) *
     * v2(i1,i2,...)
     */
    ...
    /**
     * Return the square root of each element: s(i1,i2,...) = squar_root(
     * vec(i1,i2,...) )
     */
    ...
    /**
     * Return the square root of each element: s(i1,i2,...) = squar_root( abs(
     * vec(i1,i2,...) ) )
     */
    ...
    /**
     * Invert the matrix in place - copied from reverseMatrix() in the the plot
     * framework's GraphDataOperations
     */
