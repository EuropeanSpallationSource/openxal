...
public class RunningWeightedStatistics extends UnivariateStatistics {
     ...
     * Constructor
     *
     * @param weight asymptotic weight to apply to new samples in large
     * populations
     */
    ...
    /**
     * Get the weight to apply to the next new sample given the specified
     * population. When we first start adding samples, we must trust the newest
     * samples most and gradually shift trust to the older samples. Ultimately
     * we will trust new samples at least at the asymptotic weight.
     */
