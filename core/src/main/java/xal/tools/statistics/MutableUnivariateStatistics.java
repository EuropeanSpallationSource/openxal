...
public class MutableUnivariateStatistics extends UnivariateStatistics {
    ...
    /**
     * Replace an old sample with a fresh sample. This is useful when updating
     * statistics on circular buffers.
     *
    ...
    /**
     * Modify the statistics for data of another scale. For example, if you took
     * data with one set of units but want results in another. This method
     * should be used with caution as it changes the scale of the data and new
     * data should only be added if it uses the new scale.
     *
     * @param scale the amount by which to scale the existing sample
     * measurements
     */
