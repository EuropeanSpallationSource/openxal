...
public class ArrayTool {
    ...
    /**
     * Given a multi-dimensional array, return the double value at the specified
     * index.
     */
    ...
    /**
     * Given a multi-dimensional array, set the double value at the specified
     * index.
     */
    ...
    /**
     * Given a multi-dimensional array, return the Object at the specified
     * index.
     */
    ...
    /**
     * Increment the indices in place. The lower bounds of each index is 0. The
     * upper bound of each index is given by the size of the associated
     * dimension. Indices are incremented in the same way that a
     * multi-dimensional C array would be incremented. Namely, the outer most
     ...
     * <code>false</code> if the indices were not incremented thus indicating
     * that it has exhausted all possible indices.
     */
    ...
    /**
     * convenience method for getting a string description of an Object array by
     * joining each element with a comma character
     *
    ...
    /**
     * convenience method for getting a string description of a double two
     * dimensional array
     */
    public static String asString(final double[][] array) {
