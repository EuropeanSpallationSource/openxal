...
/**
 * Implementation of DataTransform for the <code>double</code> precision array
 * type. DoubleArrayTransform provides a convenient way to implement general
 * transformations between double precision floating point arrays.
 *
 * @author tap
