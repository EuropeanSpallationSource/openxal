 ...
 * values. A raw value might be a value that you get directly from a channel
 * access call. The end user may want a processed value (e.g. convert current to
 * field). ValueTransform provides a common interface in XAL for such
 * processing.
 *
 * @author tap
 */
