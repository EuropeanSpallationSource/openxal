...
public class StringJoiner {
     ...
     * StringJoiner converts all items to strings and sends them to a concrete
     * subclass of Joiner to join the strings. Joiner is abstract since it is
     * never appropriate to instantiate.
     */
     ...
     * without using the separator. Thereafter, we must join items with a lead
     * separator.
     */
    ...
    /**
     * Join consecutive items with a lead separator. ConsecutiveJoiner is used
     * when the buffer already has one or more items in it.
     */
