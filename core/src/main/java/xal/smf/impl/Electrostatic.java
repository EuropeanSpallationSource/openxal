...
public class Electrostatic extends AcceleratorNode {
    ...
    /**
     * indicates whether to use the actual field readback or the field setting
     * in the getField() method
     */
    ...
    public final AccessibleProperty field = new AccessibleProperty("field", FIELD_RB_HANDLE);
