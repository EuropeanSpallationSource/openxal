...
public class OrTypeQualifier implements TypeQualifier {
    ...
    /**
     * Determine if the specified node is a match based on this qualifier's
     * criteria. One or more root qualifiers must match the node otherwise it
     * will return false even if there are no root qualifiers.
     *
     * @param node The node to test
     * @return true if the node is a match to at least one root qualifier and
     * false if not
     */
    @Override
