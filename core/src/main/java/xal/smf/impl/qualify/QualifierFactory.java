...
public class QualifierFactory {
    ...
    /**
     * Get a qualifier for testing whether a node's software type matches the
    ...
    /**
     * Get a qualifier that matches for any of the specified node types and the
     * specified node status.
     *
    ...
    /**
     * Get a qualifier that matches for any of the specified qualifiers and the
     * specified node status.
     *
     * @param nodeStatus the status of the nodes to match
