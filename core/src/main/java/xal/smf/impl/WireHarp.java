 ...
 * <p>
 * Represents a harp diagnostic device, in particular such a device installed at
 * the SNS facility. The harp has fixed, physical (carbon) wires used to measure
 * the profile of the particle beam. This class implements the device API.
 * </p>
 * <h3>NOTES:</h3>
 * <p>
 ...
 * <code>DaqConfig.CNT_WIRES</code> since there is no way to dynamically acquire
 * this value.
 * </p>
 *
 * <p>
...
public class WireHarp extends ProfileDevice {
     ...
     * <br>
     * &middot; There is a pretty egregious kluge on the attribute
     * <code>DaqConfig.cntWires</code>. The value is hard coded with the
     * constant <code>DaqConfig.CNT_WIRES</code> since there is no way to
     * dynamically acquire this value.
     *
     * @author Christopher K. Allen
     * @since Apr 11, 2014
     */
    public static class DaqConfig extends ParameterSet implements IProfileDomain {
        ...
        /**
         * Array of wire positions on the beam axis for the vertical projection
         * plane.
         */
        @AScada.Field(
                type = double[].class,
        ...
        /**
         * Array of wire positions on the beam axis for the diagonal projection
         * plane.
         */
        @AScada.Field(
                type = double[].class,
        ...
        /**
         * Bit record indicating operation status for each wire of the vertical
         * wire set.
         * <br> <br>
        ...
        /**
         * Bit record indicating operation status for each wire of the diagonal
         * wire set.
         * <br> <br>
         ...
         *
         * @throws IllegalArgumentException the index provided was not in the
         * correct range
         *
         * @author Christopher K. Allen
         * @since Apr 14, 2014
        ...
        /**
         * Creates an array of status flags for each harp wire for the given
         * transverse plane. The array size equals the number of wires in the
         * harp (<code>cntWires</code>), the index into the array is the index
         * of the harp wire.
         *
        ...
        public double[] getSamplePositions(ANGLE angle) {
            ...
            switch (angle) {
                case HOR:
                    return this.arrPosHor;
                case VER:
                    return this.arrPosVer;
                case DIA:
     ...
     * <code>WireHarp</code> device. The data structure is active and can be
     * used to set the configuration parameters as well.
     *
     * @author Christopher K. Allen
     * @since Mar 20, 2014
     */
    public static class DevConfig extends ParameterSet {
        ...
        /**
         * Returns the defined set of configuration parameters currently used
         ...
         */
        /**
         * Returns the class name as the <code>DataAdaptor</code> data label.
         *
        ...
        /**
         * Create a new <code>DevConfig</code> object initialized from the given
         * data source.
         *
         ...
         * <code>TRGEVT</code> enumeration constant to the correct code and
         * assigning the value to the trigger event field in this data
         * structure.
         *
         ...
         *
         * @return the <code>TRGEVT</code> constant for the current trigger
         * event code
         *
         * @author Christopher K. Allen
         * @since Mar 21, 2014
    ...
    public static class FitAttrSet extends SignalAttrSet {
        ...
        /**
         * Convenience method for retrieving a new, initialized data structure
         * populated from the current given device state.
         *
         * @param smfHarp data acquisition device
         *
         * @return data structure containing the current state of the given
         * hardware device
         *
         ...
         *
         * @param daptSrc persistent data store containing initializing data
         * field values
         *
         * @author Christopher K. Allen
         * @since Mar 19, 2014
     ...
     * mechanism of <code>{@link ScadaRecord}</code>.
     * </p>
     * <p>
     * The data structure is derived from the <code>SignalSet</code> base class
     * which does all the work. The data from each plane is available through
     * the attributes of type <code>{@link WireHarp.Signal}</code> in the
     * <code>WireHarp.SignalSet</code> base class. The data acquisition channels
     * are identified with the annotation <code>{@link ASignalSet}</code> which
     * tells the base class how to connect the
     * <code>{@link WireHarp.Signal}</code> attributes.
     * </p>
     *
     * @author Christopher K. Allen
     * @since Feb 5, 2013
    ...
    public static class DataRaw extends SignalSet {
         ...
         * @throws GetException general CA GET exception while fetch field value
         * @throws ScadaAnnotationException the <code>ADaqProfile</code>
        ...
        /**
         * Creates a new instance of <code>DataRaw</code> initialized with the
         * data provided by the given data source.
         *
         * @param daSrc measurement data source presenting
         * <code>DataAdaptor</code> interface
         *
         * @throws IllegalAccessException if an underlying <code>Signal</code>
        ...
        /**
         * Creates a new instance of <code>DataRaw</code> and initializes the
         * signal values by acquiring data from the given device.
         *
         * @param smfHarp data acquisition device
         *
         * @throws BadStructException the DAQ data structure and DAQ channels
    ...
    /**
     * <p>
     * Structure for maintaining a <code>WireHarp</code> profile data fits. The
     ...
     * the SCADA mechanism of <code>{@link ScadaRecord}</code>.
     * </p>
     * <p>
     * The data structure is derived from the <code>SignalSet</code> base class
     * which does all the work. The fit data for each plane is available through
     * the attributes of type <code>{@link Signal}</code> in the
     * <code>WireHarp.SignalSet</code> base class. The PV channels for the fit
     * data are identified with the annotation <code>{@link ASignalSet}</code>
     * which tells the base class how to connect the <code>{@link Signal}</code>
     * attributes.
     * </p>
     *
     * @author Christopher K. Allen
    ...
    public static class DataFit extends SignalSet {
        ...
        /**
         * Creates a new instance of <code>DataFit</code> initialized with the
         * data provided by the given data source.
         *
         * @param daSrc measurement data source presenting
         * <code>DataAdaptor</code> interface
        ...
        /**
         * Creates a new instance of <code>DataFit</code> and initializes the
         * signal values by acquiring data from the given device.
         *
         * @param smfHarp data acquisition device
         *
     ...
     */
    /**
     * Sets sample size attribute for each signal in the set to the static value
     * <code>{@link #CNT_WIRES}</code>. The obvious kluge for the fact that
     * there is no dynamic way to get this number.
     *
