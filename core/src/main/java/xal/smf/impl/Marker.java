...
public class Marker extends AcceleratorNode {
     ...
     * default implementation to set the marker type since a marker type can be
     * "Foil", "VIW" "Tgt", etc.
     *
     ...
     * method since the types of generic nodes are not associated with the class
     * unlike typical nodes.
     *
