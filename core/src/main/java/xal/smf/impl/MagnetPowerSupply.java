...
public abstract class MagnetPowerSupply implements DataListener {
     ...
     * @throws xal.ca.ConnectionException if the readback channel cannot be
     * connected
    ...
    /**
     * Get the subset of nodes from trialNodes which are supplied by this power
     * supply.
     *
     * @param trialNodes The collection of nodes from which to check for
     * matches.
     * @return The collection of nodes that use this supply.
     */
