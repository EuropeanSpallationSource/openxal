...
public abstract class SignalAttrSet implements DataListener {
     ...
     */
    /**
     * Sets the signal attribute for the given measurement angle to the given
     * signal attribute object.
     *
    ...
    /**
     * Averages all the signal attributes in the signal attributes set using the
     * given weighting factor. See
     * <code>Signal{@link SignalAttrs#average(Signal, double)}</code> for
    ...
    /**
     * Load the contents of this signal traits set from the persistent store
     * behind the <code>DataListener</code> interface.
     *
