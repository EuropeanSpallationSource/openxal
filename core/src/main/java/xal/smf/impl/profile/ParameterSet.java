 ...
 * <code>{@link ScadaRecord}</code>. Specifically, data structures derived from
 * this type can be used directly as parameters for <code>ProfileDevice</code>
 * objects.
 *
 * <p>
...
//    }
    ...
    /**
     * Create a new <code>ParameterSet</code> object initialized from the given
     * data source.
     *
