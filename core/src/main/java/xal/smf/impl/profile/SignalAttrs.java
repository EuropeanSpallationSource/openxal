...
public class SignalAttrs extends ScadaRecord {
    ...
    public enum ATTRS {
        ...
        /**
         * <p>
         * Creates a new SCADA (PV) field descriptor for the signal attribute
         ...
         * parameters
         *
         * @return A new SCADA field descriptor for the given signal attribute,
         * or <code>null</code> if field is missing
         *
         * @author Christopher K. Allen
         * @since Feb 6, 2013
         */
        ...
        /**
         * Returns the name of the field in the data structure which corresponds
         * to this enumeration constant.
         *
         ...
         *
         * @param data data structure having field corresponding to this
         * constant
         *
         ...
         * <code>SignalAttrs</code> object that this enumeration constant
         * represents. The value of that field is the <code>double</code> valued
         * field provided in the arguments.
         *
        ...
        /**
         * name of the annotation field containing the channel handle for this
         * enumeration
         */
         ...
         * <code>{@link SignalAttrs}</code> and
         * <code>{@link ASignalAttrs}</code> that the constant represents.
         *
         * @param strPropNm name of the field in the
         * <code>{@link SignalAttrs}</code> structure this constant represents
         * @param strAnnFldNm field name of annotation
         * <code>{@link ASignalAttrs}</code> which identifies the data type of
         * the channel value
         * @param strChanHnd field name of annotation
         * <code>{@link ASignalAttrs}</code>containing the metal-data to be
     ...
     *
     * @param annAttrs annotation class containing the meta-data describing the
     * signal connections
     *
     * @return fully operational <code>ScadaRecord</code> class capable of data
     * acquisition
     *
     * @author Christopher K. Allen
     * @since Feb 7, 2013
    ...
    /**
     * Create a new, initialized <code>SignalAttrs</code> object. Data field
     * values are taken immediately from the diagnostic devices.
     *
    ...
    /**
     * <p>
     * Performs an averaging operation with the given <code>SignalAttrs</code>
     ...
     * is in the interval [0,1], the new values of this structure, say
     * <em>v'</em>
    ...
    /**
     * Loads the data structure from the given data source while respecting the
     * various data format versions.
     *
