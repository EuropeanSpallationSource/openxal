 ...
 * It also provides some tools for managing the device and its connections. For
 * example, testing batch acquisition of data and configuration channels, along
 * with some common enumerations.
 * </p>
 * <p>
 * Child classes can define their own specific behavior using the
 * component-based classes <code>ParameterSet</code> and <code>SignalSet</code>.
 ...
 * <code>AcceleratorNode{@link #getType()}</code> method, since this class has
...
public abstract class ProfileDevice extends AcceleratorNode {
    ...
    public interface IProfileDomain {
        ...
        /**
         * Returns the locations within the domain interval where the profile
        ...
        /**
         * Return the length of the real interval containing the projection
    ...
    /**
     * Interface exposed by data structures containing formatted data acquired
     * from profile diagnostic devices. The interface presents that data which
     * is common to all profile devices.
     *
     * @author Christopher K. Allen
     * @since Apr 22, 2014
     */
    public interface IProfileData extends DataListener {
         ...
         * the current data.
         *
         * @return string identifier of the acquisition device (i.e., "ws",
         * "harp", etc.)
         *
         * @author Christopher K. Allen
         * @since Sep 22, 2014
        ...
        /**
         * Returns the length of each signal in the data set, that is, the
         ...
         * The type of fit and its corresponding processing should be defined by
         * the exposing method or clear from the context.
         *
...
//        public SignalAttrSet    getRawAttrs();
         ...
         * etc. These values are computed from some pre-processed, or fitted,
         * data. How these values are computed must be should be defined in in
         * the exposed method or clear from the context.
         *
         * @return signal properties of the current profile device data set
         *
         * @author Christopher K. Allen
         ...
         * producing valid data. The argument is the index for the wire, the
         * same index that would be used for the arrays of data produced by the
         * profile device.
         * </p>
         * <p>
         * If the profile device has no method of validating wire operation then
         * the method will return <code>true</code> regardless of the argument,
         * rather than a blanket <code>false</code> for all wires.
         * </p>
         *
         * @param angle projection angle of the harp to be validated
         * @param iWire index of the wire to be validated
         *
         * @return          <code>true</code> if the the wire is operating correctly or
         * the device has no method of validation, <code>false</code> if the
         * wire is faulty.
         *
         * @author Christopher K. Allen
         * @since Jul 2, 2014
    ...
    public enum ANGLE {
        ...
        /**
         * Extracts the proper signal attributes w.r.t. to this plane from the
         * given set of signal attributes.
         *
        ...
        /**
         * Extracts the field descriptor for the position channel from the
         * annotations of the given <code>SignalSet</code>-derived class type.
         *
         * @param clsData the <code>Data</code>-derived child class with DAQ
         * annotations
         *
         * @return position channel field descriptor for this plane
         *
         * @throws ScadaAnnotationException a required field of the
         * <code>ASet</code> annotation was empty or annotation not found
         *
         * @author Christopher K. Allen
         * @since Sep 27, 2011
         */
        ...
        /**
         * Extracts the field descriptor for the signal value channel from the
         * set of acquisition descriptors.
         *
         * @param clsData the <code>SignalSet</code>-derived child class with
         * DAQ annotations
         *
    ...
    public enum TRGEVT {
         ...
         * Trigger event code
         */
        TEST_NETWORK_MARKER(249),
        /**
         * Trigger event code
         */
        DIAG_MPS_SNAPSHOT(250),
        /**
         * Trigger event code
         */
        COMPUTE_REP_RATE(251),
        /**
         * Trigger event code
         */
        NEW_REP_RATE_EVENT(252),
        /**
         * Trigger event code
         */
        MPS_ERROR_RESET(253),
         ...
         * Trigger event code
         */
        UTIL_ERROR_RESET(254),
        /**
         * Trigger event code
         */
        SUPERCYCLE_START(255);

        /**
         * Returns the trigger event enumeration constant for the given trigger
         * event code.
         *
         * @param iEvtVal raw event code value
         *
         * @return the trigger event corresponding to the given event code, or
         * <code>UNKNOWN</code> if there was no match.
         *
         * @since Dec 22, 2009
         * @author Christopher K. Allen
         */
        ...
        /**
         * Returns the raw (numeric) event code for the current triggering
         * event.
         *
    ...
    /**
     * Enumeration of the gain constants for the <code>ProfileDevice</code>
    ...
    public enum GAIN {
         ...
         *
         * @return corresponding gain enumeration constant for given value, or
         * <code>UNKNOWN</code> if value has no constant
         *
         * @since Dec 22, 2009
         * @author Christopher K. Allen
         */
     ...
     * <code>{@link DevStatus#mvtStatus}</code>.
     *
     * @since Jan 22, 2010
     * @author Christopher K. Allen
     */
    public enum MVTVAL {
        ...
        /**
         * Return the value of the movement state that this enumeration constant
         * represents.
         *
        ...
        /**
         * Returns the movement enumeration constant for the given movement code
         * value.
         *
         ...
         *
         * @param intVal numerical value represented by this enumeration
         * constant
         */
     ...
     */
    /**
     * Retrieves a given set of configuration parameter values. The values are
     * returned in a new instance of the data structure type provided in the
     * argument. (Note that all configuration parameters are contained in data
     * structures derived from the base class <code>ParameterSet</code>.)
     *
     ...
     *
     * @throws BadStructException the DAQ data structure and DAQ channels are
     * incompatible or could not be constructed
     * @throws ConnectionException unable to connect to a parameter readback
     * channel
     * @throws GetException general CA GET exception while reading a parameter
     * value
     *
     * @author Christopher K. Allen
     * @since Nov 15, 2011
     ...
     * The type of data set is determined by the class type parameter
     * <code>T</code> given to this method. (Note that all data sets are data
     * structured derived from the base class <code>Data</code>.)
     *
     * @param <T> specific type of data set being requested
     * @param clsType class type of data being requested
     *
     * @return measurement data set currently available on this wire scanner
     * data buffers
     *
     * @throws BadStructException the DAQ data structure and DAQ channels are
     * incompatible or could not be constructed
