 ...
 * a wire profile measurement device. The names of the read back channels for
 * both the position array and the value array are included here. Also, the
...
public @interface ASignal {
    ...
    public static @interface ASet {
        ...
        /**
         * Provides the connection parameters for horizontal projection data
         * acquisition.
         *
         * @return  <code>ASignal</code> annotation containing profile device
        ...
        /**
         * Provides the connection parameters for vertical projection data
         * acquisition.
         *
         * @return  <code>ASignal</code> annotation containing profile device
         * connection parameters
        ...
        /**
         * Provides the connection parameters for diagonal projection data
         * acquisition.
         *
         * @return  <code>ASignal</code> annotation containing profile device
         * connection parameters
     ...
     *
     * @return class type of the sample count, default value is
     * <code>int.class</code>
     *
     * @author Christopher K. Allen
     * @since Jan 31, 2013
    ...
    /**
     * The XAL channel handle for the number of active signal samples. This
     * differs from the size of the signal array returned by the channel in
     * <code>ADaqWire.Signal.Hor#hndPosRb</code> which is the buffer size of the
     * DAQ controller.
     *
     ...
     *
     * @return the class type of the position array, default value is
     ...
     *
     * @return the name of the channel serving up the position array, no default
     * value
     *
     * @author Christopher K. Allen
     * @since Jan 31, 2013
     ...
     *
     * @return the type of the value array, default value is
     * <code>double[].class</code>
     *
     * @author Christopher K. Allen
     * @since Jan 31, 2013
    ...
    /**
     * The data type of the noise mean value. The default value is
     * <code>double.class</code>.
     *
     * @return class type of the noise mean parameter, default value is
     * <code>double.class</code>
     *
     * @author Christopher K. Allen
     * @since Dec 7, 2011
     ...
     *
     * @return noise variance channel name, default value is <code>""</code>
     * (empty string)
     *
     * @author Christopher K. Allen
     * @since Dec 7, 2011
     ...
     *
     * @return class type of the noise variance parameter, the default value is
     * <code>double.class</code>.
     *
     * @author Christopher K. Allen
     * @since Dec 7, 2011
