...
public class MagnetMainSupply extends MagnetPowerSupply {
    ...
    /**
     * MPS - field setpoint about which warnings and alarms are specified
     */
    ...
    /**
     * Set the cycle enable state of the magnet power supply. If enabled, the
     * magnet will be cycled when the field is set.
     *
    ...
    /**
     * Get the field contribution from this power supply. T/(m^(n-1)), where n =
     * 1 for dipole, 2 for quad, etc.
     *
    ...
    /**
     * Set the field contribution from this power supply. If cycle enable is set
     * to true the field is cycled otherwise it is simply set to the specified
     * value.
     *
    ...
    /**
     * Get the value to which the field is set. Note that this is not the
     * readback.
     *
    ...
    /**
     * get the field upper display limit in T/(m^(n-1)), where n = 1 for dipole,
    ...
    /**
     * get the field lower display limit in T/(m^(n-1)), where n = 1 for dipole,
