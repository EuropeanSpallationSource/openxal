 ...
 * <br>
 * &middot; This is a refactoring of the original <code>WireScanner</code> class
 * that generalizes to the <code>WireHarp</code>
 * </p>
 *
 * <p>
...
public class WireScanner extends ProfileDevice {
     ...
     * in the command array. It provides the command type while additional
     * arguments provide the command parameters.
     * </p>
     *
     * @since Aug 21, 2009
     * @author Christopher K. Allen
    ...
    public enum CMD {
        ...
        SETUPDAQ(11),
        /**
         * Move until a limit switch is hit (takes arguments 1: forward, 0:
         * reverse)
         */
        HIT(13),
        /**
        ...
        SAVE(15),
        /**
         * Recreate the traces and profile points and re-fit to the new profiles
         * (needed after modifying for example the delay parameter).
         */
        REANALYZE(17),
        /**
        ...
        UPDATE(20),
        /**
         * Performs a (simple) scan using predefined scan parameters within the
         * device controller
         */
        EZ_SCAN(21);
        ...
        /**
         * Returns the integer-value device command associated with the command
        ...
        /**
         * Create a new <code>CMD</code> constant with the given device command.
         *
    ...
    public enum CMDARG {
         ...
         */
        /**
         * Returns the integer-value device command associated with the
         * (CMD,ARG) pair.
         *
        ...
        /**
         * Returns the integer-value command argument associated with the
         * (CMD,ARG) pair.
         *
        ...
        /**
         * Create a new <code>CMD_ARG</code> enumeration constant for the given
         * (CMD,ARG) pair.
         *
     ...
     * argument is packaged together with a <code>{@link CMD}</code> instance to
    ...
    public static class CmdPck {
         ...
         */
        /**
         * Create a new <code>Cmd</code> object for the given <code>CMD</code>
         * and no arguments.
         *
        ...
        /**
         * Create a new <code>Cmd</code> object for the given
         * <code>{@link CMD}</code> and the given <code>{@link CMDARG}</code>
         * argment and any addition arguments <var>addargs</var>.
         *
         * @param cmd the wire scanner command
         ...
         */
        /**
         * Return the number of arguments in this command. Currently there is a
         * maximum of three.
         *
        ...
        /**
         * Returns the command constant of this command instance, that is, an
         * element of the enumeration <code>CMD</code>.
         *
        ...
        /**
         * Returns the argument of this command. This method is actually a
         * shortcut for the method call
         * <br>
         * <br>
         * &nbsp; &nbsp; <code>{@link #getArgument(int)}</code>
         * <br>
         * <br>
         * for the argument of 0. Specially, use this method if there is only
        ...
        /**
         * Return the command argument at the given index. Note that the
         * argument index value must be strictly less than the argument count.
         *
     ...
     */
    /**
     * Register the hardware device types that this class recognizes.
     */
    static {
    ...
    public static class SmplConfig extends ParameterSet {
         ...
         *
         * @throws ConnectionException unable to connect parameter read back
         * channel
        ...
        /**
         * Create a new <code>DaqConfig</code> object initialized from the given
         * data source.
         *
        ...
        /**
         * Create a new <code>DaqConfig</code> object initialize with values
         * fetched from the given device.
         *
         * @param ws data acquisition device
         *
         * @throws ConnectionException unable to connect to a parameter read
         * back channel
         * @throws GetException general field initialization exception
         *
         * @since Dec 16, 2009
         ...
         */
        /**
         * Set the gain as a <code>GAIN</code> enumeration.
         *
        ...
        /**
         * Return the gain as a <code>GAIN</code> enumeration.
         *
    ...
    public static class ActrConfig extends ParameterSet {
        ...
        /**
         * The initial (actuator) speed of the actuator in mm/sec. This is the
         * maximum speed obtained by the actuator en route to the location where
         * the data acquisition begins.
         */
        @AScada.Field(
                type = double.class,
                ctrl = true,
        ...
        /**
         * The maximum acceleration of the actuator used to move into the
         * initial scan location; that is, the time derivative of
         * <code>velInit</code>. The units are mm/sec<sup>2</sup>.
         */
        @AScada.Field(
                type = double.class,
                ctrl = true,
        ...
        /**
         * The maximum acceleration of the actuator used to move between
         * sampling points, in mm/sec<sup>2</sup>. That is, the time derivative
         * of <code>velStep</code>.
         */
        @AScada.Field(
                type = double.class,
                ctrl = true,
        ...
        /**
         * The maximum velocity used by the actuator when searching for a limit
         * switch, in mm/sec.
         */
        @AScada.Field(
                type = double.class,
        ...
        /**
         * The maximum acceleration used by the actuator when searching for a
         * limit switch, in mm/sec<sup>2</sup>.
         */
        @AScada.Field(
                type = double.class,
                ctrl = true,
        ...
        /**
         * The maximum actuator speed when returning to the home location, in
         * mm/sec.
         */
        @AScada.Field(
                type = double.class,
        ...
        /**
         * The maximum actuator acceleration when returning to the home
         * location, in mm/sec.
         */
        @AScada.Field(
                type = double.class,
        ...
        /**
         * The maximum time allowed while the actuator is searching for a limit
         * switch, in seconds.
         */
        @AScada.Field(
                type = double.class,
        ...
        /**
         * The maximum time allowed to move the actuator between sampling
        ...
        /**
         * Create a new <code>ActrConfig</code> object initialized from the
         * given data source.
         *
         * @param daptSrc data source containing data structure fields
         *
        ...
        /**
         * Create a new <code>ActrConfig</code> object initialize with values
         * fetched from the given device.
         *
         * @param ws data acquisition device
         *
    ...
    public static class ScanConfig extends ParameterSet implements IProfileDomain {
         ...
         */
        /**
         * The map between structure field names and there corresponding
         * descriptors
         */
         ...
         * parameters are obtained from a call to channel access and returned
         * the the scan parameter data structure.
         *
         * @param ws profile device under request
         *
        ...
        /**
         * The initial (actuator) position of the scan in mm. This is the
         * actuator location where the data acquisition begins. The actuator
         * initially moves to this location then begins the data scan at the
         * specified scan rate. The data is taken between this value and that
         * returned by <code>compFinalPosition()</code>.
         */
        @AScada.Field(
                type = double.class,
                ctrl = true,
        ...
        /**
         * The total number of profile data samples in the scan data set. That
         * is, the number of actuator steps during data acquisition.
         */
        @AScada.Field(
                type = int.class,
                ctrl = true,
        ...
        /**
         * The size of each scan step in mm. That is, the distance between
         * actuator positions for each profile data sample.
         */
        @AScada.Field(
                type = double.class,
                ctrl = true,
        ...
        /**
         * The number of beam pulses (traces) used to compute a profile sample
         * value. Note that a value greater than 1 indicates averaging.
         * Attempting to set the value less than 1 does nothing.
         */
        @AScada.Field(
                type = int.class,
                ctrl = true,
        ...
        /**
         * The maximum position of the scan considering the current values of
         * <code>posInit</code>, <code>stepLength</code>, and
         * <code>stepCount</code>
         */
        @AScada.Field(
                type = double.class,
        ...
        /**
         * The stroke length of the device actuator. Thus, this is the maximum
         * possible distance the wire can travel while taking data. It is a
         * mechanical limitation.
         * <br> <br>
         * The product of <code>stepLength</code> &times; <code>stepCount</code>
         * must be less than this value. This is a read-only quantity.
         */
        @AScada.Field(
                type = double.class,
                ctrl = false,
        ...
        /**
         * Error flag indicating that the scan parameters are inconsistent, that
         * is, they do not describe a viable scan.
         */
        @AScada.Field(
                type = int.class,
                ctrl = false,
 ...
 /*
        ...
        /**
         * Create a new <code>ScanConfig</code> object initialized from the
         * given data source.
         *
         * @param daptSrc data source containing data structure fields
         *
        ...
        /**
         * Create a new <code>ScanConfig</code> object initialize with values
         * fetched from the given device.
         *
         * @param ws data acquisition device
         *
         ...
         *
         * @see
         * xal.smf.impl.profile.ProfileDevice.IProfileDomain#getSampleCount(xal.smf.impl.profile.ProfileDevice.ANGLE)
         *
         * @author Christopher K. Allen
         * @since Apr 24, 2014
         */
        ...
        /**
         * @see
         * xal.smf.impl.profile.ProfileDevice.IProfileDomain#getSamplePositions(xal.smf.impl.profile.ProfileDevice.ANGLE)
         *
         * @author Christopher K. Allen
         * @since Apr 24, 2014
         */
         ...
         *
         * @see
         * xal.smf.impl.profile.ProfileDevice.IProfileDomain#getInitialPosition(xal.smf.impl.profile.ProfileDevice.ANGLE)
         *
         * @author Christopher K. Allen
         * @since Apr 24, 2014
         */
...
//            }
         ...
         *
         * @see
         * xal.smf.impl.profile.ProfileDevice.IProfileDomain#getIntervalLength(xal.smf.impl.profile.ProfileDevice.ANGLE)
         *
         * @author Christopher K. Allen
         * @since Apr 24, 2014
         */
    ...
    public static class PrcgConfig extends ParameterSet {
        ...
        /**
         * Create a new <code>PrcgConfig</code> object initialized from the
         * given data source.
         *
         * @param daptSrc persistent data store containing data structure field
         * values
         *
         * @since Mar 17, 2010
         * @author Christopher K. Allen
    ...
    public static class TrgConfig extends ParameterSet {
         ...
         */
        /**
         * Time delay between beam-on event and actual DAQ start. NOTE: this
         * value may be negative indicating DAQ before the beam-on event (thus,
         * sampling only noise)
         */
        @AScada.Field(
                type = double.class,
         ...
         */
        /**
         * Sets the value of the <code>event</code> field using the appropriate
         * <code>TRGEVT</code> enumeration constant.
         *
        ...
        /**
         * Returns the triggering event code taken from the raw value field
         * <code>event</code> of this data structure.
         *
        ...
        /**
         * Create a new <code>TrgConfig</code> object initialized from the given
         * data source.
         *
         * @param daptSrc persistent data store containing data structure field
         * values
        ...
        /**
         * Create a new <code>TrgConfig</code> object initialize with values
         * fetched from the given device.
         *
         * @param ws data acquisition device
         *
    ...
    public static class DevStatus extends ParameterSet {
        ...
        /**
         * Timing error flag. General error in the device controller timing
         * hardware.
         */
        @AScada.Field(
                type = int.class,
        ...
        /**
         * Actuator collision error. Motion was disabled to prevent collision
         * with another device.
         * <br>
         * <br>
        ...
        /**
         * The current scan sequence identifier. The value is incremented on the
    ...
    public static class GaussFitAttrSet extends SignalAttrSet {
         ...
         * @return New data populated structure
         *
         * @throws NoSuchChannelException unable to find channel for given
         * handle
        ...
        /**
         * Create a new <code>GaussFitAttrSet</code> object initialized from the
         * given data source.
         *
         * @param daptSrc persistent data store containing data structure field
         * values
    ...
    public static class DblGaussFitAttrSet extends SignalAttrSet {
         ...
         * @throws ConnectionException unable to connect to a field's channel
         * @throws GetException general CA GET exception while fetch field value
         * @throws IllegalAccessException a needed field in the annotation is
         * not publicly accessible
         * @throws IllegalArgumentException this class is not annotated with
         * <code>ASgnlAttrSet</code>
         *
         *
         * @since Nov 14, 2009
         * @author Christopher K. Allen
        ...
        /**
         * Create a new <code>DblGaussianAttrSet</code> object initialized from
    ...
    public static class StatisticalAttrSet extends SignalAttrSet {
        ...
        /**
         * Create a new <code>Statistical</code> object initialized from the
         * given data source.
         *
         * @param daptSrc persistent data store containing data structure field
         * values
         ...
         * @param ws device providing initializing data
         *
         * @throws IllegalArgumentException general field incompatibility
         * exception
         * @throws ConnectionException unable to connect to a parameter read
         * back channel
         * @throws GetException general CA GET exception while fetch field value
...
//        }
         ...
         * @return New data populated structure
         *
         * @throws ScadaAnnotationException the <code>ASignal.ASet</code>
         * annotations are incomplete
         * @throws ConnectionException unable to connect to a parameter read
         * back channel
         * @throws GetException general CA GET exception while fetch field value
         * @throws BadStructException the DAQ data structure and DAQ channels
         * are incompatible, bad definition
         *
         * @since Nov 14, 2009
         * @author Christopher K. Allen
         */
...
//
         ...
         *
         * @throws ScadaAnnotationException the channel handle annotations are
         * not setup correctly
         *
         * @since Feb 16, 2010
         * @author Christopher K. Allen
        ...
        /**
         * Create a new <code>DataLive</code> object initialized from the given
         * data source.
         *
         * @param daptSrc persistent data store containing data structure field
         * values
         *
         * @throws ScadaAnnotationException the Data AcQ annotations are not
         * setup correctly
         *
         * @since Mar 17, 2010
         * @author Christopher K. Allen
        ...
        /**
         * Create a new <code>DataLive</code> object initialize with values
         * fetched from the given device.
         *
         * @param ws data acquisition device
         *
     ...
     * </p>
     * <p>
     * This appears to be then entire profile available after every measurement
     * sample. This is different than the addition point value after each
     * sample. The connected Process Variables are different, so it is likely
...
//        }
        ...
        /**
         * Create a new <code>DataLiveArr</code> object initialized from the
         * given data source.
         *
         * @param daptSrc persistent data store containing data structure field
         * values
         ...
         * @throws ScadaAnnotationException the Data AcQ annotations are not
         * setup correctly
         * @throws MissingResourceException a data field was missing from the
         * data source
         * @throws BadStructException data structure fields are
         * ill-defined/incompatible
         *
         * @since Mar 17, 2010
         * @author Christopher K. Allen
         */
        ...
        /**
         * Create a new <code>DataLiveArr</code> object initialize with values
         * fetched from the given device.
         *
         * @param ws data acquisition device
         *
...
//        }
         ...
         *
         * @throws ScadaAnnotationException this class is not annotated with
         * <code>ASignal.ASet</code>, or the annotation is corrupt
         *
         * @since Feb 26, 2010
         * @author Christopher K. Allen
         */
        ...
        /**
         * Create a new <code>DataRaw</code> object initialized from the given
         * data source.
         *
         * @param daptSrc persistent data store containing data structure field
         * values
        ...
        /**
         * Create a new <code>DataRaw</code> object and initialize with values
         * fetched from the given device.
         *
         * @param ws data acquisition device
         *
...
//        }
        ...
        /**
         * Create a new <code>DataFit</code> object initialized from the given
         * data source.
         *
         * @param daptSrc persistent data store containing data structure field
         * values
        ...
        /**
         * Create a new <code>DataFit</code> object initialize with values
         * fetched from the given device.
         *
         * @param ws data acquisition device
         *
...
//        }
        ...
        /**
         * Create a new <code>DataTrace</code> object initialized from the given
         * data source.
         *
         * @param daptSrc persistent data store containing data structure field
         * values
     ...
     *
     * @return the "software type" or the driver version for the hardware.
     */
    @Override
...
//        channel.putVal( CMD.NOOP.getCode() );
    ...
    /**
     * Issue a wire scanner command with or without arguments arguments. The
     * command and argument list is packed in the argument of type
     * <code>{@link WireScanner2.CmdPck}</code> Here we are packing the
     * command-argument vector as an array of type <code>double</code>.
     *
...
//        channel.putVal( CMD.NOOP.getCode() );
    ...
    /**
     * Returns the command result code(s). These are integer valued codes for
     * the result of a previous issued device command. See the wire scanner
     * documentation to interpret the particular resultant code.
     *
    ...
    /**
     * Test the connections in all the channels of the given parameter set for
     * this accelerator device. The test will wait up to the given length of
     ...
     *
     * @throws BadChannelException An unbound channel handle within a field
     * descriptor
     *
     * @author Christopher K. Allen
     * @since Feb 4, 2011
...
//    }
     ...
     * handle). The monitor events are sent to the <code>IEventSink</code>
     * object provided.
     * </p>
     * <p>
     * One can specify the event type which fires the monitor using the argument
     * intEvtType. Any combination of the following event types can be specified
     ...
     * @param mskEvtType code specifying when the monitor is fired (or'ed
     * combination of {Monitor.VALUE, Monitor.LOG, Monitor.ALARM})
     *
     * @return A new monitor on the given process variable
     *
     * @throws xal.smf.NoSuchChannelException if the handle does not identify
     * any process variable of this accelerator node
     ...
     * <code>{@link PrcgConfig}</code>) so that the on-board controller selects
     * the beam micro-bunch section for computing measurement results.
     *
     * @param enmBmSct the part of the beam on which to focus the analysis
     * @param dblBmFrac proportion of the current beam to be used in analysis (a
     * value 1 is the entire macro-pulse)
     *
     * @throws RejectedExecutionException (runtime exception) the machine is not
     * in 50 &mu;sec mode, parameter will not be changed
     * @throws NoSuchChannelException error in XAL channel handle/EPICS PV
     * binding
     ...
     * @throws PutException unable to set the new analysis configuration
     * parameters
     *
     * @author Christopher K. Allen
     * @since Nov 3, 2011
