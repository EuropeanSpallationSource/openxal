...
abstract public class Electromagnet extends Magnet {
    ...
    /**
     * Update data from the power supply data adaptor. Get the main power supply
     * information.
     *
     ...
     *
     * @param useFieldReadback true to use the field readback and false to use
     * the field setting.
     */
     ...
     *
     * @return true if the field readback is used in getField() and false if
     * instead the field setting is used.
     */
    ...
    /**
     * Find the channel for the specified handle searching the main supply if
     * necessary.
     *
    ...
    /**
     * Set the cycle enable state of the magnet. If enabled, the magnet will be
     * cycled when the field is set.
     *
     ...
     * states: cycle is invalid (field changed in reverse direction of initial
     * setting), cycling in progress or cycle is valid
     *
    ...
    /**
     * Set the main power supply field contribution in the magnet. If cycle
     ...
     * and possible trim supply contributions. Note that this is not the
     * readback.
     *
     * @return the field setting in T/(m^(n-1)), where n = 1 for dipole, 2 for
     * quad, etc.
     ...
     *
     * @return false since all Electromagnet instances are not permanent
     * magnets.
     */
