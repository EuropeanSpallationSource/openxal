...
public class TwissBucket extends AttributeBucket {
    ...
    public double   getX()      { return attX.getDouble(); }
    public double   getY()      { return attY.getDouble(); }
    
    public double   getAlphaX()     { return attAlphaX.getDouble(); }
    public double   getBetaX()      { return attBetaX.getDouble(); }
    public double   getEmitX()      { return attEmitX.getDouble(); }
    
    public double   getAlphaY()     { return attAlphaY.getDouble(); }
    public double   getBetaY()      { return attBetaY.getDouble(); }
    public double   getEmitY()      { return attEmitY.getDouble(); }
    
    public double   getAlphaZ()     { return attAlphaZ.getDouble(); }
    public double   getBetaZ()      { return attBetaZ.getDouble(); }
    public double   getEmitZ()      { return attEmitZ.getDouble(); }
    
    public double   getEtaX()       { return attEtaX.getDouble(); }
    public double   getEtaPx()      { return attEtaPx.getDouble(); }
    public double   getEtaY()       { return attEtaY.getDouble(); }
    public double   getEtaPy()      { return attEtaPy.getDouble(); }
    
    public double   getMuX()      { return attMuX.getDouble(); }
    public double   getMuY()      { return attMuY.getDouble(); }
    ...
    public void setX(double dblVal)     { attX.set(dblVal); }
    public void setY(double dblVal)     { attY.set(dblVal); }
    
    public void setAlphaX(double dblVal)    { attAlphaX.set(dblVal); }
    public void setBetaX(double dblVal)     { attBetaX.set(dblVal); }
    public void setEmitX(double dblVal)     { attEmitX.set(dblVal); }
     
    public void setAlphaY(double dblVal)    { attAlphaY.set(dblVal); }
    public void setBetaY(double dblVal)     { attBetaY.set(dblVal); }
    public void setEmitY(double dblVal)     { attEmitY.set(dblVal); }
     
    public void setAlphaZ(double dblVal)    { attAlphaZ.set(dblVal); }
    public void setBetaZ(double dblVal)     { attBetaZ.set(dblVal); }
    public void setEmitZ(double dblVal)     { attEmitZ.set(dblVal); }

    public void setEtaX(double dblVal)      { attEtaX.set(dblVal); }
    public void setEtaPx(double dblVal)     { attEtaPx.set(dblVal); }
    public void setEtaY(double dblVal)      { attEtaY.set(dblVal); }
    public void setEtaPy(double dblVal)     { attEtaPy.set(dblVal); }
    
    public void setMuX(double dblVal)       { attMuX.set(dblVal); }
    public void setMuY(double dblVal)       { attMuY.set(dblVal); }
