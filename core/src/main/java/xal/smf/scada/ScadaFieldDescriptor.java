 ...
 * PVs. For example, such data sets are supported by {@link ScadaRecord}.
 * </p>
 * <p>
...
public class ScadaFieldDescriptor extends XalPvDescriptor {
    ...
    /**
     * <p>
     * This method returns the field descriptor objects for each field in the
     * SCADA data structure, only here it is returned as an array. This is a
     * convenience method which simply calls
     * <code>{@link ScadaFieldDescriptor#makeFieldDescriptorList(Class)}</code>
     * then converts the result into an array.
     * </p>
     *
    ...
    /**
     * <p>
     * This method returns meta-data of the <code>{@link AScada.Field}</code>
     * annotation used to identify fields in data structures as Supervisory
     * Control And Data Acquisition (SCADA) fields. The meta-data is taken from
     * each field annotation and is used to populate a
     * <code>ScadaFieldDescriptor</code> object. The sum of all annotation data
     * for each field is returned as a list of field descriptors.
     * </p>
     * <p>
     * This whole mechanism of <code>ScadaFieldDescriptor</code> usage is
     * (hopefully) going to be eradicated. It is too clumsy and the Java
     * Annotation mechanism seems more appropriate.
     * </p>
     *
     * @param clsScada class type which is meant to be a SCADA data structure It
     * must be annotated with <code>AScada</code>
     *
     * @return list of field descriptors describing all the field in the data
     * structure used for SCADA.
     *
     * @author Christopher K. Allen
     * @since Feb 16, 2011
     */
    ...
    /**
     * <p>
     * This method returns data of the <code>{@link AScada.Field}</code>
     * annotation meta data. The meta data is used to identify fields in data
     * structures as Supervisory Control And Data Acquisition (SCADA) fields.
     * The meta-data is taken the annotation around the field and entered into a
     * new a <code>ScadaFieldDescriptor</code> object.
     * </p>
     *
     ...
     * must be annotated with <code>AScada</code>
     *
     * @return field descriptor describing the field meta-data in the data
     * structure or <code>null</code> if the field is not a SCADA type
     *
     *
    ...
    /**
     * Creates a <code>ScadaStruct$ScadaFieldDescriptor</code> object according
     * to the specifications in the given arguments.
     *
     ...
     *
     * @param clsRec class type annotated with the <code>AScada.Record</code>
     * annotation
     *
     ...
     * represents a process variable that can be controlled and has a "set
     * value" channel.
     *
     * @param strFldNm the name of the data field
     * @param clsType the class type of the data field
