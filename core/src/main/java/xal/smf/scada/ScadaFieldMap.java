...
/**
 * <p>
 * This class parses the meta-data of the <code>{@link AScada.Field}</code>
 ...
 * annotation and is used to populate a <code>ScadaFieldDescriptor</code>
...
public class ScadaFieldMap extends HashMap<String, ScadaFieldDescriptor> {
    ...
    /**
     * <p>
     * Create a new SCADA field map object which contains the fields in the
     * given list.
     * </p>
     * <h3>NOTE:</h3>
     * <p>
     * The class <code>ScadaFieldList</code> is derived from the type
     * <code>List<ScadaFieldDescriptor></code>. Thus, objects of that type maybe
     * be used as arguments.
     * </p>
     *
     * @param lstFlds list containing field descriptors to be mapped (keyed by
     * field name)
     *
     * @author Christopher K. Allen
     * @since Oct 14, 2011
