 ...
 * <code>{@link IFieldDescriptor}</code>s objects) does not match the actual
...
public class BadStructException extends RuntimeException {
    ...
    /**
     * Create a new <code>BadStructDefinition</code> object with a descriptive
     * message.
     *
    ...
    /**
     * Create a new <code>BadStructDefinition</code> object with the source
     * exception (the present exception being the last in a chain).
     *
