 ...
 * <code>{@link BatchConnectionTest}</code>
 *
 * @author Christopher K. Allen
 * @since Mar 4, 2011
 */
...
public class ScadaCheckConnect {
    ...
    public static final class ConnectionMonitor implements ConnectionListener {
         ...
         *
         * @param chnFld EPICS channel connecting to a field within the
         * parameter set.
    ...
    public static final class TestChannelList {
         ...
         */
        /**
         * Create a new, empty <code>TestChannelList</code> object.
         *
         * @author Christopher K. Allen
         * @since Mar 7, 2011
         */
        ...
        /**
         * Returns the size of the list, i.e., the number of unconnected
        ...
        /**
         * Returns the list of channels which never connected, that is, they are
         * still pending.
         *
        ...
        /**
         * Removes the given channel from the the channel list. If there are not
         * more channels in the list we send an interrupt to the main thread.
         *
        ...
        /**
         * Sends a "connection request" to Channel Access for all the channels
         * within the list. If all connection monitors return before the timeout
         * period the method {@link #remove(Channel)} will issue an interrupt
         * waking up the current thread.
         *
         * @param dblTmOut time (in seconds) to wait before connection attempt
         * is aborted
         *
         * @return  <code>true</code> if all connections were made in the alloted
         * time, false if otherwise
         *
         * @author Christopher K. Allen
         * @since Mar 7, 2011
         */
    ...
    /**
     * Test the connections in all the channels in this DAQ data structure for
     * the given accelerator device. The test will wait up to the given length
     ...
     *
     * @throws BadStructException the data structure is not annotated by
     * <code>AScada</code>
     *
     * @author Christopher K. Allen
     * @since Feb 4, 2011
     ...
     * <em>channel handle</em>. Then, we create a <code>ConnectionMonitor</code>
     * object for the given channel. The channel is added to the list of
     * requested channel connects then a request is made for connection.
     * </p>
     * <p>
     ...
     *
     * @throws BadStructException the given device does not contain a requested
     * channel
     *
     * @author Christopher K. Allen
     * @since Feb 4, 2011
