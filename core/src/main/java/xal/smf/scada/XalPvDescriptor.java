...
public class XalPvDescriptor {
    ...
    public interface IPvDescriptor {
        ...
        /**
         * Return the XAL process variable descriptor for the enumeration
         * constant.
         *
     ...
     */
    /**
     * Create a new <code>XalPvDescriptor</code> object with read back values
     * only. The read back channel hand the given handles and the PV value has
     * the given data type.
     *
    ...
    /**
     * Create a new <code>XalPvDescriptor</code> object that is controllable
     * with the given channel handles and data type.
     *
     * @param clsType PV value data type
     * @param strHandleRb read back channel XAL handle
     ...
     *
     * <p>
     * <strong>NOTE:</strong> Added to implement the functionality of
     * PvDescriptor in XAL.<br>
     ...
     */
    /**
     * Return the channel handle for the PV corresponding to the current
     ...
     *
     * @return  <code>true</code> if the PV is controllable, <code>false</code>
     * if it can only be read
     *
     * @since Nov 6, 2009
     * @author Christopher K. Allen
     */
