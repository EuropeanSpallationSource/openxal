...
public abstract class ScadaRecord implements DataListener, Cloneable {
     ...
     * The name is typically the name of the structure field itself.
     *
     * @param strName field name
     *
     * @return PV field descriptor with given field name or <code>null</code> if
     * not found
     *
     * @author Christopher K. Allen
     * @since Oct 4, 2011
     ...
     * structure.
     *
     * @return map of descriptors that characterize the fields of this data
     * structure
     *
     * @author Christopher K. Allen
     * @since Jan 28, 2013
    ...
    /**
     * Populate the fields of this data set with the current Process Variable
     * values of the given device. We assume that this data set has the
     * appropriate fields for the given device.
     *
     ...
     * @throws ConnectionException unable to connect to a descriptor read back
     * channel
    ...
    /**
     * Sets the parameters of the given hardware device, to the values in this
     * data structure.
     *
     ...
     * @throws PutException general put exception (unable to set all parameter
     * values)
     *
     * @since Dec 17, 2009
     * @author Christopher K. Allen
     ...
     */
    /**
     * Read in the values of the data structure fields from the data source
     * behind the data adaptor interface. The attributes of the data source are
     * the field names, the values are taken from there.
     *
     * @since Mar 3, 2010
     * @author Christopher K. Allen
     *
     * @throws MissingResourceException a data field was missing from the data
     * source
     * @throws BadStructException data structure fields are
     * ill-defined/incompatible
     *
    ...
    /**
     * Save the data structure field values to the given data sink behind the
     * <code>DataAdaptor</code> interface. Each value is stored as the value of
     * an attribute being the field name.
     *
     ...
     */
    /**
     * Make a deep copy of this <code>ScadaStruct</code> object. The field
     * descriptors do not need to be duplicated, however, for they are
     * immutable.
     *
     * @since Apr 19, 2012
    ...
    protected Object clone() throws CloneNotSupportedException {
        ...
        strCopy.lstFldDscr = new LinkedList<>();
        strCopy.mapNm2Fd = new HashMap<>();
     ...
     */
    /**
     * Create a new <code>ScadaStruct</code> object. The field descriptors are
     * taken from annotations in the source code. The structure fields in the
     * derived class should be annotated using the <code>AScada.Field</code>
     * annotation to be recognized and included in the list of field
     * descriptors.
     *
     * @throws BadStructException no SCADA fields (@Scada.Field) were found in
     * data structure, CKA: I have removed this for now
     *
     * @since Jan 18, 2011
     * @author Christopher K. Allen
     */
    ...
    /**
     * Creates a new <code>ScadaStruct</code> object which is a deep copy of the
     * argument.
     *
     * @param clone the <code>ScadaStruct</code> to be cloned
     *
     * @throws CloneNotSupportedException occurs when a defining
     * <code>ScadaFieldDescriptor</code> cannot be copied
     *
     * @author Christopher K. Allen
     * @since Apr 19, 2012
     */
    protected ScadaRecord(ScadaRecord clone) throws CloneNotSupportedException {
        ...
        this.lstFldDscr = new LinkedList<>();
    ...
    /**
     * Creates a new instance of <code>ScadaRecord</code> initializing the
     * connections from the SCADA records in the annotated argument.
     *
    ...
    /**
     * Create a new <code>ScadaStruct</code> object. Called by child classes to
     * define their data fields and PVs (with
     * <code>ScadaFieldDescriptor</code>s) directly. That is, without the
     * annotation option.
     *
     ...
     */
    /**
     * Set the value of of the given data field using the value obtained from
     * the PV attached to the given device. The type of the field is determined
     * using Java reflection. Supported typed are all the native types plus
     * their array forms. The value of the PV is read in as the same type of the
     * data field. This cowboy approach should be okay since the method is meant
     ...
     * @throws BadStructException data structure fields are
     * ill-defined/incompatible
     * @throws ConnectionException unable to connect to descriptor read back
     * channel
    ...
    /**
     * <p>
     * Sets the given PV with the value of the data structure field given by
     * name. Of course all this is for the SMF hardware device given in the
     * argument. Thus, the given device must contain the given PV, and this data
     * structure must contain the named field.
     * </p>
     * <p>
     * We check the type of the named data field. The PV is set using this type
     * (not the data type specified in the {@link PvDescriptor} given in the
     * arguments.
     * </p>
     *
     ...
     * @throws ConnectionException unable to connect to descriptor set value
     * channel
