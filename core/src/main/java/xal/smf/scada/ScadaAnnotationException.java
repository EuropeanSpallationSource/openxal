...
public class ScadaAnnotationException extends RuntimeException {
    ...
    /**
     * Creates a new <code>ScadaAnnotationException</code> with the given error
     * message.
     *
    ...
    /**
     * Creates a new <code>ScadaAnnotationException</code> with the given source
     * exception.
     *
