...
public class OpticsSwitcher {
     ...
     * Primary Constructor
     *
     * @param includeDisposeButtons indicates whether to show cancel and close
     * buttons which are appropriate for a hosting dialog
    ...
    /**
     * Set the callback to capture the user cancel and close events. Call this
     * method if the view will be hosted in a custom dialog
     */
