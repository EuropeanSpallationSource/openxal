...
public class NoSuchChannelException extends RuntimeException {
    ...
    /**
     * Constructs an <code>NoSuchChannelException</code> with the specified
     * detail message.
     *
    ...
    /**
     * NoSuchChannelException constructor for a missing channel corresponding to
     * the specified node and handle.
     *
    ...
    /**
     * NoSuchChannelException constructor for a missing channel corresponding to
     * the specified powerSupply and handle.
     *
    ...
    /**
     * NoSuchChannelException constructor for a missing channel corresponding to
     * the specified timing center and handle.
     *
