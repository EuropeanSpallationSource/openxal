...
public class TimingCenter implements DataListener {
    ...
    public enum BEAM_MODE {
        ...
        MILSEC_1("1 mSec"),
        /**
         * We are at full throttle - the beam can be all long as other systems
         * allow
         */
        FULLPWR("Full Power");
        ...
        /**
         * Check whether or not the given string is lexically equivalent to the
         * PV value represented by this enumeration constant
         *
         * @param strPvVal
         *
         * @return  <code>true</code> if the given string is this beam mode
    ...
    /**
     * Get the default TimingCenter corresponding to the user's default main
     * optics source
     *
     * @return the default TimingCenter or null if no default has been specified
     * @throws xal.tools.ExceptionWrapper if an exception occurs while parsing
     * the data source
     */
     ...
     * @return The channel for the specified handle or null if there is no
     * match.
     */
     ...
     *
     * @param handle The handle to the desired channel stored in the channel
     * suite
     */
