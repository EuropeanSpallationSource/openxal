...
public class Accelerator extends AcceleratorSeq implements /* IElement, */ DataListener {
    ...
    protected void updatePowerSupplies(final DataAdaptor adaptor) {
        ...
        for (final DataAdaptor powerSupplyAdaptor : powerSupplyAdaptors) {
            ...
            if (powerSupplyType.equals("main")) {
                ...
                if (powerSupply == null) {
                    powerSupply = new MagnetMainSupply(this);
                }
                ...
                if (powerSupply == null) {
                    powerSupply = new MagnetTrimSupply(this);
                }
                powerSupply.update(powerSupplyAdaptor);
    ...
    /**
     * Programmatically add or replace a magnet main supply keyed by its ID. If
     * a power supply has the same ID as another power supply in this
     * accelerator then it will replace that one.
     *
     * @param mainSupply main power supply to add or replace
     * @throws IllegalArgumentException if the power supply's accelerator does
    ...
    /**
     * Programmatically add or replace a magnet trim supply keyed by its ID. If
     * a power supply has the same ID as another power supply in this
     * accelerator then it will replace that one.
     *
     ...
     *
     * @param comboAdaptor The data adaptor from which to generate the combo
     * sequence
     */
     ...
     *
     * @param comboType the type of combo sequence identifying the combo
     * sequence subclass
     ...
     *
     * @param channelFactory - the new ChannelFactory added by Juan
     */
     ...
     * @return the ring in this accelerator with the specified ID or null if
     * none exists
     */
    ...
    /**
     * Find a sequence with the specified ID. The sequence may either be a
     * direct child sequence or a predefined combo sequence.
     *
