 ...
 * </p>
 * <p>
 * Each algorithm will support the propagation of one type of simulation probe,
 * however, each probe class may accept multiple types of algorithms for its
 * propagation. It is the responsibility of the developer to create and use the
 * appropriate algorithm object for the given probe type.
 * </p>
 *
 * @see EditContext
 * @see IAlgorithm
...
public final class AlgorithmFactory {
 ...
 /*
    ...
    /**
     * <p>
     * Convenience method: Creates a new <code>SynchronousTracker</code>
     * instance by calling the class method
     * <code>{@link #createTrackerFor(AcceleratorSeq, Class)}</code> with the
     * returned class type.
     * </p>
     * <p>
     * The new algorithm instance is initialized with parameters specified in
     * the edit context of the given accelerator sequence object. The returned
     * <code>SynchronousTracker</code> algorithm will propagate a
     * <code>SynchronousProbe</code> object.
     * </p>
     *
     * @param smfSeq Accelerator sequence object indirectly containing the edit
     * context through its associated accelerator
     *
     * @return newly instantiated algorithm that was initialized from the given
     * accelerator sequence's edit context.
     *
     * @see xal.model.probe.EnvelopeProbe
     *
     * @throws InstantiationException unable to instantiate the object due to
     * constructor access violation or the class has no nullary constructor
     *
     * @author Christopher K. Allen
     * @since Oct 26, 2012
     */
    ...
    /**
     * <p>
     * Convenience method: Creates a new <code>ParticleTracker</code> instance
     ...
     * The new algorithm instance is initialized with parameters specified in
     * the edit context of the given accelerator sequence object. The returned
     * <code>ParticleTracker</code> algorithm will propagate a
     * <code>ParticleProbe</code> object.
     * </p>
     *
     * @param smfSeq Accelerator sequence object indirectly containing the edit
     * context through its associated accelerator
    ...
    /**
     * <p>
     * Convenience method: Creates a new <code>TransferMapTracker</code>
     * instance by calling the class method
     * <code>{@link #createTrackerFor(AcceleratorSeq, Class)}</code> with the
     * returned class type.
     * </p>
     ...
     * The new algorithm instance is initialized with parameters specified in
     * the edit context of the given accelerator sequence object. The returned
     * <code>TransferMapTracker</code> algorithm will propagate a
     * <code>TransferMapProbe</code> object.
     * </p>
     *
     * @param smfSeq Accelerator sequence object indirectly containing the edit
     * context through its associated accelerator
    ...
    /**
     * <p>
     * Convenience method: Creates a new <code>TwissTracker</code> instance by
     ...
     * The new algorithm instance is initialized with parameters specified in
     * the edit context of the given accelerator sequence object. The returned
     * <code>TwissTracker</code> algorithm will propagate a
     * <code>TwissProbe</code> object.
     * </p>
     *
     * @param smfSeq Accelerator sequence object indirectly containing the edit
     * context through its associated accelerator
    ...
    /**
     * <p>
     * Convenience method: Creates a new <code>TwissTrackerPmq</code> instance
     * by calling the class method
     * <code>{@link #createTrackerFor(AcceleratorSeq, Class)}</code> with the
     * returned class type.
     * </p>
     ...
     * The new algorithm instance is initialized with parameters specified in
     * the edit context of the given accelerator sequence object. The returned
     * <code>TwissTrackerPmq</code> algorithm will propagate a
     * <code>TwissProbe</code> object.
     * </p>
     *
     * @param smfSeq Accelerator sequence object indirectly containing the edit
    ...
    /**
     * <p>
     * Convenience method: Creates a new <code>Trace3dTracker</code> instance by
     * calling the class method
     * <code>{@link #createTrackerFor(AcceleratorSeq, Class)}</code> with the
     * returned class type.
     * </p>
     ...
     * The new algorithm instance is initialized with parameters specified in
     * the edit context of the given accelerator sequence object. The returned
     * <code>Trace3dTracker</code> algorithm will propagate an
     * <code>EnvelopeProbe</code> object.
     * </p>
     * <h3>NOTES:</h3>
     * <p>
     * &middot; The <code>Trace3dTracker</code> algorithm is all but deprecated.
     * Use of this method is discouraged except for benchmarking purposes.
     * </p>
     *
     * @param smfSeq Accelerator sequence object indirectly containing the edit
     * context through its associated accelerator
     ...
     *
     * @throws InstantiationException unable to instantiate the object due to
     * access violation or the class has no nullary constructor
     *
     * @author Christopher K. Allen
     * @since Oct 25, 2012
     */
    ...
    /**
     * <p>
     * Convenience method: Creates a new <code>EnvelopeTracker</code> instance
     * by calling the class method
     * <code>{@link #createTrackerFor(AcceleratorSeq, Class)}</code> with the
     * returned class type.
     * </p>
     ...
     * The new algorithm instance is initialized with parameters specified in
     * the edit context of the given accelerator sequence object. The returned
     * <code>EnvelopeTracker</code> algorithm will propagate an
     * <code>EnvelopeProbe</code> object.
     * </p>
     *
     * @param smfSeq Accelerator sequence object indirectly containing the edit
    ...
    /**
     * <p>
     * Convenience method: Creates a new <code>EnvelopeBacktracker</code>
     * instance by calling the class method
     * <code>{@link #createTrackerFor(AcceleratorSeq, Class)}</code> with the
     * returned class type.
     * </p>
     ...
     * The new algorithm instance is initialized with parameters specified in
     * the edit context of the given accelerator sequence object. The returned
     * <code>EnvelopeBacktracker</code> algorithm will propagate an
     * <code>EnvelopeProbe</code> object.
     * </p>
     *
     * @param smfSeq Accelerator sequence object indirectly containing the edit
    ...
    /**
     * <p>
     * Convenience method: Creates a new <code>EnvTrackerAdapt</code> instance
     * by calling the class method
     * <code>{@link #createTrackerFor(AcceleratorSeq, Class)}</code> with the
     * returned class type.
     * </p>
     ...
     * The new algorithm instance is initialized with parameters specified in
     * the edit context of the given accelerator sequence object. The returned
     * <code>EnvTrackerAdapt</code> algorithm will propagate an
     * <code>EnvelopeProbe</code> object.
     * </p>
     *
     * @param smfSeq Accelerator sequence object indirectly containing the edit
    ...
    /**
     * <p>
     * Convenience method: Creates a new <code>EnvelopeTrackerPmqDipole</code>
     * instance by calling the class method
     * <code>{@link #createTrackerFor(AcceleratorSeq, Class)}</code> with the
     * returned class type.
     * </p>
     ...
     * The new algorithm instance is initialized with parameters specified in
     * the edit context of the given accelerator sequence object. The returned
     * <code>EnvelopeTrackerPmq</code> algorithm will propagate an
     * <code>EnvelopeProbe</code> object.
     * </p>
     *
     * @param smfSeq Accelerator sequence object indirectly containing the edit
     ...
     * accelerator sequence's edit context.
     *
     * @throws InstantiationException unable to instantiate the tracker object
     * due to access violation or the class has no nullary constructor
     *
