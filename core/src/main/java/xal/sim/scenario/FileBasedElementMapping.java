 ...
 * &middot; The class no longer appears to be a singleton. You may create
 * multiple instances using the same or difference mapping definition files.
 * </p>
 *
 * @author Ivo List
 * @since Jan 27, 2014
...
public class FileBasedElementMapping extends ElementMapping {
     ...
     * <code>{@link xal.model.elem.Marker}</code> and the default sequence type
     * is set to <code>{@link xal.model.Sector}</code>
     * </p>
     *
    ...
    public static ElementMapping loadFrom(String urlModelConfig, String schemaUrl) {
        ...
        if (daCfg.hasAttribute("debug")) {
            mapHwToModElem.bolDebug = daCfg.booleanValue("debug");
        }
        if (daCfg.hasAttribute("divMags")) {
            mapHwToModElem.bolDivMags = daCfg.booleanValue("divMags");
        }
        if (daCfg.hasAttribute("subsectionCtrOrigin")) {
            mapHwToModElem.bolSubsectionCtrOrigin = daCfg.booleanValue("subsectionCtrOrigin");
        }
        ...
        try {
            ...
            if (daSeq == null) {
                throw new ClassNotFoundException("No sequence attribute in model configuration file.");
            }
        ...
        try {
            ...
            if (daCavDrift == null) {
                throw new ClassNotFoundException("No rfcavdrift element in model configuration file.");
            }
    ...
    /**
     * <p>
     * Returns the modeling element type for a hardware node used whenever no
     * specific (hardware,model) association has been defined.
     * </p>
     * <p>
     ...
     *
     * @see xal.sim.scenario.ElementMapping#createDefaultDrift(java.lang.String,
     * double)
     *
     * @author Christopher K. Allen
     * @since Dec 3, 2014
     ...
     *
     * @see
     * xal.sim.scenario.ElementMapping#createRfCavityDrift(java.lang.String,
