...
/**
 * <p>
 * This class is an extension of the <code>LatticeSequence</code> class needed
 * for generating modeling lattices from <code>AcceleratorSeqCombo</code>
 * hardware structures. We need an extra level of processing to account for the
 * fact that <code>AcceleratorSeqCombo</code> flattens out its constituent
 * sequence objects when requesting the accelerator nodes, that is, you must ask
 * for the constituent sequences explicitly.
 * </p>
 * <p>
 * Given a valid <code>ElementMapping</code> object,
 * <code>AcceleratorSeqCombo</code> object, and
 * <code>SynchronizationManager</code> for the online model, the
 * <code>LatticeSequenceCombo</code> will create an online model
 * <code>Lattice</code> object. This object is used by a
 * <code>ScenarioGenerator</code> to create a new <code>Scenario</code> object.
 * </p>
 * <p>
 * Thus, the actual "lattice generation" is done mostly in the
 * <code>LatticeSequence</code> class. The peripheral resources such as hardware
...
public class LatticeSequenceCombo extends LatticeSequence {
     ...
     * <code>LatticeSequenceCombo</code> object for the given accelerator combo
     * sequence under the assumption that that sequence is the top level (i.e.,
     * not a sub-sequence).
     * </p>
     *
     ...
     *
     * @see
     * xal.sim.scenario.LatticeSequence#createModelLattice(xal.sim.sync.SynchronizationManager)
     *
     * @since Jan 20, 2015 by Christopher K. Allen
     */
    @Override
