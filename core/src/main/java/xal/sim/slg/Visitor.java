 ...
 * interface and that have accepted to be visited. The implementer of Visitor
 * has to provide a visit() member function for each class (or type) that
 * implements VisitorListener. This gives the implementing class the possibility
 * to construct complex operations on a collection of VisitorListeners.
 *
