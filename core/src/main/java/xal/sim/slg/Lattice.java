...
/**
 * The lattice is a linear sequence of elements. Each element is associated with
 * one and only one XAL AcceleratorNode object.
 *
 * @author wdklotz
 */
public class Lattice implements Cloneable {
    ...
    /**
     * precision limit for position calculations
     */
    ...
    /**
     * Clone a lattice. The cloned lattice is a deep copied clone of the
     * original.
     */
    public Object clone() {
        try {
    ...
    /**
     * Concatenate two lattices. The resulting lattice will be a lattice with
     * right added to the end of left.
     *
     ...
     *
     * @return The forward dictionary that maps accelerator nodes to lattice
     * elements.
     */
    ...
    /**
     * Insert a thin element (length=0) into the lattice. Thick elements at the
     * same position will be sliced accordingly.
     */
