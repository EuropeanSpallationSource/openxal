...
public abstract class RBACLogin {
     ...
     * the Token if authentication was successful or throws a
     * {@link AccessDeniedException} if authentication failed.
     *
    ...
    /**
     * Authenticates the user using username, password and preferred role. The
     * method returns the Token if authentication was successful or throws a
     * {@link AccessDeniedException} if authentication failed.
     *
     * @param username that will be used for authentication.
     * @param password that will be used for authentication.
    ...
    /**
     * Authenticates the user using username and password, preferred role and
     * ip. The method returns the Token if authentication was successful or
     * throws a {@link AccessDeniedException} if authentication failed.
     *
     * @param username that will be used for authentication.
     * @param password that will be used for authentication.
     * @param preferredRole the user would prefer to have.
    ...
    /**
     * Instantiate a new RBACLogin by calling
     * xal.extensions.application.rbac.RBACPlugin.getRBACLoginInstance()
     *
