...
public class ElementTreeCell<T> extends TreeCell<T> {
    ...
    protected final Label classNameInfoLabel = new Label();
    protected final Label displayInfoLabel = new Label();
    protected final HBox graphic = new HBox();
    protected final HBox iconBox = new HBox();
    protected final Label iconsLabel = new Label();
