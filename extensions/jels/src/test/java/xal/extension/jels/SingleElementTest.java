...
public abstract class SingleElementTest extends TestCommon {
    ...
    public static class SingleElementTestData {
        ...
        public String toString() {
            ...
            String params = I == 0. ? String.format(Locale.ROOT, "E=%.2E", probe.getKineticEnergy())
                    : String.format(Locale.ROOT, "E=%.2E, I=%.2E", probe.getKineticEnergy(), ((EnvelopeProbe) probe).getBeamCurrent());
            if (description != null) {
