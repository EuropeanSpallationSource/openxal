...
//                    new double[]{1.458045E+01, 1.039017E+01, 7.424592E+00}, errTolerance); // when halfMag=true
            ...
            checkTWTransferMatrix(new double[][]{
                ...
                {+0.000000e+00, +0.000000e+00, +1.890399e-01, +1.722575e-01, +1.000000e+00, +1.230074e-01,},
        ...
        if (initialEnergy == 2.5e9) {
            ...
            checkTWResults(3.664472480, new double[][]{
                {+8.676998e-07, +4.724759e-07, +0.000000e+00, +0.000000e+00, +0.000000e+00, +0.000000e+00,},
                {+4.724759e-07, +2.613519e-07, +0.000000e+00, +0.000000e+00, +0.000000e+00, +0.000000e+00,},
                {+0.000000e+00, +0.000000e+00, +6.637309e-07, +3.519620e-07, +2.359123e-08, -2.755347e-07,},
                {+0.000000e+00, +0.000000e+00, +3.519620e-07, +2.087888e-07, -1.470196e-08, -3.023791e-07,},
                {+0.000000e+00, +0.000000e+00, +2.359123e-08, -1.470196e-08, +4.693527e-08, +2.394806e-07,},
                {+0.000000e+00, +0.000000e+00, -2.755347e-07, -3.023791e-07, +2.394806e-07, +1.599552e-06,},}, errTolerance);
        }
    }
...
//                    new double[]{1.434713E+01, 1.061625E+01, 7.424592E+00}, errTolerance);
        ...
        if (initialEnergy == 2.5e9) {
            checkTWTransferMatrix(new double[][]{
                ...
                {+0.000000e+00, +0.000000e+00, +1.018958e+00, +1.799999e+00, +0.000000e+00, +0.000000e+00,},
                {+0.000000e+00, +0.000000e+00, +2.126416e-02, +1.018958e+00, +0.000000e+00, +0.000000e+00,},
                {+1.890399e-01, +1.722575e-01, +0.000000e+00, +0.000000e+00, +1.000000e+00, +1.230074e-01,},
                {+0.000000e+00, +0.000000e+00, +0.000000e+00, +0.000000e+00, +0.000000e+00, +1.000000e+00,},}, errTolerance);

            checkTWResults(3.664472480, new double[][]{
                {+9.012775e-07, +4.935008e-07, +0.000000e+00, +0.000000e+00, +4.411589e-08, -2.755347e-07,},
                {+4.935008e-07, +2.895163e-07, +0.000000e+00, +0.000000e+00, -1.851370e-09, -3.023791e-07,},
                {+0.000000e+00, +0.000000e+00, +6.296777e-07, +3.238510e-07, +0.000000e+00, +0.000000e+00,},
                {+0.000000e+00, +0.000000e+00, +3.238510e-07, +1.721475e-07, +0.000000e+00, +0.000000e+00,},
                {+4.411589e-08, -1.851370e-09, +0.000000e+00, +0.000000e+00, +4.860164e-08, +2.394806e-07,},
                {-2.755347e-07, -3.023791e-07, +0.000000e+00, +0.000000e+00, +2.394806e-07, +1.599552e-06,},}, errTolerance);
        }
    }
...
//                    new double[]{1.434713E+01, 1.061625E+01, 7.424592E+00}, errTolerance);
        ...
        if (initialEnergy == 2.5e9) {
            checkTWTransferMatrix(new double[][]{
                ...
                {+0.000000e+00, +0.000000e+00, +1.015251e+00, +1.797789e+00, +0.000000e+00, +0.000000e+00,},
                {+0.000000e+00, +0.000000e+00, +1.709594e-02, +1.015251e+00, +0.000000e+00, +0.000000e+00,},
                {+1.892739e-01, +1.723634e-01, +0.000000e+00, +0.000000e+00, +1.000000e+00, +1.230033e-01,},
                {+0.000000e+00, +0.000000e+00, +0.000000e+00, +0.000000e+00, +0.000000e+00, +1.000000e+00,},}, errTolerance);

            checkTWResults(3.664472480, new double[][]{
                {+9.036025e-07, +4.959717e-07, +0.000000e+00, +0.000000e+00, +4.426445e-08, -2.757041e-07,},
                {+4.959717e-07, +2.914978e-07, +0.000000e+00, +0.000000e+00, -1.695229e-09, -3.027534e-07,},
                {+0.000000e+00, +0.000000e+00, +6.278442e-07, +3.219878e-07, +0.000000e+00, +0.000000e+00,},
                {+0.000000e+00, +0.000000e+00, +3.219878e-07, +1.707336e-07, +0.000000e+00, +0.000000e+00,},
                {+4.426445e-08, -1.695229e-09, +0.000000e+00, +0.000000e+00, +4.861141e-08, +2.394741e-07,},
                {-2.757041e-07, -3.027534e-07, +0.000000e+00, +0.000000e+00, +2.394741e-07, +1.599552e-06,},}, errTolerance);
        }
    }
    ...
    public void doVerticalBendTest2() throws InstantiationException, ModelException {
        ...
        if (initialEnergy == 2.5e9) {
            checkTWTransferMatrix(new double[][]{
                ...
                {+0.000000e+00, +0.000000e+00, +9.796828e-01, +1.798894e+00, +0.000000e+00, -1.727345e-01,},
                {+0.000000e+00, +0.000000e+00, -2.235906e-02, +9.796828e-01, +0.000000e+00, -1.900943e-01,},
                {+0.000000e+00, +0.000000e+00, +1.900943e-01, +1.727345e-01, +1.000000e+00, +1.229891e-01,},
                {+0.000000e+00, +0.000000e+00, +0.000000e+00, +0.000000e+00, +0.000000e+00, +1.000000e+00,},}, errTolerance);

            checkTWResults(3.664472480, new double[][]{
                {+8.574107e-07, +4.614619e-07, +0.000000e+00, +0.000000e+00, +0.000000e+00, +0.000000e+00,},
                {+4.614619e-07, +2.524912e-07, +0.000000e+00, +0.000000e+00, +0.000000e+00, +0.000000e+00,},
                {+0.000000e+00, +0.000000e+00, +6.721324e-07, +3.604805e-07, +2.413964e-08, -2.762977e-07,},
                {+0.000000e+00, +0.000000e+00, +3.604805e-07, +2.153205e-07, -1.418630e-08, -3.040656e-07,},
                {+0.000000e+00, +0.000000e+00, +2.413964e-08, -1.418630e-08, +4.697355e-08, +2.394513e-07,},
                {+0.000000e+00, +0.000000e+00, -2.762977e-07, -3.040656e-07, +2.394513e-07, +1.599552e-06,},}, errTolerance);
        }
    }
