        ...
        tests.add(new Object[]{new SingleElementTestData() {
            {
                ...
                TWGamma = 1.003197291;
                TWCorrelationMatrix = new double[][]{
                    {+5.606844e-07, -1.476716e-06, +0.000000e+00, +0.000000e+00, +0.000000e+00, +0.000000e+00},
                    {-1.476716e-06, +1.614641e-05, +0.000000e+00, +0.000000e+00, +0.000000e+00, +0.000000e+00},
                    {+0.000000e+00, +0.000000e+00, +1.583302e-06, +7.733000e-06, +0.000000e+00, +0.000000e+00},
                    {+0.000000e+00, +0.000000e+00, +7.733000e-06, +4.208032e-05, +0.000000e+00, +0.000000e+00},
                    {+0.000000e+00, +0.000000e+00, +0.000000e+00, +0.000000e+00, +3.361266e-06, +2.249328e-06},
                    {+0.000000e+00, +0.000000e+00, +0.000000e+00, +0.000000e+00, +2.249328e-06, +5.280827e-06},};
        ...
        tests.add(new Object[]{new SingleElementTestData() {
            {
                ...
                CMerrTolerance = 2e-5;
                TWCorrelationMatrix = new double[][]{
                    {+1.712016e-08, +2.638128e-08, +0.000000e+00, +0.000000e+00, +0.000000e+00, +0.000000e+00},
                    {+2.638128e-08, +2.475260e-07, +0.000000e+00, +0.000000e+00, +0.000000e+00, +0.000000e+00},
                    {+0.000000e+00, +0.000000e+00, +2.725861e-08, +3.354165e-08, +0.000000e+00, +0.000000e+00},
                    {+0.000000e+00, +0.000000e+00, +3.354165e-08, +1.703375e-07, +0.000000e+00, +0.000000e+00},
                    {+0.000000e+00, +0.000000e+00, +0.000000e+00, +0.000000e+00, +5.719022e-09, +5.106308e-08},
                    {+0.000000e+00, +0.000000e+00, +0.000000e+00, +0.000000e+00, +5.106308e-08, +1.599526e-06},};
            }
        }});
        ...
        tests.add(new Object[]{new SingleElementTestData() {
            {
                ...
                probe = setupOpenXALProbe(3e6, frequency, 30.0e-3);
                elementMapping = JElsElementMapping.getInstance();
                sequence = quad(70., -16., 15., 0., 0., 0., 0., 0.);
        ...
        tests.add(new Object[]{new SingleElementTestData() {
            {
                ...
                probe = setupOpenXALProbe(20e9, frequency, 30.0e-3);
                elementMapping = JElsElementMapping.getInstance();
                sequence = quad(5000., -16., 15., 0., 0., 0., 0., 0.);
        ...
        tests.add(new Object[]{new SingleElementTestData() {
            {
                ...
                TWGamma = 1.003197291;
                TWCorrelationMatrix = new double[][]{
                    {+1.001439e-06, +5.226533e-06, +9.686578e-09, +1.089479e-07, +0.000000e+00, +0.000000e+00},
                    {+5.226533e-06, +3.415808e-05, +1.741208e-07, +7.520650e-08, +0.000000e+00, +0.000000e+00},
                    {+9.686578e-09, +1.741208e-07, +8.735915e-07, -2.950460e-06, +0.000000e+00, +0.000000e+00},
                    {+1.089479e-07, +7.520650e-08, -2.950460e-06, +1.780010e-05, +0.000000e+00, +0.000000e+00},
                    {+0.000000e+00, +0.000000e+00, +0.000000e+00, +0.000000e+00, +3.361266e-06, +2.249328e-06},
                    {+0.000000e+00, +0.000000e+00, +0.000000e+00, +0.000000e+00, +2.249328e-06, +5.280827e-06},};
            }
        }});
        ...
        tests.add(new Object[]{new SingleElementTestData() {
            {
                ...
                TWGamma = 1.003197291;
                TWCorrelationMatrix = new double[][]{
                    {+9.985181e-07, +5.186108e-06, +4.822285e-08, +5.428292e-07, +0.000000e+00, +0.000000e+00},
                    {+5.186108e-06, +3.427046e-05, +8.671076e-07, +3.955276e-07, +0.000000e+00, +0.000000e+00},
                    {+4.822285e-08, +8.671076e-07, +8.784742e-07, -2.881004e-06, +0.000000e+00, +0.000000e+00},
                    {+5.428292e-07, +3.955276e-07, -2.881004e-06, +1.773345e-05, +0.000000e+00, +0.000000e+00},
                    {+0.000000e+00, +0.000000e+00, +0.000000e+00, +0.000000e+00, +3.361266e-06, +2.249328e-06},
                    {+0.000000e+00, +0.000000e+00, +0.000000e+00, +0.000000e+00, +2.249328e-06, +5.280827e-06},};
                TWMean = new double[]{
