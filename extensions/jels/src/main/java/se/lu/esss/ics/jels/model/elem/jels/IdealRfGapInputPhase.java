 ...
 * 
 * <p>
 * This is a modification of IdealRFGap that allows instantiation
 *  </p>
 * 
 *  <p>
 *
 ...
 */
public class IdealRfGapInputPhase extends ThinElement implements IRfGap {
    ...
    */
     ...
     */
    public IdealRfGapInputPhase(String strId, double dblETL, double dblPhase, double dblFreq) {
    ...
    */   
    ...
    protected PhaseMap transferMap(IProbe probe) throws ModelException {
    	...
    	double Phis;
    	if (isFirstGap()) {
    		setPhase(TTFFit.getSyncPhase(getInputPhase(), probe.getBeta()));
    		Phis = getPhase();
    	}
    	else {    		 
    	...
    	{        	
    		...
    		if (TTFFit.getCoef(0)!=0)
    		{
    			...
    			double E0TL_scaled=E0TL*TTFFit.evaluateAt(getInputPhase()-Phis,beta_middle);
    			double kToverT =-beta_middle*TTFFit.evaluateDerivativeAt(getInputPhase()-Phis, beta_middle)/
    					TTFFit.evaluateAt(getInputPhase()-Phis, beta_middle);
    		...
    		{   
    			...
    			System.out.printf("%s %E %E %E\n", getId(), E0TL, Phis*180/Math.PI, energyGain);
    			gamma_end=gamma_start+energyGain/mass;    			
    			beta_end = computeBetaFromGamma(gamma_end);
	...
	public double getInputPhase() {
		return inputPhase;
	}

	public void setInputPhase(double inputPhase) {
