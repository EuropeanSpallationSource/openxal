 ...
 */
public class IdealRfGap2 extends ThinElement implements IRfGap {    
	/*
	 *  Global Constants
	 */
	/**
    ...
    */
     ...
     */
    public IdealRfGap2(String strId, double dblETL, double dblPhase, double dblFreq) {
    ...
    protected PhaseMap transferMap(IProbe probe) throws ModelException {
    	...
    	{        	
    		...
    		if (TTFFit.getCoef(0)!=0)
    		{
    			...
    			// NOTE: This is a possible alternative for calculation of kToverT. 
    			//kToverT =-2*Math.PI/lambda*beta_middle*beta_middle*TTFFit.evaluateDerivativeAt(beta_middle)/TTFFit.evaluateAt(beta_middle);
    		...
    		//account for only delta p/p     		
			kz=kz*gamma_avg*gamma_avg; // not late
