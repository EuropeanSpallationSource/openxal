...
public class Matcher implements Runnable, Stopper {
    ...
    public void run() {
        ...
        try {
            ...
            LOGGER.log(Level.SEVERE, "Error while running the matcher.", e);
        }
        ...
        if (outputInitialRun != null) {
            evaluator.printSolution(outputInitialRun, problem.generateInitialTrialPoint());
        }
        ...
        if (outputBestRun != null) {
            ...
            try {
                ...
                LOGGER.log(Level.SEVERE, "File encoding not supported.", e);
            }
        }
