...
public class ElogUtility {
	 ...
	 * @throws DatabaseException if an exception occurs while connecting to the database
	 */
	 ...
	 * @throws DatabaseException if a database exception occurs while posting an entry
	 */
