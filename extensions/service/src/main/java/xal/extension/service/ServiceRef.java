...
public class ServiceRef {
     ...
     *
     * @param other The other service reference against which to compare this
     * one.
     * @return true if the other service reference refers to the same service
     * provider as the this instance and false otherwise.
     */
    @Override
    ...
    /**
     * Internally used to strip the communication protocol and DNS address from
     * the full type name.
     *
    ...
    /**
     * Internally used to strip the type information from the name to get just
     * the base name.
     *
     * @param fullName The full rendezvous name (e.g.
     * "Mary.greeting._tcp._local.")
     * @param fullType The full rendezvous type (e.g. "greeting._tcp._local.")
    ...
    /**
     * Internally used to construct the full bonjour type from the simple base
     * type.
     *
