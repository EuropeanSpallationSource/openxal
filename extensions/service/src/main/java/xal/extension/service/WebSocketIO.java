...
/**
 * Utility for processing messages passed through sockets on top of the
 * WebSocket protocol
 */
class WebSocketIO {
    ...
    /**
     * key with which to encode the web socket header key for completing the
     * handshake
     */
    ...
    /**
     * Initiate the handshake (from the client) passing a random value for the
