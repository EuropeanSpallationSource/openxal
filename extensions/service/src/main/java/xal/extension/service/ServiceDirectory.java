...
public final class ServiceDirectory {
    ...
    /**
     * flag indicating bonjour is in loopback mode (i.e. workstation is
     * disconnected from network)
     */
    private boolean isLoopback;

    /**
     * Table mapping ServiceListener to the corresponding bonjour service
     * listener
     */
    ...
    /**
     * Check if service support is active. If initialization fails, then
     * services will not be active.
     *
    ...
    /**
     * Determine if bonjour is running in loopback mode which would indicate
     * that the computer is isolated from the network. This flag is meaningful
     * only if the service directory is active.
     *
     * @return true if the service is running in loopback mode and false if it
     * is on a network
     */
    ...
    /**
     * Get a list of standard data types which are supported for coding and
     * decoding
     */
    ...
    /**
     * Register the custom type and its associated adaptor to use for encoding
     * and decoding objects of the custom type
     *
     ...
     * @return A proxy implementing the specified protocol for the specified
     * service reference
     */
    ...
    /**
     * Lookup the service given the fully qualified service type and the fully
    ...
    /**
     * Lookup the service given the fully qualified service type and the fully
     * qualified service name and block until a match is found or the specified
     * timeout has expired.
     *
     * @param type The fully qualified service type
     * @param name The fully qualified service name
     * @param timeout The timeout in milliseconds to block until a match is
     * found
     * @return the matching service reference or null if no match is found
     */
    ...
    /**
     * Convenience method for making a request to find service providers of a
     * specific service type and waiting a specified amount of time to find
     * those services. It is more preferable, however, to use the
     * "addServiceListener()" method instead so as to monitor the availability
     * of services. Convenience method used when the type is derived from the
     * protocol's name.
     *
     * @param protocol The protocol identifying the service type for which to
     * find providers.
     * @param timeout Time to block in milliseconds while waiting for services
     * to be discovered.
     * @return An array of services which were found within the specified
     * timeout
    ...
    /**
     * Add a listener for addition and removal of service providers. Convenience
     * method used when the type is derived from the protocol's name.
     *
     * @param protocol The protocol identifying the service type.
    ...
    public void addServiceListener(final String type, final ServiceListener listener) throws ServiceException {
        try {
            ...
            bonjour.addServiceListener(bonjourType, new javax.jmdns.ServiceListener() {
                ...
                /**
                 * A service is resolved. Its details are now available in the
                 * ServiceInfo record.
                 *
                 * @param type the fully qualified type of the service
                 * @param name the fully qualified name of the service
                 * @param info the service info record, or null if the service
    ...
    /**
     * Form a valid type based on the specified protocol by replacing the
     * protocol's name with a valid name in which "." is replaced by "_".
     *
