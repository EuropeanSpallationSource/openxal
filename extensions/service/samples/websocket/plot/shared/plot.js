...
PlotDataSource.prototype.pointCount = function () {
    return 0;
}
PlotDataSource.prototype.getX = function (index) {
    return 0;
}
PlotDataSource.prototype.getY = function (index) {
    return 0;
}
...
WaveformPlotDataSource.prototype.setWaveform = function (waveform) {
    this.waveform = waveform;
}
WaveformPlotDataSource.prototype.getWaveform = function () {
    return this.waveform;
}
WaveformPlotDataSource.prototype.pointCount = function () {
    return this.waveform.length;
}
WaveformPlotDataSource.prototype.getX = function (index) {
    return index;
}
WaveformPlotDataSource.prototype.getY = function (index) {
...
XYPlotDataSource.prototype.pointCount = function () {
    return this.points.length;
}
XYPlotDataSource.prototype.getX = function (index) {
    return this.points[index].x;
}
XYPlotDataSource.prototype.getY = function (index) {
...
PlotSeries.prototype.getLineWidth = function () {
    return this.lineWidth;
}
PlotSeries.prototype.setLineWidth = function (width) {
    this.lineWidth = width;
}
PlotSeries.prototype.getPointWidth = function () {
    return this.pointWidth;
}
PlotSeries.prototype.setPointWidth = function (width) {
    this.pointWidth = width;
}
PlotSeries.prototype.getPointColor = function () {
    return this.pointColor;
}
PlotSeries.prototype.setPointColor = function (color) {
    this.pointColor = color;
}
PlotSeries.prototype.getLineColor = function () {
    return this.lineColor;
}
PlotSeries.prototype.setLineColor = function (color) {
    this.lineColor = color;
}
...
AxisOrientationAdaptor.prototype.getMajorTicks = function (grid) {
    return 4;
}
AxisOrientationAdaptor.prototype.setMajorTicks = function (count, grid) {}
AxisOrientationAdaptor.prototype.getTickLabelMaxWidth = function (axis) {
    return 0.0;
}
AxisOrientationAdaptor.prototype.getTickLabelEdge = function (axis) {
    return 0.0;
}
AxisOrientationAdaptor.prototype.drawTickLabel = function (context, label, position, edge, maxWidth) {}
AxisOrientationAdaptor.prototype.defaultLabel = function () {
    return "";
}
...
LeftAxisAdaptor.prototype.getMajorTicks = function (grid) {
    return grid.yMajorTicks;
}
LeftAxisAdaptor.prototype.setMajorTicks = function (count, grid) {
    grid.yMajorTicks = count;
}
LeftAxisAdaptor.prototype.getTickLabelMaxWidth = function (axis) {
    return axis.canvas.width / 2;
}
LeftAxisAdaptor.prototype.getTickLabelEdge = function (axis) {
    return axis.canvas.width;
}
...
LeftAxisAdaptor.prototype.defaultLabel = function () {
    return "Vertical";
}
...
BottomAxisAdaptor.prototype.getMajorTicks = function (grid) {
    return grid.xMajorTicks;
}
BottomAxisAdaptor.prototype.setMajorTicks = function (count, grid) {
    grid.xMajorTicks = count;
}
BottomAxisAdaptor.prototype.getTickLabelMaxWidth = function (axis) {
    return axis.canvas.width / (2 * axis.grid.xMajorTicks);
}
BottomAxisAdaptor.prototype.getTickLabelEdge = function (axis) {
    return 0;
}
...
BottomAxisAdaptor.prototype.defaultLabel = function () {
    return "Horizontal";
}
...
// get the lower limit
GraphAxis.prototype.getLowerLimit = function () {
    return this._lowerLimit;
}


// get the upper limit
GraphAxis.prototype.getUpperLimit = function () {
...
// get the height
GraphAxis.prototype.getLength = function () {
    return this._length;
}
...
// set the height
GraphGrid.prototype.__defineSetter__("height", function (height) {
...
// get the height
GraphGrid.prototype.__defineGetter__("height", function () {
    return this._height;
});


// set the width
GraphGrid.prototype.__defineSetter__("width", function (width) {
    this.setWidth(width);
});
...
// get the width
GraphGrid.prototype.__defineGetter__("width", function () {
    return this._width;
});
...
// set the height
Graph.prototype.__defineSetter__("height", function (height) {
    this.setHeight(height);
});
...
// get the height
Graph.prototype.__defineGetter__("height", function () {
    return this._height;
});
...
// set the width
Graph.prototype.__defineSetter__("width", function (width) {
    this.setWidth(width);
});
...
// get the width
Graph.prototype.__defineGetter__("width", function () {
    return this._width;
});
