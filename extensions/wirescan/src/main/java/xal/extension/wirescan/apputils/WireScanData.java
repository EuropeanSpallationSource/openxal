...
public class WireScanData {
    ...
    /**
     * Returns a reference to the BasicGraphData instance with the raw waveform
     * for X-direction
     */
    ...
    /**
     * Returns a reference to the BasicGraphData instance with the log of raw
     * waveform for X-direction
     */
    ...
    /**
     * Returns a reference to the BasicGraphData instance with the fitting
     * waveform for X-direction
     */
    ...
    /**
     * Returns a reference to the BasicGraphData instance with the log of
     * fitting waveform for X-direction
     */
    ...
    /**
     * Returns a reference to the BasicGraphData instance with the log of
     * fitting waveform for Y-direction
     */
    ...
    /**
     * Returns the position of the center parameter of the Gaussian fit for
     * X-direction
     */
    ...
    /**
     * Sets the position of the center parameter of the Gaussian fit for
     * Y-direction
     */
