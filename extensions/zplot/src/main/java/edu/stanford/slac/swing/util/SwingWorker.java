 ...
 */
/**
 * t.setPriority(t.MAX_PRIORITY); threadVar = new ThreadVar(t); }
 *
 * /**
...
*/public abstract class SwingWorker {
    ...
    /**
     * see getValue(), setValue() public Thread thread;
     *
     * /**
    ...
    public Object get() {
        while (true) {
            ...
            try {
                ...
                Thread.currentThread().interrupt();  */private Object value;
package edu.stanford.slac.swing.util;
