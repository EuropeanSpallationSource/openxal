 ...
 * @version %I%, %G%
 * @since This class extends Device in order to provide a different tooltip for
 * the alarmed magnet devices
 */
...
public class AlarmMagnet extends Device {
     ...
     * @param bact = MagnetBactRecord whose toString() method is overwritten to
     * provide the magnet's bact value
     * @param statusMessage = MagnetStatMsgRecord whose toString() method is
     * overwritten to provide STATMSG string
     */
