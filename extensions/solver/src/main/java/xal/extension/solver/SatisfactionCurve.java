...
public class SatisfactionCurve {
    ...
    /**
     * Generate a satisfaction based on an inverse square function 1 - a / ( a +
     * x^2 )
     *
     * @param value the value to test
     * @param tolerance the tolerance corresponding to 90% satisfaction
    ...
    /**
     * Generate a satisfaction based on an S-Curve that extends from negative to
     * positive infinity satisfaction = 1/2 + a ( x - x0 ) / ( 1 + 2a|x - x0| )
     *
     * @param value the value to test
    ...
    /**
     * Generate a linear satisfaction curve which has zero at the bottom end and
     * 1 at the top end
     *
     * @param value the value to test
    ...
    /**
     * Generate a satisfaction curve which accelerates and ends with the
     * specified slope
     *
     * @param value the value to test
     * @param minValue the minimum value
    ...
    /**
     * Generate a satisfaction curve which decelerates and begins with the
     * specified slope
     *
     * @param value the value to test
     * @param minValue the minimum value
