...
public class AlgorithmMarket implements AlgorithmScheduleListener, SolutionJudgeListener {
    ...
    /**
     * the list of algorithms in the market sorted by efficiency so the most
     * efficient algorithms appear first
     */
     ...
     * Constructor
     *
     * @param algorithm the only algorithm to use which also implies the single
     * algorithm
     */
    ...
    /**
     * Constructor using the default algorithm pool and the default algorithms
     * List.
     */
     ...
     *
     * @param listener the listener to remove from receiving algorithm market
     * events
     */
    ...
    /**
     * Get the next algorithm to execute by sorting algorithms by efficiency and
     * then picking a algorithm randomly but weighted by the probability ratio
     * for each successive algorithm.
     *
