...
public class ParetoOptimalJudge extends SolutionJudge {
    ...
    /**
     * Test to see if the first solution/trial is better than the second
     * solution/trial for the specified objective. Return true if the first
     * objective's satisfaction is better than the second objective's
     * satisfaction.
     *
     ...
     * Judge the trial.
     *
     * @param solution The new solution to update the pareto optimal judge with.
     */
    @Override
