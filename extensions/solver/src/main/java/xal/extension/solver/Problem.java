...
public class Problem {
    ...
    /**
     * Construct a problem using an objective list, variable list, constraint
     * list, hint list, and an evaluator.
     */
    ...
    /**
     * Construct a problem using an objective list, variable list, and an
     * evaluator.
     */
    ...
    /**
     * Set the evaluator to use in scoring the trial points. The evaluator
     * defines the problem we are trying to optimize.
     *
    ...
    /**
     * Generate a trial for the initial variable values without any associated
     * algorithm
     *
     ...
     * @return A trial veto if any of the constraints vetoes the trial or null
     * if there is no veto.
     */
    ...
    /**
     * Evaluate the initial point as specified by the initial values of the
     * variables
     *
