...
public final class ScoreBoard implements AlgorithmScheduleListener, SolutionJudgeListener {
    ...
    /**
     * number of algorithm run executions (note that one run can correspond to
     * many evaluations)
     */
    ...
    /**
     * HashMap for containing the algorithms and the amount of evaluations that
     * each one completes
     */
    private Map<String, Integer> evaluationsLog = new HashMap<>();

    /**
     * this is for recording the efficiency of the algorithms over a set amount
     * of evaluations
     */
    ...
    /**
     * Add the specified listener as a receiver of ScoreBoard events from this
     * instance.
     */
    ...
    /**
     * Remove the specified listener from receiving ScoreBoard events from this
     * instance.
     */
    ...
    /**
     * class for recording the efficiency for each algorithm averaged over a set
     * amount of time Also records the averaged distribution of evaluations
     * among algorithms
     *
     * The record method is based on evaluations. Default is to average and
     * record every 1000 evaluations
     */
