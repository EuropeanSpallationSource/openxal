...
public class RandomShrinkSearch extends SearchAlgorithm {
     ...
     *
     * This is for operating this algorithm completely independently of any
     * other algorithm
     */
    @Override
    ...
    /**
     * This is going to keep track of its own solutions. Basically it will run
     * alongside other programs if the option is chosen, but it will not changed
    ...
    protected class RandomSearcher implements Searcher {
        ...
        /**
         * Get the next trial point given the expected number of variables to
         * change. Randomly pick the number of variables to vary by weighing it
         * based on the average number we expect to vary. If no variables get
         * selected to change then we pick the number of variables to change
         * randomly from 1 to the total number of variables available. For each
         * variable that was selected to change, we randomly select a value
         * within the target domain for the variable.
         *
         * @param expectedNumToChange The average number of variables that we
         * expect to change.
         * @return the next trial point.
         */
        ...
        /**
         * Propose a new value for the variable by selecting a random value in
         * the variable's search range.
         *
    ...
    protected class ShrinkSearcher extends RandomSearcher {
        ...
        /**
         * Build the new bounds based upon the user specified domain and the
         * search algorithm's search space per variable. The search windows
         * become the intersection of the user specified search domain and the
        ...
        /**
         * Propose a new value for the variable by selecting a random value from
         * the variable's shrunken search space.
         *
         * @param variable the variable for which to propose a new value
         * @return the new value to propose for the variable
         */
    ...
    public class ComboSearcher extends RandomSearcher {
        ...
        /**
         * Propose a new value for the variable by picking a search engine to
         * propose a new value.
         *
         * @param variable the variable for which to propose a new value
         * @return the new value to propose for the variable
...
/**
 * Search window for a variable. Specifies upper and lower limits of the search
