...
public class ProblemFactory {
    ...
    /**
     * Generate a problem which seeks to minimize the score which is in a range
     * of zero to infinity
     *
    ...
    /**
     * Generate a problem which seeks to maximize the score which is in a range
     * of zero to infinity
     *
     * @param variables the variables
     * @param scorer the scorer
    ...
    /**
     * Generate a problem which uses an S-curve satisfaction curve over the
     * range of negative infinity to positive infinity with center at zero
     *
     * @param variables the variables
     * @param scorer the scorer
    ...
    /**
     * Generate a problem which uses an S-curve satisfaction curve over the
     * range of negative infinity to positive infinity
     *
     * @param variables the variables
     * @param scorer the scorer
    ...
    /**
     * Generate a problem which uses a linear rising satisfaction curve over the
    ...
    /**
     * Generate a problem which uses a linear falling satisfaction curve over
    ...
    /**
     * Generate a problem which uses an accelerating satisfaction curve over the
     * specified score range
     *
     * @param variables the variables
     * @param scorer the scorer
    ...
    /**
     * Generate a problem which uses a decelerating satisfaction curve over the
     * specified score range
     *
     * @param variables the variables
     * @param scorer the scorer
     * @param minScore the minimum score
     * @param maxScore the maximum score
     * @param startSlope the slope of the satisfaction curve at the minimum
     * score
     */
    ...
    /**
     * Generate an evaluator which takes the score from the scorer and feeds it
    ...
    /**
     * Generate an objective which uses a linear rising satisfaction curve over
     * the specified score range
     *
     * @param minScore the minimum score
     * @param maxScore the maximum score
    ...
    private static Objective getLinearRisingObjective(final double minScore, final double maxScore) {
        return new Objective("Rising Linear") {
            /**
             * Determines how satisfied the user is with the specified value for
             * this objective.
             *
             * @param value The value associated with this objective for a
             * particular trial
    ...
    /**
     * Generate an objective which uses a linear falling satisfaction curve over
     * the specified score range
     *
     * @param minScore the minimum score
     * @param maxScore the maximum score
    ...
    /**
     * Generate an objective which uses an accelerating satisfaction curve over
     * the specified score range
     *
     * @param minScore the minimum score
     * @param maxScore the maximum score
    ...
    /**
     * Generate an objective which uses a decelerating satisfaction curve over
     * the specified score range
     *
     * @param minScore the minimum score
     * @param maxScore the maximum score
    ...
    /**
     * Generate an objective which uses an S-Curve satisfaction curve with the
     * specified center and slope
     *
     * @param center the center value of the satisfaction curve
     * @param slope the slope of the satisfaction curve at the center
     */
    ...
    /**
     * Generate an objective which uses an inverse square satisfaction curve
    ...
    /**
     * Generate an objective which uses an inverse square rising satisfaction
     * curve with the specified tolerance
     *
     * @param tolerance the score corresponding to 90% satisfaction
     */
