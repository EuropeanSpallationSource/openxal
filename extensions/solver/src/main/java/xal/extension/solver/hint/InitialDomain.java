...
public class InitialDomain extends DomainHint {
    ...
    /**
     * Simple range constructor with the specified range limits for each
     * variable
     */
    ...
    /**
     * Get an initial domain hint whose range for each variable is the specified
     * fraction of the variable's limits.
     */
     ...
     * hint in a table of hints. Subclasses should override this method to
     * return a unique string identifying the hint.
     *
