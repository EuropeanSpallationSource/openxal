...
public class Variable {
     ...
     *
     * @param initialValue the initial first guess for the variable (e.g.
     * starting point)
     * @param name the name to assign to the variable
     * @param lowerLimit the lowest value that should be assigned to the
     * variable
     * @param upperLimit the highest value that should be assigned to the
     * variable
     */
    ...
    /**
     * Copy this variable but substitute the specified initial value for this
     * variable's initial value.
     *
     * @param initialValue initial value to use for the new variable
     * @return new variable with the same properties as this instance but
     * substituting the specified initial value
     */
    ...
    /**
     * A string for displaying a variable. The string consist of a title, an
     * initial value, a lower limit and an upper limit.
     *
