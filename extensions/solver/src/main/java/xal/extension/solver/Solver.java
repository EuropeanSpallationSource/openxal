...
public class Solver implements AlgorithmPoolListener, AlgorithmMarketListener {
    ...
    /**
     * Constructor using the specified stopper, solution judge and only the
     * specified algorithm.
     *
     * @param stopper Determines when the solving is finished
     * @param solutionJudge Decides if a solution is optimal.
     ...
     * @throws xal.extension.solver.InvalidConfigurationException if the problem
     * is ill defined
     */
    ...
    /**
     * Get the scoreboard that shows the present state of solving. It shows the
     * best solution found so far and the time elapsed since solving started.
     *
