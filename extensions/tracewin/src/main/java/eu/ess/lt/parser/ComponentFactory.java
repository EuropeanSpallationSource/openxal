...
public class ComponentFactory {
     ...
     * ellipse
     */
    private final ApertureType defaultAperture = ApertureType.toEnum(1);
     ...
     *
     * @param name {@link String} name of the aperture.
     * @param dx <code>double</code> aperture's X position.
     * @param dy <code>double</code> aperture's Y position.
     * @param apertureType {@link ApertureType} type of the aperture.
     * @param previousSubsystem {@link Subsystem} subsystem positioned
     * previously in the lattice.
     ...
     *
     * @param name {@link String} name of the bending magnet.
     * @param entranceEdgeName
     * @param exitEdgeName
     * @param bendAngle <code>double</code> angle of bending.
     * @param curvatureRadius <code>double</code> radius of the trajectory
     * curve.
     * @param gradientIndex <code>int</code> gradient index.
     * @param aperture <code>double</code> aperture size.
     * @param orientation {@link Orientation} orientation of the bending magnet.
     * @param gap <code>double</code> total gap of the magnet.
     * @param entranceAngle <code>double</code> angle of the incoming beam.
     * @param entranceCurvature <code>double</code> curvature of the incoming
     * beam.
     * @param exitAngle <code>double</code> angle of the outgoing beam.
     * @param exitCurvature <code>double</code> curvature of the outgoing beam.
     * @param previousSubsystem {@link Subsystem} subsystem positioned
     * previously in the lattice.
     ...
     * new one. The returned entity has its fields set to the specified values.
     *
     * @param name {@link String} name of the RF cavity.
     * @param gapVoltage <code>double</code> effective gap voltage.
     * @param rfPhase <code>double</code> RF phase.
     * @param apertureRadius <code>double</code> aperture size.
     * @param isPhaseAbsolute <code>boolean</code> 1 if phase is absolute, 0 if
     * it's relative.
     * @param beta <code>double</code>
     * @param transitTimeFactor <code>double</code> transit time factor.
     * @param kT <code>double</code> transit time factor coefficient.
     * @param kkT <code>double</code> transit time factor coefficient.
     * @param kS <code>double</code> transit time factor coefficient.
     * @param kkS <code>double</code> transit time factor coefficient.
     * @param cavityType {@link CavityType} type of the cavity.
     * @param previousSubsystem {@link Subsystem} subsystem positioned
     * previously in the lattice.
     ...
     * new one. The returned entity has its fields set to the specified values.
     *
     * @param name {@link String} name of the drift element.
     * @param length <code>double</code> length of the drift.
     * @param aperture <code>double</code> aperture size.
     * @param apertureY <code>double</code> aperture position.
     * @param previousSubsystem {@link Subsystem} subsystem positioned
     * previously in the lattice.
     ...
     * new one. The returned entity has its fields set to the specified values.
     *
     * @param name {@link String} name of the DTL cell.
     * @param length <code>double</code> length of the DTL cell.
     * @param quadLength1 <code>double</code> first 1/2 quadrupole length.
     * @param quadLength2 <code>double</code> second 1/2 quadrupole length.
     * @param cellCenter <code>double</code> cell center.
     * @param fieldGradient1 <code>double</code> first magnetic field gradient.
     * @param fieldGradient2 <code>double</code> second magnetic field gradient.
     * @param gapVoltage <code>double</code> effective gap voltage.
     * @param rfPhase <code>double</code> RF phase.
     * @param aperture <code>double</code> aperture size.
     * @param isPhaseAbsolute <code>boolean</code> 1 if phase is absolute, 0 if
     * it's relative.
     * @param beta <code>double</code> particle reduced velocity.
     * @param transitTimeFactor <code>double</code> transit time factor.
     * @param kT <code>double</code> transit time factor coefficient.
     * @param kkT <code>double</code> transit time factor coefficient.
     * @param previousSubsystem {@link Subsystem} subsystem positioned
     ...
     * specified values.
     *
     * @param name {@link String} name of the electrostatic acceleration
     * element.
     * @param length <code>double</code> length of the electrostatic
     * acceleration element.
     * @param voltage <code>double</code> voltage.
     * @param defocal <code>double</code> transverse defocal.
     * @param aperture <code>double</code> aperture size.
     * @param previousSubsystem {@link Subsystem} subsystem positioned
     * previously in the lattice.
     ...
     * specified values.
     *
     * @param name {@link String} name of the electrostatic quadrupole.
     * @param length <code>double</code> length of the electrostatic quadrupole.
     * @param voltage <code>double</code> voltage between electrodes.
     * @param apertureRadius <code>double</code> aperture size.
     * @param skewAngle <code>double</code> skew angle.
     * @param sextupoleVoltage <code>double</code> sextupole voltage component.
     * @param octupoleVoltage <code>double</code> octupole voltage component.
     * @param decapoleVoltage <code>double</code> decapole voltage component.
     * @param dodecapoleVoltage <code>double</code> dodecapole voltage
     * component.
     * @param previousSubsystem {@link Subsystem} subsystem positioned
     * previously in the lattice.
     ...
     * new one. The returned entity has its fields set to the specified values.
     *
     * @param name {@link String} name of the field map.
     * @param length <code>double</code> length of the field map element.
     * @param geom <code>int</code> field map type.
     * @param rfPhase <code>double</code> RF phase.
     * @param aperture <code>double</code> aperture size.
     * @param magneticIntensityFactor <code>double</code> magnetic field
     * intensity factor.
     * @param electricIntensityFactor <code>double</code> electric field
     * intensity factor.
     * @param spaceChargeCompensationFactor <code>double</code> space charge
     * compensation factor.
     * @param apertureFlag <code>int</code> aperture flag.
     * @param fileName {@link String} file name without extension.
     * @param previousSubsystem {@link Subsystem} subsystem positioned
     * previously in the lattice.
     ...
     * specified values.
     *
     * @param name {@link String} name of the multipole magnet.
     * @param length <code>double</code> length of the multipole magnet.
     * @param magnetType {@link MagnetType} magnet type.
     * @param numberOfSteps <code>int</code> number of steps along x and y
     * directions.
     * @param magneticField <code>double</code> magnetic field on pole.
     * @param aperture <code>double</code> aperture size.
     * @param solenoidLength <code>double</code> physical length of solenoid.
     * @param solenoidStepNumber <code>int</code> step number of solenoid case.
     * @param previousSubsystem {@link Subsystem} subsystem positioned
     * previously in the lattice.
     ...
     *
     * @param name {@link String} name of the quadrupole magnet.
     * @param length <code>double</code> length of the quadrupole magnet.
     * @param quadrupoleGradient <code>double</code> magnetic field gradient
     * (T/m)
     * @param aperture <code>double</code> aperture
     * @param skewAngle <code>double</code> skew angle (degrees)
     * @param sextupoleGradient <code>double</code> sextupole gradient (T/m2)
     * @param octupoleGradient <code>double</code> octupole gradient (T/m3)
     * @param decapoleGradient <code>double</code> decapole gradient (T/m4)
     * @param dodecapoleGradient <code>double</code> dodecapole gradient (T/m5)
     * @param previousSubsystem {@link Subsystem} subsystem positioned
     * previously in the lattice.
     * @return {@link MultipoleMagnet} with the specified field values.
     */
     ...
     * new one. The returned entity has its fields set to the specified values.
     *
     * @param name {@link String} name of the NCell element.
     * @param length {@link String} length of the NCell element.
     * @param mode <code>int</code> mode.
     * @param numberOfCells <code>int</code> number of cells.
     * @param geometricBeta <code>double</code> geometric beta.
     * @param gapVoltage <code>double</code> effective gap voltage.
     * @param rfPhase <code>double</code> RF phase.
     * @param aperture <code>double</code> aperture size.
     * @param isPhaseAbsolute <code>boolean</code> 1 if phase is absolute, 0 if
     * it's relative.
     * @param inputFieldCorrection <code>double</code> input field correction.
     * @param outputFieldCorrection <code>double</code> output field correction.
     * @param gapDisplacement1 <code>double</code> first gap displacement.
     * @param gapDisplacement2 <code>double</code> second gap displacement.
     * @param beta <code>double</code> particle reduced velocity.
     * @param ttfMiddleGaps <code>double</code> transit time factor for the
     * middle gaps.
     * @param kTMiddleGaps <code>double</code> transit time factor coefficient
     * for the middle gaps.
     * @param kktMiddleGaps <code>double</code> transit time factor coefficient
     * for the middle gaps.
     * @param ttfInputGaps <code>double</code> transit time factor for the input
     * gaps.
     * @param kTInputGaps <code>double</code> transit time factor coefficient
     * for the input gaps.
     * @param kkTInputGaps <code>double</code> transit time factor coefficient
     * for the input gaps.
     * @param ttfOutputGaps <code>double</code> transit time factor for the
     * output gaps.
     * @param kTOutputGaps <code>double</code> transit time factor coefficient
     * for the output gaps.
     * @param kkTOutputGaps <code>double</code> transit time factor coefficient
     * for the output gaps.
     * @param previousSubsystem {@link Subsystem} subsystem positioned
     * previously in the lattice.
     ...
     * new one. The returned entity has its fields set to the specified values.
     *
     * @param name {@link String} name of the RFQ cell.
     * @param length <code>double</code> length of the RFQ cell.
     * @param gapVoltage <code>double</code> effective gap voltage.
     * @param vaneRadius <code>double</code> vane radius.
     * @param accParameter <code>double</code> acceleration parameter.
     * @param modulation <code>double</code> modulation.
     * @param rfPhase <code>double</code> RF phase.
     * @param type {@link String} type of RF cell.
     * @param curvature <code>double</code> transverse curvature.
     * @param focusing <code>double</code> transverse focusing.
     * @param previousSubsystem {@link Subsystem} subsystem positioned
     * previously in the lattice.
     ...
     *
     * @param name {@link String} name of the RF cavity.
     * @param length <code>double</code> length of the RF cavity.
     * @param cellNumber <code>int</code> cell number.
     * @param averageAccField <code>double</code> average accelerating field.
     * @param phaseAtEntrance <code>double</code> phase of the synchronous
     * particle at the entrance.
     * @param aperture <code>double</code> aperture size.
     * @param isPhaseAbsolute <code>boolean</code> 1 if phase is absolute, 0 if
     * it's relative.
     * @param cavityType {@link CavityType} type of the cavity.
     ...
     * new one. The returned entity has its fields set to the specified values.
     *
     * @param name {@link String} name of the solenoid.
     * @param length <code>double</code> length of the solenoid.
     * @param magneticField <code>double</code> magnetic field.
     * @param aperture <code>double</code> aperture size.
     * @param previousSubsystem {@link Subsystem} subsystem positioned
     * previously in the lattice.
     ...
     * new one. The returned entity has its fields set to the specified values.
     *
     * @param name {@link String} name of the thin lens.
     * @param focalLengthX <code>double</code> focal length.
     * @param focalLengthY <code>double</code> focal length.
     * @param aperture <code>double</code> size of aperture.
     * @param previousSubsystem {@link Subsystem} subsystem positioned
     * previously in the lattice.
     ...
     *
     * @param name {@link String} name of the slot.
     * @param description {@link String} description of the slot.
     ...
     *
     * @param name {@link String} name of the beamline.
     * @param description {@link String} description of the beamline.
     ...
     * new one. The returned entity has its fields set to the specified values.
     *
     * @param name {@link String} name of the marker.
     * @param previousSubsystem {@link Subsystem} subsystem positioned
     * previously in the lattice.
     ...
     * specified values.
     *
     * @param name {@link String} name of the electrostatic bend.
     * @param bendAngle <code>double</code> bend angle in the rotation plane
     * (deg)
     * @param curvatureRadius <code>double</code> curvature radius of central
     * trajectory (mm)
     * @param bendType {@link ElectrostaticBend.BendType} CYLINDRICAL, SPHERICAL
     * or TOROIDAL
     * @param aperture <code>double</code> aperture (mm)
     * @param horizVert <code>false</code> horizontal, <code>true</code>
     * vertical
     * @param previousSubsystem {@link Subsystem} subsystem positioned
     * previously in the lattice.
     * @return
     ...
     * specified values.
     *
     * @param name {@link String} name of the space charge compensation.
     * @param factor <code>double</code> beam current is compensated by a factor
     * @param previousSubsystem {@link Subsystem} subsystem positioned
     * previously in the lattice.
     * @return
     */
