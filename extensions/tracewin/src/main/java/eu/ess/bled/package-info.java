/**
 * <code>eu.ess.bled</code> is the main package containing the java object model
 ...
 * <p>
 * The database is structured around the base class {@link Subsystem}, which
 ...
 * {@link Subsystem}. All nodes in the tree are also {@link Subsystem}s.
 * </p>
 * <p>
 * All classes that form BLED, form a relational model, which is annotated with
 * hibernate annotations and can be mapped to/from a database.
 * </p>
 */
package eu.ess.bled;
