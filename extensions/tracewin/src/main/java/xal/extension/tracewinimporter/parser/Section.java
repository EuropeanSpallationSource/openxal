...
public class Section {
     ...
     *
     * @param sectionNumber the number of the section in the file
     * @param periodType ??
     * @param syncPhaseInput phase input in degrees
     * @param syncPhaseOutput phase output in degrees
     * @param syncPhaseMax phase maximum in degrees
     * @param syncPhaseStepMax maximum phase step in degrees
     * @param syncPhaseContinuity ??
     * @param syncPhaseConstantAcceptance ??
     * @param phaseAdvanceMax maximum phase advance in degrees
     * @param phaseAdvanceStep step size degrees per meter
     * @param phaseAdvanceContinuity ??
     * @param cavityBetaG reduced speed
     * @param cavityFrequency the frequency in Hz
     * @param cavityMaxPower maximal power in W
     * @param cavityAccElectricField accelerating electric field in V/m
     * @param analyticModel ??
     * @param cavityFile ??
     * @param radiusData ??
     */
     ...
     * section id number.
     *
     * @param sectionNumber the section id number
     */
