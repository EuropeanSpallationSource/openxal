...
public interface TraceWinTags {
    ...
    public static final List<String> LATT_COM_LIST = new ArrayList<>(Arrays.<String>asList(C_CHOPPER,
            ...
            C_RFQ_VANE_GEOMETRY, C_SHIFT, C_SUPERPOSE_FIELD_MAP, C_CHANGE_BEAM,
            C_FIELD, C_MIN_ENVELOPE_VARIATION, C_MATCH_FAM_GRAD,
            C_MATCH_FAM_FIELD, C_MATCH_FAM_PHASE, C_MATCH_FAM_LFOC,
