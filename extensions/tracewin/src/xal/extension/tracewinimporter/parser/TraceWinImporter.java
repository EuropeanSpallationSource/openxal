...
public class TraceWinImporter implements TraceWinTags {
     ...
     *
     * @param reader {@link BufferedReader} providing the input.
     ...
     *
     * @param source the source string to be manipulated
    ...
    private boolean isLatticeCommand(String line) {
        ...
        return startsWithTag(line, LATT_COM_LIST);
    }
    ...
    private boolean isElement(String line) {
        ...
        return startsWithTag(line, DIAG_LIST) || startsWithTag(line, ELEM_LIST);
    }
    ...
    /**
     * Returns true if line starts with any of the tags in tagList
     *
     * @param line line from the TraceWin file
     * @param tagList List of tags
     * @return <code> true </code> if line contains any of the tags, <code> false
     * </code> otherwise
     */
     ...
     *
     * @param originalLine {@link String} unchanged line containing all of the
     * element's information.
     * @param section {@link Section} where this element belongs to.
     * @param parentSubsystem {@link Subsystem} parent of the element.
     ...
     *
     * @param line the truncated, trimmed, uppered line
     * @param values the values extracted from the line
     * @param originalLine the original line
     * @param section the section to append the element to
     ...
     *
     * @param edge1Line {@link String} line containing preceding edge parameter
     * values.
     * @param edge1Values <code>String[]</code> containing preceding edge
     * parameter values.
     * @param bendLine {@link String} line containing bend parameter values.
     * @param bendValues <code>String[]</code> bend edge parameter values.
     * @param bendName {@link String} name of the bend.
     * @param edge2Line {@link String} line containing following edge parameter
     * values.
     * @param edge2Values <code>String[]</code> containing following edge
     * parameter values.
     * @param section {@link Section} where this element belongs to.
     */
     ...
     * values array, the values array is returned. Otherwise an array of length
     * </code>length</code> is returned, with values from the
     * <code>values</code> array in the beginning and empty strings in the rest
     * of the array.
     *
     * @param values the original values array
     * @param length the desired length of the array
     * @param appendZeros true if the missing values should be set to 0 or false
     * if left emptyStrings
     ...
     *
     * @param feedback {@link String} feedback to be written.
     */
     ...
     *
     * @param parentSubsystem {@link Subsystem} parent subsystem with children
     * listed in its description.
     * @param candidates {@link List}<code>&lt;Subsystem&gt;</code> list of
     * child candidates.
