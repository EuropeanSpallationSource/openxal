...
public interface TraceWinTags {
    ...
    public static final List<String> LATT_COM_LIST = new ArrayList<>(Arrays.<String>asList(C_CHOPPER,
            ...
            C_MAGNETIC_STEERER, C_RFQ_COUPLING_GAP, C_RFQ_ELECTRODE_FOUR,
            C_RFQ_ELECTRODE_TWO, C_RFQ_VANE_GEOMETRY, C_SHIFT,
            C_SUPERPOSE_FIELD_MAP, C_CHANGE_BEAM, C_FIELD, C_MIN_ENVELOPE_VARIATION,
            C_MATCH_FAM_GRAD, C_MATCH_FAM_FIELD, C_MATCH_FAM_PHASE, C_MATCH_FAM_LFOC,
            C_MATCH_FAM_LENGTH, C_MIN_EMITTANCE_GROWTH, C_MIN_FIELD_VARIATION,
            C_MIN_PHASE_VARIATION, C_SET_ACHROMAT, C_SET_POSITION, C_SET_BEAM_E_P,
            C_SET_BEAM_PHASE_ADVANCE, C_SET_BEAM_PHASE_ERROR, C_SET_BEAM_SEPARATION,
            C_SET_BEAM_SIZE, C_SET_BEAM_SIZE_MAX, C_SET_SYNC_PHASE, C_SET_TWISS,
            C_SET_BEAM_ENERGY, C_START_ACHROMAT, C_LATTICE_BEGIN, C_LATTICE_END, C_END));
    ...
    public static final List<String> ELEM_LIST = new ArrayList<>(Arrays.<String>asList(E_ALPHA_MAGNET,
            E_APERTURE, E_BEAM_CURRENT, E_BEAM_ROTATION, E_BENDING_MAGNET, E_BUNCHED_CAVITY,
            E_CAVITY_MULTIGAP, E_CHFRAME, E_DRIFT, E_DTL_CELL, E_EDGE_BENDING_MAGNET,
            E_ELECTROSTATIC_ACCELERATION, E_ELECTROSTATIC_QUADRUPOLE, E_FIELD_MAP_PATH,
            E_FIELD_MAP, E_FUNNELING_GAP, E_MULTIPOLE_FIELD_MAP, E_QUADRUPOLE, E_RFQ_CELL,
            E_SINUS_CAVITY, E_SOLENOID, E_SPACE_CHARGE_COMPENSATION, E_THIN_LENS, E_THIN_MATRIX,
            E_THIN_STEERING_MAGNET, E_BEND_ELE));
    ...
    public static final List<String> DIAG_LIST = new ArrayList<>(Arrays.<String>asList(D_ACHROMAT,
            D_CURRENT, D_DELTA_SIZE, D_DELTA_SIZE2, D_DELTA_SIZE3, D_DIVERGENCE, D_EMITTANCE,
            D_EMITTANCE99, D_LUMINOSITY, D_PERFECT_ENERGY, D_PERFECT_PHASE, D_PHASE,
            D_POSITION, D_SIZE, D_SIZE_DIVERGENCE, D_TRANSFER_MATRIX, D_TWISS, D_WAIST));
}
