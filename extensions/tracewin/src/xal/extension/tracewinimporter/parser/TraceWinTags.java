...
public interface TraceWinTags {
    ...
    public static final List<String> ELEM_LIST = new ArrayList<>(Arrays.<String>asList(E_ALPHA_MAGNET,
            ...
            E_CAVITY_MULTIGAP, E_CHFRAME, E_DRIFT, E_DTL_CELL, E_ELECTROSTATIC_ACCELERATION, 
            E_ELECTROSTATIC_QUADRUPOLE, E_FIELD_MAP_PATH, E_FIELD_MAP, E_FUNNELING_GAP,
            E_MULTIPOLE_FIELD_MAP, E_QUADRUPOLE, E_RFQ_CELL, E_SINUS_CAVITY, E_SOLENOID,
            E_SPACE_CHARGE_COMPENSATION, E_THIN_LENS, E_THIN_MATRIX, E_THIN_STEERING_MAGNET, E_BEND_ELE));
