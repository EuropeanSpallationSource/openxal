...
public class FunctionGraphsPopupAdaptor implements ChartPopupAdaptor {
    ...
    /**
     * Scale the x and y axes once so all points fit on the chart then keep the
     * axes' scales fixed.
     */
    ...
    /**
     * Scale the x-axis once so all points fit on the chart along the x axis
     * then keep the x-axis scale fixed. Method intended for internal use.
     */
    ...
    /**
     * Scale the y-axis once so all points fit on the chart along the y axis
     * then keep the y-axis scale fixed. Method intended for internal use.
     */
     ...
     *
     * @param autoScale true to enable x-axis auto-scaling; false to disable
     * auto-scaling
     */
    @Override
     ...
     *
     * @param autoScale true to enable y-axis auto-scaling; false to disable
     * auto-scaling
     */
    @Override
