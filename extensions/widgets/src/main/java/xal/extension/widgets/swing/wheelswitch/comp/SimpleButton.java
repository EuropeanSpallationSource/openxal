...
public class SimpleButton extends GradientLabel {
     ...
     * ActionEvent when left mouse button is clicked. CHAIN_ACTION_MODE fires a
     * series of ActionEvent while left mouse button is being pressed at the
     * <code>fireRate</code>. FAST_ACTION_MODE fires ActionEvent when left mouse
     * button is pressed. NULL_ACTION_MODE fires no ActionEvents on mouse
     * actions but pressing the ENTER key still triggers ActionEvents.
     *
     ...
     *
     * @see
     * xal.extension.widgets.swing.wheelswitch.comp.GradientLabel#setBackground(Color)
     */
    @Override
     ...
     *
     * @see
     * xal.extension.widgets.swing.wheelswitch.comp.GradientLabel#getBackgroundStart()
     */
    @Override
     ...
     *
     * @see
     * xal.extension.widgets.swing.wheelswitch.comp.GradientLabel#setBackgroundStart(Color)
     */
    @Override
    ...
    /**
     * Gets the starting background gradient color displayed when the button is
     * pressed.
     *
     * @return Color
     */
    ...
    /**
     * Sets the starting background gradient color displayed when the button is
     * pressed.
     *
     * @param newColor Color
     */
    ...
    /**
     * Removes an action listener from the list of registered listeners for this
     * button.
     *
     * @param l ActionListener
     */
     ...
     *
     * @see
     * xal.extension.widgets.swing.wheelswitch.comp.GradientLabel#paintComponent(Graphics)
     */
    @Override
    ...
    private class DisplayMouseListener extends MouseAdapter {
        ...
        /**
         * Updates the visualisation of this SimpleButton when left mouse button
         * is pressed.
         *
         * @param e MouseEvent
         *
    ...
    private class ChainMouseListener extends MouseAdapter {
        ...
        /**
         * time to wait in milliseconds before a press triggers a chain of
         * events
         */
        ...
        /**
         * Determine if the current press is long (i.e. user is pressing and
         * holding long enough to trigger a chain event)
         */
    ...
    public static class PanelFlushBorder implements Border {
        ...
        /**
         * @see javax.swing.border.Border#paintBorder(Component, Graphics, int,
         * int, int, int)
         */
        @Override
