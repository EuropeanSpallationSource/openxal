...
public class Data3DFactory {
     ...
     */
    public static ColorSurfaceData getDefaultData3D(int nx, int ny) {
        if (nx < 3) {
            nx = 3;
        }
        if (ny < 3) {
    ...
    /**
     * Returns the 3d data instance defined by name. The name could be "smooth",
     * "linear", "point like", and "black&white".
     */
    public static ColorSurfaceData getData3D(int nx, int ny, String dataName) {
