...
/**
 * Graphics object representing a curve in a <code>{
 *
 * @FunctionGraphsJPanel}</code> object. The curve is a
 * <code>{@link BasicGraphData}</code> object that is an RMS envelope trajectory
...
public class EnvelopeCurve extends BasicGraphData {
     ...
     * given phase plane. The curve object must be subsequently defined using
     * the method {@link #loadCurve(Trajectory)}</code>.
     *
     ...
     *
     * @throws IllegalArgumentException the argument <var>trjEnv</var> is not an
     * envelope trajectory object
     *
     * @author Christopher K. Allen
     * @since Nov 26, 2012
     */
     ...
     */
    /**
     * Defines the graphics curve according to the RMS envelope trajectory data
     * in the given <code>Trajectory</code> object.
     *
