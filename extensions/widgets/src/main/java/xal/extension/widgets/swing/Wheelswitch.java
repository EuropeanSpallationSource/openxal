 ...
 * modifying a single formatted <code>double</code> value with an optional unit
 * string (also in digits) displayed next to the value. Value manipulation and
 * display formatting is handled by the <code>WheelswitchFormatter</code>.
 *
...
public class Wheelswitch extends JPanel {
    ...
    protected class MouseHandler extends MouseAdapter {
        ...
        /**
         * Updates digit selection in this Wheelswitch when left mouse button is
         * pressed.
         *
         * @param e
         */
    ...
    /**
     * Constructor for Wheelswitch which sets no format or unit and the value is
     * set to zero.
     *
     * @see #Wheelswitch(String, double, String)
     */
     ...
     * change the current digit selection if neccessary in order to point to the
     * same decimal digit of the displayed value.
     *
     * @param newValue
     *
    ...
    private boolean layoutMatches(final String oldString, final String newString) {
        ...
        if (oldString.indexOf(".") != newString.indexOf(".")) {
            return false;
        }
