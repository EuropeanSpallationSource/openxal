...
public class BarChart {
    ...
    class MarkerFormat extends NumberFormat {
        ...
        /**
         * The overridden method of the NumberFormat that delegates formatting
         * to the specific inner formatter
         *
    ...
    /**
     * The smart formatter calculates min, max, step values and chooses the
     * right format for two initial parameters vMin, vMax.
     *
     * @author shishlo created October 10, 2005
     */
    static class SmartFormater {
        ...
        /**
         * Analyzes the limits and calculates suggestion for new limits and
         * formats
         *
