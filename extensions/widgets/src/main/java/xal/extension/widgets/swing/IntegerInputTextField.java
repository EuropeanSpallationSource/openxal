...
/**
 * This is an input formatted text field for an integer value. This text field
 ...
 * <code> getValue() </code> and <code> setValue(int val) </code> methods to get
 * and to set integer value to this container. User has to add one or several
 * ActionListeners as usual to interact with the external code. By default the
 * format of this text field is ###. To specify another format the method <code> setDecimalFormat
 * </code>should be used.
 */
public class IntegerInputTextField extends JTextField {
    ...
    /**
     * Creates new IntegerInputTextField with predefined text and number of
     * columns
     */
    ...
    /**
     * Creates new IntegerInputTextField with predefined value, format, and
     * number of columns
     */
