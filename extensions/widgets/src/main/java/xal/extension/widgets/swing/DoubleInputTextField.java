 ...
 * will have the special alert background color is the changes are not
 * committed. After posting changes the background color will be normal color
 * again. In addition to usual JTextField methods it provides 
 * <code> getValue() </code> and <code> setValue(double val) </code> methods to
 * get and to set double value to this container. User has to add one or several
 * ActionListeners as usual to interact with the external code. By default the
 * format of this text field is ###.###. To specify another format the method <code> setNumberFormat
 * </code>should be used.
 */
public class DoubleInputTextField extends JTextField {
    ...
    /**
     * Creates new DoubleInputTextField with predefined text and number of
     * columns
     */
    ...
    /**
     * Creates new DoubleInputTextField with predefined value, format, and
     * number of columns
     */
    ...
    /**
     * Sets the value quietly. The external listeners do not receive the "action
     * performed" call.
     */
    ...
    /**
     * @deprecated use setNumberFormat() instead as constraining to
     * DecimalFormat is not necessary and there should be no expectation that
     * the internal number format is a DecimalFormat. This method is around
     * temporarily for backward compatibility but will be removed in the near
     * future. Set the number format
     */
    @Deprecated
    ...
    /**
     * Sets the integer value quietly. The external listeners do not receive the
