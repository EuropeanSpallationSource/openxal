...
public enum PLANE {
    ...
    /**
     * Extracts the particle position of the phase plane represented by this
     * enumeration constant from the given particle probe state.
     *
     * @param state <code>ParticleProbeState</code> object containing particle
     * state information
     *
     * @return the value of the RMS envelope of this phase plane within the
     * given state
     *
     * @author Christopher K. Allen
     * @since Nov 26, 2012
    ...
    /**
     * Extracts the RMS envelope size of the phase plane represented by this
     * enumeration constant from the given envelope probe state.
     *
     * @param state <code>EnvelopeProbeState</code> object containing RMS
    ...
    /**
     * Create the enumeration constant saving the name of the method needed to
     * acquire its envelope value.
     *
     * @param strMthPar name of the method returning the particle coordinate
     * value
