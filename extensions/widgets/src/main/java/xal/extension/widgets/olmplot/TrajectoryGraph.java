 ...
 * <code>{@link EnvelopeCurve}</code>), particle positions (see
 * <code>{@link ParticleCurve}</code>), or any other object derived from
...
public class TrajectoryGraph extends FunctionGraphsJPanel {
     ...
     */
    /**
     * Creates a new graph object of the particle trajectory contained in the
     * given <code>Trajectory</code> object.
     *
     * @param trjPar trajectory object containing particle coordinate positions
     * as function of beamline position
     *
     * @return graph with curves showing particle positions in each phase plane
     *
     * @throws IllegalArgumentException the argument is not a particle
     * trajectory object
     *
     * @author Christopher K. Allen
     * @since Nov 26, 2012
     ...
     *
     * @return graph with curves showing envelope trajectory for each phase
     * plane
     *
     * @throws IllegalArgumentException the argument is not an envelope
     * trajectory object
     *
     * @author Christopher K. Allen
     * @since Nov 26, 2012
     ...
     */
    /**
     * Adds a new curve to the trajectory graph for the give plane. The curve
     * type need only be derived from <code>BasicGraphData</code> so this is a
     * general object.
     *
     * @param plane the curve will display under this phase plane
     * characteristics
     ...
     */
    /**
     * Creates and loads a curve for each particle phase position trajectory.
     * The given trajectory object provides the data for the curve.
     *
     * @param trjPar particle trajectory object containing the data for the
     * curve
     *
     * @throws IllegalArgumentException the given argument is not a particle
     * trajectory object
     *
     * @author Christopher K. Allen
     * @since Nov 26, 2012
    ...
    /**
     * Creates and loads an envelope curve for each phase plane. The curve is
     * constructed from the given trajectory data for each phase plane.
     *
