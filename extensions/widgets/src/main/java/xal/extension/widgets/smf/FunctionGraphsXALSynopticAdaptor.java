...
public class FunctionGraphsXALSynopticAdaptor {
    ...
    /**
     * Assign the synoptic view to the specified chart and configure it to auto
     * size as the chart's position axis changes. You will also need to
     * explicitly add the synoptic panel to a container to be viewed along with
     * your chart.
     *
     * @param chart the chart to which to add the synoptic view
     * @param sequence the accelerator sequence for which to generate the
     * synoptic view
