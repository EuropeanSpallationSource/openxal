...
public class TextScrollDouble extends JPanel {
     ...
     * of text and scroll) = 0 (horizontal); tdigits (total number of digits in
     * the text field) = 6; fdigits (digits after the decimal) = 3; dval
     * (initial value in the text box) = 0.0; min (minimum of the range) = 0.0;
     * max (maximum of the range) = 10.0; cincrement (current increment) = 0.01;
    ...
    /**
     * An instance the class. Default values used are: tdigits (total number of
     * digits in the text field) = 6; fdigits (digits after the decimal) = 3;
     * dval (initial value in the text box) = 0.0; minincrement (minimum
     * allowable increment) = 0.001;
     */
     ...
     *
     * @param orient the relative layout of the text box and scroll panel (0 is
     * horizontal, 1 is vertical)
    ...
    /**
     * Set the increment of the scroll bar. Can not be less than the minimum
     * increment.
     */
