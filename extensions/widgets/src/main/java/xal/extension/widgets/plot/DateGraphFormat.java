...
public class DateGraphFormat extends NumberFormat {
    ...
    /**
     * Constructor with a default DateFormat (it is
    ...
    /**
     * Returns the instance of the DateFormat class that is used to format the
     * seconds to the date.
     */
    ...
    /**
     * Sets the instance of the DateFormat class that will be used to format the
     * seconds to the date.
     */
