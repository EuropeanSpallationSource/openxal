...
public class BasicGraphData {
     ...
     * containers <code> FunctionGraphsJPanel </code> where this data set has
     * been registered.
     */
    ...
    /**
     * returns the size of the point during drawing. This parameter is used if
     * no external shape is set, and the filled circle is used to represent
     * points.
     *
    ...
    /**
     * sets the filling shape property of the point during drawing. By default
     * it will be true.
     *
