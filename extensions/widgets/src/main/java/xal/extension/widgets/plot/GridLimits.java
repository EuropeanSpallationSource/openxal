...
public class GridLimits {
    ...
    /**
     * Sets the minimal value, maximal value, step, and number of minor ticks on
     * the x-axis
     *
    ...
    /**
     * Sets the minimal value, maximal value, step, and number of minor ticks on
     * the x-axis. The number of minor ticks will be what is was before
     *
     * @param vMin The new minimal value
    ...
    /**
     * Sets the minimal value, maximal value, step, and number of minor ticks on
     * the y-axis. The number of minor ticks will be what is was before
     *
     * @param vMin The new minimal value
     * @param vMax The new maximal value
     * @param step The new step
