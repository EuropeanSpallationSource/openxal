...
public class UpDownButton extends JComponent {
    ...
    /**
     * Returns <code>UpDownButton.UP_PRESSED</code> if the upper arrowed button
     * was last pressed and <code>UpDownButton.DOWN_PRESSED</code> if the lower
     * arrowed button was last pressed
     */
    public int getValue() {
        return value;
    }
    ...
    /**
     * Adds an <code>UpDownListener</code> to the array of listeners currently
     * registered for listening to the changes of the <code>UpDownButton</code>.
     * These listeners are notified whenever the user clicks the
     * <code>UpDownButton</code>.
     *
     * @param l
     * @see UpDownListener
     */
    ...
    /**
     * Removes an <code>UpDownListener</code> from the array of listeners
     * currently registered for listening to the changes of the
     * <code>UpDownButton</code>.
     */
    ...
    /**
     * This method was overridden to implement correct <code>UpDownButton</code>
     * placement inside the <code>Wheelswitch</code> container.
     *
