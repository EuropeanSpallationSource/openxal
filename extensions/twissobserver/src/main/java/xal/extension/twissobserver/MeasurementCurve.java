 ...
 * <code>{@link FunctionGraphsJPanel}</code> and child class
 * <code>{@link TrajectoryGraph}</code>) containing measurement data. The curve
 * is composed of unconnected data points for the beam size measurements of a
...
public class MeasurementCurve extends BasicGraphData {
     ...
     */
    /**
     * Creates a new, initialized curve object containing the given measurement
     * data as points. The data for the given phase plane is extracted from the
     * data set. The <code>AcceleratorSeq</code> object must be the location
     * within the accelerator where the data was taken.
     *
     ...
     */
    /**
     * Loads the data points from the given measurement data into this curve
     * object.
     *
    ...
    /**
     * Returns the correct beam size measurement from the measurement record for
     * the given phase plane.
     *
     * @param plane phase plane of the desired measurement
     * @param msmt the data record of beam size measurements
     *
     * @return beam size measurement from the provided data structure in the
     * given phase plane
     *
     * @author Christopher K. Allen
     * @since Nov 27, 2012
