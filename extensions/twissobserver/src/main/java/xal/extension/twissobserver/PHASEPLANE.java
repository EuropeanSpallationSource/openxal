...
/**
 * Enumeration of the mechanical motion phase planes for use in identifying the
 * families of Courant-Snyder parameters. The enumeration also contains useful
 * methods for converting between covariance space representations.
 *
 * @author Christopher K. Allen
 * @author Eric Dai
 * @since Jul 20, 2012
...
public enum PHASEPLANE {
     ...
     *
     * @return index offset identifying the block diagonal within the covariance
     * matrix
     *
     * @author Christopher K. Allen
     * @since Mar 27, 2013
     ...
     * <strong>four</strong> of these matrices for each phase plane. They
     * provide an independent vector representation of the 4&times;4 diagonal
     * block occupied by this phase space within <strong>phase
     * matrices</strong>. Restricting to one block diagonal we have
     * </p>
     * <br>
     * <table>
     * <tr><td><strong>e</strong><sub>0</sub></td><td>&equiv;</td><td>| 1 0
     * |</td></tr>
     * <tr><td/><td/><td>| 0 0 |</td></tr>
     * </table>
     * <br>
     * <table>
     * <tr><td><strong>e</strong><sub>1</sub></td><td>&equiv;</td><td>| 0 1
     * |</td></tr>
     * <tr><td/><td/><td>| 0 0 |</td></tr>
     * </table>
     * </br>
     * <table>
     * <tr><td><strong>e</strong><sub>2</sub></td><td>&equiv;</td><td>| 0 0
     * |</td></tr>
     * <tr><td/><td/><td>| 1 0 |</td></tr>
     * </table>
     * <br>
     * <table>
     * <tr><td><strong>e</strong><sub>3</sub></td><td>&equiv;</td><td>| 0 0
     * |</td></tr>
     ...
     * <strong>three</strong> of these matrices for each phase plane. They
     * provide a vector representation of the 4&times;4 block diagonal of the
     * covariance matrix occupied by this phase plane. Because of the symmetry
     * of the covariance matrix, there are only three independent basis vectors.
     * Restricting attention to one block diagonal we have
     * </p>
     * <br>
     * <table>
     * <tr><td><strong>c</strong><sub>0</sub></td><td>&equiv;</td><td>| 1 0
     * |</td></tr>
     * <tr><td/><td/><td>| 0 0 |</td></tr>
     * </table>
     * <br>
     * <table>
     * <tr><td><strong>c</strong><sub>1</sub></td><td>&equiv;</td><td>| 0 1
     * |</td></tr>
     * <tr><td/><td/><td>| 1 0 |</td></tr>
     * </table>
     * </br>
     * <table>
     * <tr><td><strong>c</strong><sub>2</sub></td><td>&equiv;</td><td>| 0 0
     * |</td></tr>
     * <tr><td/><td/><td>| 0 1 |</td></tr>
     * </table>
     * <br>
    ...
    /**
     * Returns the beam size field corresponding to this phase plane from the
     * given measurement data structure.
     *
     ...
     * &lt;<em>xx'</em>&gt;,
     * &lt;<em>x'</em><sup>2</sup>&gt;)<sup><em>T</em></sup>.
     *
     ...
     */
    /**
     * Field of the <code>Measurement</code> data structure which contains the
     * RMS beam size for this plane
     */
    private Field fldMsmtBmSz;

    /**
     * Base index of the constant into the covariance matrix
     * (<code>CorrelationMatrix</code>).
     */
    ...
    /**
     * Covariance basis matrices for covariance space covered by this phase
     * plane
     */
     ...
     * @param strFldNm name of the <code>Measurement</code> field containing
    ...
    /**
     * Initializes the <code>Field</code> object representing the data structure
     * field containing the beam size for this phase plane.
     *
     ...
     * four of these matrices for each phase plane. They allow a vector
     * representation of the block diagonal covariance matrix for a
     * distribution.
     *
     * @author Christopher K. Allen
     * @since Mar 27, 2013
     ...
     * three of these matrices for each phase plane. They provide a vector
     * representation of the symmetric covariance space for a distribution.
     *
     * @author Christopher K. Allen
     * @since Mar 27, 2013
     */
