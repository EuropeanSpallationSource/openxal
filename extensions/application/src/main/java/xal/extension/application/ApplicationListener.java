...
public interface ApplicationListener {
    ...
    /**
     * Event indicating that the application will open the initial documents if
     * any. These documents may include a new empty document if appropriate or
     * any documents passed at the command line.
     */
