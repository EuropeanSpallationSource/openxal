...
public abstract class XalWindow extends JFrame implements XalDocumentView, XalDocumentListener {
    ...
    /**
     * Implement XalDocumentListener and handle the event where the title has
     * changed. Update the title on the title bar to reflect the new document
     * title.
     *
    ...
    /**
     * Implement XalDocumentListener. Update the title on the title bar to
     * reflect whether the document has changes that need saving.
     *
    ...
    /**
     * Implement XalDocumentListener. Event indicating that the document will
     * close. Closes the window in response.
     */
    @Override
