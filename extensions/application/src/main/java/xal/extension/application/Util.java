...
public class Util {
    ...
    /**
     * Load the resource bundle specified by the URL. When the resource bundle
     * is loaded, the properties are stored in a Map for convenience data
     * access.
     *
     * @param resourceURL The URL to the properties file
     * @return The map equivalent of the resource bundle or null if the resource
     * was not found
     */
    ...
    /**
     * Merge the resource bundle from the specified source into the specified
     * map. If the file does not exist at the source, then nothing is merged as
     * this is intended for optional modifications.
     *
    ...
    /**
     * Convenience method for loading the resource bundle from a file whose path
     * is specified relative to the application's resources folder.
     *
     * @param propertyFile The property file relative to the application's
     * resources folder
     * @return The map equivalent of the resource bundle
     * @throws java.util.MissingResourceException If the resource bundle cannot
     * be found.
