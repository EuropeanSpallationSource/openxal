...
class LoggerBuffer extends Handler {
    ...
    /**
     * Add the specified listener to receive LoggerBufferListener events from
     * this instance.
     *
     * @param listener The listener to register to receive events from this
     * instance
     */
    ...
    /**
     * Remove the specified listener from receiving LoggerBufferListener events
     * from this instance.
     *
     * @param listener The listener to remove from receiving events from this
     * instance.
     */
