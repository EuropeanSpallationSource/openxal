...
/**
 * Displays a dialog box which allows the user to compose a combo sequence by
 * selecting the end sequences.
 */
class ComboSequenceComposer {
    ...
    /**
     * determine whether a combo sequence is possible between the start and end
     * sequences
     */
    ...
    /**
     * generate a combo sequence using the given name and the sequences between
    ...
    private String suggestedComboName() {
        ...
        buffer.append(":");
        if (endSequence != null) {
            buffer.append(endSequence.getId());
        }
    ...
    /**
     * Display a dialog for selecting the start and end sequences to form a
     * combo sequence joining them.
     *
