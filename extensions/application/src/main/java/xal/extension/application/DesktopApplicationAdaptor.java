...
public abstract class DesktopApplicationAdaptor extends AbstractApplicationAdaptor {
     ...
     * depending on the application's specific implementation. The default
     * implementation displays a warning dialog box that now preference panel
     * exists.
     *
    ...
    /**
     * Determine whether to draw a document's contents when its window is
     * dragged. The default behavior is true. Subclasses should override this
     * method if outline mode is desired.
     *
