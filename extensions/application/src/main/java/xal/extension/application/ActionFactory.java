 ...
 * for use in menus and the toolbar. All of the actions are standard
 * document-based application actions. In addition to actions, it also defines
 * menu handlers that get invoked when a menu is activated. Typically it menu
 * handlers are used to dynamically populate menus. For example there is
 * "documents" submenu under the "Window" menu that populates itself upon
 * selection with a list of menu items having one menu item for each open
 * document.
 *
 * @author t6p
 */
public class ActionFactory {
    ...
    // --------- File menu actions ---------------------------------------------
    /**
     * Make an action that creates a new document in the application. This
     * action is usually associated with the "new" menu item in the "File" menu.
     *
     ...
     * This action is usually associated with the "New from Template..." menu
     * item in the "File" menu.
     *
     * @return An action that creates a new document from a user selected
     * template
     */
    ...
    /**
     * Make an action that creates a new document for the associated document
     * type.
     *
    ...
    /**
     * Make an action that presents the user with an open file dialog. If the
     * user selects one or more files, those files are opened as XalDocument
     * subclasses and added to the application's list of open documents. This
     * action is usually associated with the "Open..." menu item in the "File"
     * menu.
     *
     ...
     * menu items in the dynamically generated submenu "Open Recent" in the
     * "File" menu. The "Open Recent" submenu lists the URL specifications of
     * the recently opened files.
     *
     * @param urlSpec The URL specification of the file to open
     * @return An action that opens a file corresponding to the given URL
     * specification
    ...
    /**
     * Make a menu handler that is used to generate a list of recently opened
     * files to be available under the "Open Recent" submenu of the "File" menu.
     * A "clear" menu item appears at the end of the list and allows the user to
     * clear the list. When the submenu is selected, the submenu gets populated
     * with the list of recently opened files. The list is stored in the user
     * preferences and the Application class manages the list.
     *
     * @return An action that opens a file corresponding to the given URL
     * specification
     * @see #openURLAction
    ...
    /**
     * Make an action that presents the user with an open dialog to select a
     * version of the current document to open
     *
    ...
    /**
     * Make an action that closes the document where the from which the menu
     * item was selected. This action is usually associated with the "Close"
    ...
    /**
     * Make an action that closes all documents in the application which leads
     * to termination of the application. This action is usually associated with
    ...
    /**
     * Make an action that presents the user with an save file dialog for a new
     * document or just save the present document to its existing file source if
     * it is not new. In the case were the document is new: if the user selects
     * "Save" after navigating to a folder and naming a new file, the present
     * document is saved to the selected file. This action is usually associated
     * with the "Save" menu item in the "File" menu.
     *
    ...
    /**
     * Make an action that presents the user with an save file dialog. If the
     * user selects "Save" after navigating to a folder and naming a new file,
     * the present document is saved to the selected file. This action is
     * usually associated with the "Save As..." menu item in the "File" menu.
     *
     * @param document The document to save.
    ...
    /**
     * Make an action that shows a standard page-setup dialog box for formatting
     * printing.
     *
     ...
     *
     * @return an action for performing a copy operation on the component in
     * focus
     */
     ...
     *
     * @return an action for performing a cut operation on the component in
     * focus
     */
     ...
     *
     * @return an action for performing a paste operation on the component in
     * focus
     */
    ...
    /**
     * Make an internal action used by the documentsHandler to show a specified
     * document when that document is selected from the documents submenu.
     *
    ...
    /**
     * Cascade all document windows relative to the location of the window where
     * the action was fired.
     *
     * @param document The document about whose window all other windows will
     * cascade
    ...
    /**
     * Make an action that captures the main window corresponding to the
     * document as a PNG image and allows the user to save it to a file.
     *
    ...
    // --------- Help menu actions ---------------------------------------------
    /**
     * Make an action that shows the about box which presents information about
     * the application.
     *
...
/**
 * track the last non-button, non-null component which was focused for purposes
 * of edit operations
 */
class ComponentFocusTracker {
    ...
    /**
     * refresh the last focused component based on rules to avoid defocusing a
     * component when a button is pressed
     */
    public void refresh() {
