...
public class AcceleratorActionFactory {
    ...
    /**
     * The handler that dynamically builds the Sequence submenu whenever the
     * menu is selected. Specifically it builds menu items for loading
     * accelerator sequences associated with the selected accelerator.
     *
    ...
    /**
     * Creates the action that, when activated, will load the default
     * accelerator.
     *
    ...
    /**
     * Creates the action that, when activated, will provide an open dialog box
     * that allows the user to select an accelerator file.
     *
     * @param document The document into which the accelerator will be set.
     * @return The action that when activated will load the accelerator selected
     * by the user.
     */
    ...
    /**
     * Creates the menu item that selects a particular sequence and sets the
     * document's selected sequence to that sequence.
     *
     * @param sequence The sequence that gets selected when the menu item is
     * selected.
     * @param document The document for which the menu item applies the selected
     * sequence.
    ...
    /**
     * Creates the menu item that allows the user to construct and select a
     * combo sequence.
     *
