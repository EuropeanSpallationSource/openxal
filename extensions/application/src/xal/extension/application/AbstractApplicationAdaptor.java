...
abstract public class AbstractApplicationAdaptor implements ApplicationListener {
     ...
     * If environment variable XAL_USE_CONSOLE is set to false, then output is sent to terminal instead.
     * Individual applications may implement a different solution.
     *
