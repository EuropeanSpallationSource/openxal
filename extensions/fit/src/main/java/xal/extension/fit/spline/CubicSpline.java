...
public class CubicSpline {
    ...
    /**
     * constructor which takes only the data points fp0 - the slope at the
     * starting point assumed = 0. fpn - the slope at the end point assumed = 0.
     *
     * @param xx - the data X values
     * @param y - the data Y values
     */
     ...
     *
     * @param xx - the x value to evaluate the interpolation at If x is outside
    ...
    /**
     * Integrates a spline in place. After calling this routine, a calls to
     * evaluateAt() return the integral. The constant of integration is chosen
     * such that i(0) = 0.0;
     */
