...
public class NodeChannelSelector extends KeyValueRecordSelector<NodeChannelRef> {
    ...
    /**
     * Get an instance of a record selector for allowing users to select node
     * channel references from a list in a table.
     *
     ...
     * @param owner the window that owns the dialog window
     * @param title the title of the dialog window
     * @param handles the channel handles for which to get the channel
     * references
     */
