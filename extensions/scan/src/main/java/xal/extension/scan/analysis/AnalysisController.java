...
public class AnalysisController {
    ...
    /**
     * Sets the configuration of the analysis. The subclasses should call the
    ...
    /**
     * Sets fonts for all GUI elements. The subclasses should call the
     * super-class method in this method.
     */
    ...
    /**
     * Updates data on the analysis graph panel. This method will be called
     * outside of this analysis controller, and should update data only related
     * to the inner business for this analysis. This method could be overridden,
