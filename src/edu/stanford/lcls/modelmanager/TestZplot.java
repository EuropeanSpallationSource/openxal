...
public class TestZplot {
	...
	public static void main(String[] args) {
		...
		//
		final Beamline[] beamlines = new Beamline[20];
		double startZ = 0;
		double length = 0;
		...
		SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				...
				renderer = (XYLineAndShapeRenderer) yPlot.getRenderer(yPlot
						.getDatasetCount() - 1);
				renderer.setBaseLinesVisible(false);
