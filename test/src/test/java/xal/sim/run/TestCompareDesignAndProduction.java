 ...
 * <p>
 * <h4>NOTE</h4>
 * This class should be a local simulation test class. It is not in the form of
 * a JUnit test suite, able to run independent against test data. The real use
 * is to compare the simulations results of the online model for the Open XAL
 * design and product configurations. However, I am leaving it here for the
 * present with the modification so it simply compares the results of the test
 * accelerator with itself (see
 * <code>{@link TestCompareDesignAndProduction#loadAccelerator(String...)}.
 * <p>
...
public class TestCompareDesignAndProduction {
    ...
    /**
     * Flag used for comparing the design and production trajectories (otherwise
     * just compute design)
     */
     ...
     * Output file name
     */
    private static final String STR_FILENAME_OUTPUT = TestCompareDesignAndProduction.class.getName() + ".txt";
     ...
     */
    /**
     * Loads an SMF accelerator object given the path relative to the Open XAL
     * project home (i.e., OPENXAL_HOME).
     *
    ...
    /**
     * Creates new particle probes, loads them into the class's online models
     * and runs the models.
     *
     * @author Christopher K. Allen
     * @since Sep 12, 2014
    ...
    /**
     * Save the results of the of the design and production particle trajectory
     * simulations to disk;
     *
     * @author Christopher K. Allen
     * @since Sep 12, 2014
     ...
     */
    /**
     * Writes out the contains of the given trajectory to the output file.
     *
