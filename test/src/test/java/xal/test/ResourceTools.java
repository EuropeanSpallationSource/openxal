...
/**
 * Class <code>Tools</code>. A utility class providing some tools for common
 * operations used in JUnit test cases.
 *
 *
 * @author Christopher K. Allen
 * @since Jul 10, 2015
...
public abstract class ResourceTools {
     ...
     */
    /**
     * Enumerations of the acceleration configurations available for
     * instantiation.
     *
     *
     * @author Christopher K. Allen
     ...
     * constant. The paths to the configuration files are defined relative to
     * the OPENXAL_HOME directory by the global string constants defined in
     ...
     * file name and the relative path given by the class location.
     *
    ...
    /**
     * Creates a new output file in the testing output directory with the given
     * class used for both the file path location (class package) and file name
     * (class name).
     *
     ...
     * directory. The file has the given file name and the relative path is
     * determined by the package of the given class.
     *
     * @param clsRelPath class with package specifying relative path
