 ...
 * <code>timing_pvs.tim</code> structure.
 *
...
public class TimingSourceTest extends AbstractXMLValidation {
     ...
     * This method retrieves the XML schema by calling {@link #getSchema()} and
     * then builds a test XML {@link Document} from scratch, testing it against
     * the schema after each step in the building procedure.
     *
     * @see #getSchema()
     */
    @Override
     ...
     * Test checks against invalid root element tag and against invalid child
     * elements.
     *
     ...
     * Provided DOM {@link Document} gets updated in the process.<br>
     * Test checks adding optional attributes and then tests channels in a
     * separate method. See {@link #testChannels(Document, Element, Validator)}
     * for details on channel testing.
     *
     * @param document {@link Document} DOM document built for testing.
     ...
     * Provided DOM {@link Document} gets updated in the process.<br>
     * Test checks against missing required attributes, against adding optional
     * attributes, uniqueness of the attributes and then tests transforms in a
     * separate method. See
     * {@link #testTransforms(Document, Element, Validator)} for details on
     * transform testing.
     *
     * @param document {@link Document} DOM document built for testing.
     ...
     * Provided DOM {@link Document} gets updated in the process.<br>
     * Test checks against missing required attributes, against against
     * element-to-element references and correct attribute content types.
     *
     * @param document {@link Document} DOM document built for testing.
     * @param channelSuite {@link Element} root element of the document.
     * @param validator {@link Validator} for the tested XML {@link Schema}.
