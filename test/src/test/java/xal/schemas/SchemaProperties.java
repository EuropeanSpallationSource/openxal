...
public final class SchemaProperties {
     ...
     * <code>null</code> if property is not found.
     *
     * @param propertyKey {@link String} the property key.
     * @return {@link String} value of property with the specified key, or
     * <code>null</code> if property is not found.
     */
    ...
    /**
     * Returns the test properties, or loads them from a file, if they have not
     * been accessed yet.<br>
     * Properties are read from file {@value #FILE_TEST_PROPERTIES}. If there is
     * an exception while loading properties, empty properties are returned.
     *
