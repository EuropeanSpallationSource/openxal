...
public class TestPolynomialFit {
     ...
     */
    /**
     * Computes the wave number for the given particle velocity &beta; assuming
     * 402.5 MHz RF.
     *
    ...
    /**
     * Provides the values of a test transit time factor (the sinc function) for
     * the given &beta;.
     *
     * @param dblBeta normalized particle velocity
     *
    ...
    /**
     * Test method for
     * {@link xal.app.ttffactory.PolynomialFit#PolynomialFit(double[], double[])}.
     */
    @Test
    ...
    /**
     * Test mimicking the polynomial fitting in class
     * <code>PolynomialFit</code>.
     *
     * @since Jul 28, 2015 by Christopher K. Allen
     */
    @Test
    ...
    /**
     * Test method for
     * {@link xal.app.ttffactory.PolynomialFit#getPolyConstants()}.
     */
    @Test
     ...
     */
    /**
     * Computes the system matrix from the array of beta values and the order of
    ...
    /**
     * Samples the transit time factor function at the given &beta; locations to
    ...
    /**
     * Evaluate the polynomial defined by the given vector of coefficients at
     * the given value of variable.
     *
