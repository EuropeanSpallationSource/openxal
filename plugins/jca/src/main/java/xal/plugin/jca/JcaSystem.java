...
/**
 * JcaSystem is a wrapper for public static methods of JcaChannel that are
 * common to Channel. It provides a means of calling those methods without
 * knowing (at a high level) the subclass of Channel. This is necessary since
 * static abstract methods don't exist in Java.
 *
 * @author tap
 */
class JcaSystem extends ChannelSystem {
     ...
     * "gov.aps.jca.jni.ThreadSafeContext" or
    ...
    /**
     * Determine the user's preferred JCA Context otherwise defaulting to
    ...
    /**
     * Determine the user's preferred JCA Context first checking for a Java
     * property, then an environment variable and finally a user preference
     */
     ...
     * @return the user context type if not null or empty and
     * JCALibrary.CHANNEL_ACCESS_JAVA otherwise
     */
