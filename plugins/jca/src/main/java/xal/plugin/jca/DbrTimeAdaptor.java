...
class DbrTimeAdaptor extends DbrStatusAdaptor implements TimeAdaptor {
    ...
    /**
     * Time stamp in seconds since the Java epoch Epics only provides nanosecond
    ...
    /**
     * Time stamp in seconds since the Epics epoch of January 1, 1990 Epics only
     * provides nanosecond accuracy, so we limit the timestamp to nine decimal
