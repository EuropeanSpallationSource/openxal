 ...
 * natively and then forwards the result appropriate to an IEventSinkValue
 * receiver.
 *
...
class Getback implements GetListener {
    ...
    /**
     * Derived objects must override this event hook. Derived class will catch
     * the jca.getCompleted, convert to appropriate data type, and forward to
     * the appropriate data sink interface (IEventSinkXxxXxx).
     *
