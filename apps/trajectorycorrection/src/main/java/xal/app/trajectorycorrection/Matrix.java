...
/*
 * Based of the Jama package with a few modifications
 */
 ...
 * ------------------------ */
   ...
   */
   ...
   /** Matrix pseudoinverse based on SVD decomposition
   @param   cut
   @return  pseudoinverse(A) 
   */

   public Matrix pseudoinverse (double cut) {
      Matrix X;
      Matrix Inv;
     ...
     X = new Matrix(S);
     Inv = this.getV().times(X.times(this.getU().transpose()));
