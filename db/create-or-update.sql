...
--CHECKING COLUMNS
IF NOT EXISTS (SELECT "ELEMENT_NAME" FROM "MACHINE_MODEL"."MODEL_DEVICES")
THEN
    ALTER TABLE "MACHINE_MODEL"."MODEL_DEVICES" ADD COLUMN "ELEMENT_NAME" VARCHAR(60);
END IF;

IF NOT EXISTS(SELECT "ZPOS" FROM "MACHINE_MODEL"."MODEL_DEVICES")
THEN 
    ALTER TABLE "MACHINE_MODEL"."MODEL_DEVICES" ADD COLUMN "ZPOS" NUMERIC;
END IF;

IF NOT EXISTS(SELECT "INITIAL_VALUE" FROM "MACHINE_MODEL"."MODEL_DEVICES")
THEN 
    ALTER TABLE "MACHINE_MODEL"."MODEL_DEVICES" ADD COLUMN "INITIAL_VALUE" DOUBLE PRECISION;
END IF;

IF NOT EXISTS(SELECT "UNITS" FROM "MACHINE_MODEL"."MODEL_DEVICES")
THEN 
